...
\chapter{Algorithm}
There are several reasons that can cause algorithmic fairness to be violated:
\begin{enumerate}
    \item Training Data;
    \item Objective of Principle (some consumers are more valuable than others);
    \item Mislabeled Outcomes.
\end{enumerate}
Solutions:
\begin{enumerate}
    \item Modify the loss functions
    \item ...
\end{enumerate}
\section{\cite{kleinberg2018algorithmic}: Algorithmic Fairness}
