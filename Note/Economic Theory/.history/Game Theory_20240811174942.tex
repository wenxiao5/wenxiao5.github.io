...
\begin{equation}
    \begin{aligned}
        \delta^2 F(y,h)&=\int_X\frac{d^2 F(y)}{d y(x)^2}h(x) dx=\int_X\frac{d^2 f(y(x))}{d y^2}h(x) dx\\
        \delta^2 G(y,h)&=\int_X\frac{d G(y)}{d y(x)}h(x) dx=\int_Xg'(F(y))\frac{d f(y(x))}{d y}h(x) dx
    \end{aligned}
    \nonumber
\end{equation}
