...
Suppose the cost is privately observed by each firm. Suppose in collusion, firms set price $p^M$ in each period, which generates a monopoly profit $\Pi^M(c)=\frac{(p^M-c)D(p^M)}{2}$. Suppose in perfect competition, a firm's expected profit in each period is denoted by $\Pi^P$.
