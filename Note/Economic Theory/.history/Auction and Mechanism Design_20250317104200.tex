...
\begin{definition}[SCF's Properties]\label{SWF_properties}
    ...
    \begin{enumerate}[$\circ$]
        ...
        \item \textbf{Independent of irrelevant alternatives} (IIA): Given $\theta_1,\theta_2\in\Theta$ such that $u(x,\theta_1)> u(y,\theta_1) \Leftrightarrow u(x,\theta_2)> u(y,\theta_2)$, then $x = F(\theta_1) \Rightarrow y \neq F(\theta_2)$.
    \end{enumerate}
\end{definition}
