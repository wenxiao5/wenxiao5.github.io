...
\begin{proof}
    ...
    \begin{equation}
        \begin{aligned}
            ...
            \textnormal{By KKT necessary conditions }&=\frac{\partial f}{\partial \theta_i}(x^*;\bar{\theta})+\lambda^* \frac{\partial g}{\partial x}(x^*;\theta)\frac{\partial x^*(\bar{\theta})}{\partial \theta_i}\\
        \end{aligned}
        \nonumber
    \end{equation}
\end{proof}
