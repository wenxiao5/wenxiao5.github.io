...
\begin{definition}[Constrained Pareto Optimal]
    \normalfont
    A CE $w$ is \textbf{constrained Pareto optimal} if it cannot be Pareto improved upon by an intervention by the planner.
\end{definition}
...
\end{proposition}
\begin{proof}
    Any CE wage $w\neq w^*$ can be Pareto improved by $\{w_e=w^*,w_u=0\}$
\end{proof}
