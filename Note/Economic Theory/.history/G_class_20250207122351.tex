...
\section{Doing it now or later (Matthew Rabin Lecture)}
A 2 hours effort today can save 10 mins every day in the future.
\begin{equation}
    \begin{aligned}
        U_t=-120+\beta \delta 10 + \beta \delta^2 10 + \cdots=-120+\beta\frac{\delta}{1-\delta}10
    \end{aligned}
    \nonumber
\end{equation}
