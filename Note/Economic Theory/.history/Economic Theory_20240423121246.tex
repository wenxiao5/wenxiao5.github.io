...
\begin{lemma}
    ...
    \begin{enumerate}
        ...
        \item Derivation follows the similar step as derivation of expected revenues of the seller in optimal auctions \eqref{eq:revenue}.
        \begin{equation}
            \begin{aligned}
    ...
    \end{enumerate}
\end{lemma}
The proof of 1-4 of the lemma is similar to the Proposition \ref{Linear utility model_BIC}.
