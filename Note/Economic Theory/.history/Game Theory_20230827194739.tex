...
The sender knows the realized state and the receiver is uninformed.

Prior to the realization of the state, the sender commits to a \textbf{signaling policy} $\pi : [0, 1] \rightarrow \Delta(S)$ ,where $S$ is an arbitrary measurable space.
