...
\begin{equation}
    \begin{aligned}
        \frac{\partial \Pi_A(a,b)}{\partial a}=\underbrace{(p_A^*-c)\frac{\partial D_A^*}{\partial a}}_\textnormal{direct effect>0}+\underbrace{\frac{\partial D_A^*}{\partial p_A^*}}_{=0}\frac{\partial p_A^*}{\partial a}+\underbrace{(p_A^*-c)\frac{\partial D_A^*}{\partial p_B^*}\frac{\partial p_B^*}{\partial a}}_\textnormal{strategic effect}
    \end{aligned}
    \nonumber
\end{equation}
