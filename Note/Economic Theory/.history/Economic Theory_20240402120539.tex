...
Given
\begin{enumerate}
    \item the set of agents $I$ with utility function $u_i,i\in I$,
    \item alternatives (outcomes for the society) $X$,
    \item  types (of agents) $\Theta$ with prior probability $\phi$,
    \item and a \textbf{social choice function} $f:\Theta=(\Theta_1,...,\Theta_I) \rightarrow X$.
\end{enumerate}
