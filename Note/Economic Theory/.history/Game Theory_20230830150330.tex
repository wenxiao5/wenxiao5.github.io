...
\begin{definition}[Completeness, Transitivity, Rantionality]
    \normalfont
    \begin{enumerate}[$\circ$]
        \item \textbf{Completeness}: For any $x,y\in X$, either $x\succeq y$ or $y\succeq x$.
        \item \textbf{Transitivity}: For any $x,y,z\in X$, if $x\succeq y$ and $y\succeq z$, then $x\succeq z$.
        \item \textbf{Rationality}: $\succeq$ is \textbf{rational} \underline{if and only if} it is \textbf{complete} and \textbf{transitive}.
    \end{enumerate}
\end{definition}
...
\subsection{Indepence of Preference}
...
\begin{definition}[Independence of Preference]
    \normalfont
    $\succeq$ is \textbf{independent} if for any $x,y\in X$, $x\succeq y$ $\Rightarrow$ $y\succeq x$.
\end{definition}
