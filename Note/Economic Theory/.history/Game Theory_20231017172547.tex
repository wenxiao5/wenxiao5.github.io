...
``Value function'' $v(PD,\sigma)$ represents the net present value of starting a period in state $PD$ given $\sigma$:

The most desirable situation that both players choose $1$:
\begin{equation}
    \begin{aligned}
