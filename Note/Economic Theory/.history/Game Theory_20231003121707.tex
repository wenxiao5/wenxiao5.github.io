...
\begin{remark}
    \begin{enumerate}[$\circ$]
        \item $u$-representations are unique up to strictly increasing rescaling: if $u$ represents $\succ$ then so will $v(\cdot)=f(u(\cdot))$ for any \textbf{strictly increasing} $f$.
