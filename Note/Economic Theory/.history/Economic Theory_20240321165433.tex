...
\begin{proof}
    ...
    \begin{enumerate}
        ...
        \item \underline{$w_H=\theta_H$:} Suppose $w_H<\theta_H$, either firm can profitably deviate by offering $(w'_H,t'_H)$ such that $w'_H$ $w'_H-c(t'_H,\theta_H)> w_H-c(t_H,\theta_H)$ and $w'_H-c(t'_H,\theta_L)<w_H-c(t_H,\theta_L)< w_L-c(t_L,\theta_L)$.
    \end{enumerate}
