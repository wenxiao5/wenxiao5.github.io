...
\begin{definition}[Nash Bargaining Solution]
    The Nash (1950) bargaining solution $f_N$ is defined by
    \begin{equation}
        \begin{aligned}
    ...
    \end{equation}
\end{definition}
Given the assumptions on $(U, d)$, the solution to the optimization problem exists (the set $U$ is compact and the objective function is continuous) and is unique (the objective function of the problem is strictly quasi-concave).
