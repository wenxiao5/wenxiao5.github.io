...
\begin{proof}
    ...
    \begin{equation}
        \begin{aligned}
            ...
            \textnormal{(substitute \eqref{EE}) }=&\mathbb{E}_{\tilde{\theta}_{-i}}\left[\sum_{j=1}^I v_j(k^*(\theta_i,\tilde{\theta}_{-i}),\theta_j)\right]+\mathbb{E}_{\tilde{\theta}_{-i}}\left[h_i(\tilde{\theta}_{-i}})\right]
        \end{aligned}
        \nonumber
    \end{equation}
\end{proof}
