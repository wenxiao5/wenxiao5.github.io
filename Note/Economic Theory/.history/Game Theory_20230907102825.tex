...
\begin{definition}[Strategy Proof, DSIC]
    \normalfont
    $f$ is \textbf{strategy proof} (DSIC) if $s^*_i(\theta_i)=\theta_i$ for all $\theta_i\in\Theta_i$ and all $i\in I$ is a dominant strategy equilibrium of the direct mechanism $\Gamma=(\Theta, g(\cdot))$
\end{definition}
