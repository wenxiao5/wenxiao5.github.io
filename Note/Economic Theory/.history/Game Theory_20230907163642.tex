...
\begin{definition}[Local Nonsatiation]
    \normalfont
    For any bundle $x$, there is a nearby bundle $y$ in the consumption set such that $y$ is preferred to $x$.
    $$
    \forall x \in X, \forall \varepsilon>0, \exists y \in|x-y|<\varepsilon, \text { s.t. } y \succ x
    $$
\end{definition}
