...
\begin{definition}[SWF's Properties]\label{SWF_properties}
    ...
    \begin{enumerate}[$\circ$]
        \item has \textbf{unrestricted domain} (UD) if $\mathcal{D}=\mathcal{R}^n$;
        ...
        \item is \textbf{weakly Paretian} (PA) if, $\forall \{x,y\}\subseteq X$ and any preference profile $(\succeq_1,...,\succeq_I)\in \mathcal{D}$, we have $x\succeq_i y,\forall i\in I \Rightarrow x\trianglerighteq y$.
