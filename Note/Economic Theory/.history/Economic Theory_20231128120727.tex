...
\begin{enumerate}
    ...
    \item Each consumer has preference relation $\succeq_i$ over $\mathbb{R}_+^{L(S+1)}$ represented by utility function $u_i$ and initial endowment under different states $w_i=(w_{i0},w_{i1},...,w_{iS})\in \mathbb{R}^{L\times(S+1)}$.
\end{enumerate}
