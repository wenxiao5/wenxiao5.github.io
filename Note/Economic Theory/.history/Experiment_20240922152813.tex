...
This theory is also interesting, however, it also does not consider the decision rule of decision-makers, i.e., how the limited capacity of consciousness is used. Moreover, it separates the decision from the information acquisition process of decision-makers. Are decision-makers using unconscious thought still able to acquire the same amount as they would using conscious thought?
