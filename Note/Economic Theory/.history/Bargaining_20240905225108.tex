...
\begin{equation}
    \begin{aligned}
        dx=\mu(x)dt+\sigma(x)dW, x(0)=x_0
    \end{aligned}
    \nonumber
\end{equation}
We are interested in the evolution of the \textit{distribution} of $x$, $g(x,t)$, and in particular in the stationary distribution $g(x)$.
