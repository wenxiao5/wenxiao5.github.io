...
\end{definition}
\begin{note}
    To show an allocation is supported as a price equilibrium with transfers:
    we need to find the allocation that is supported (i.e., all agents' bundles are supported by a common price).
\end{note}
