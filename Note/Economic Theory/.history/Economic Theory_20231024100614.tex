...
Mechanism $\Phi$ is \textbf{good}, if whenever a $\tilde{setting}$ has stronger quotas than setting $q_s$, then it is not the case that all \underline{minority} students are worse off under the $\tilde{setting}$.


\begin{theorem}[Kojima 2012]
    There is no stable good matching.
\end{theorem}
