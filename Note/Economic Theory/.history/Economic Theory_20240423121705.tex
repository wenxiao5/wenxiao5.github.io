...
\begin{proof}
    ...
    \begin{equation}
        \begin{aligned}
            0\leq \int_{\underline{\theta}_2}^{\overline{\theta}_2}\int_{\underline{\theta}_1}^{\overline{\theta}_1} \left(\left[\theta_2-\frac{1-\Phi_2(\theta_2)}{\phi(\theta_2)}\right]-\left[\theta_1+\frac{\Phi_1(\theta_1)}{\phi(\theta_1)}\right]\right)y(\theta)\phi(\theta)d\theta
        \end{aligned}
        \nonumber
    \end{equation}
\end{proof}
