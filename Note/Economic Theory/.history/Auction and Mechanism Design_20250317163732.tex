...
\begin{definition}[Harsanyi's three axioms]
    ...
    \begin{enumerate}
        ...
        \item \textbf{Social EU}: For each $(\succcurlyeq_1,\ldots,\succcurlyeq_I)\in \mathcal{R}^I$, the \textit{social welfare function} satisfies the vNM EU axioms: there exists $u(\cdot;\theta)$ such that $a f(\theta) b \Leftrightarrow \mathbb{E}_au(a;\theta)\geq \mathbb{E}_bu(b;\theta)$. So $f: \mathcal{R}^I \rightarrow \mathcal{R}$.
    \end{enumerate}
\end{definition}
