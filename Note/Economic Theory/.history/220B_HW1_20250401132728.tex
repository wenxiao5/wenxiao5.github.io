...
By continuity, there exists a unique critical value $d^*$ such that for all $\frac{\delta}{1-\delta}<d^*$, the probability of sustaining collusion is higher with transparency, while for all $\frac{\delta}{1-\delta}>d^*$, the probability is higher without transparency.
