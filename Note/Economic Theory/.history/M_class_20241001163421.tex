...
\begin{enumerate}
    \item Random purchase: $x$ gets expected disutility $\int_0^1 t|x-z| dz$.
    \item Search: the search strategy can be given as
    \begin{enumerate}
        \item Stop search if $z\in (x-\delta,x+\delta)$. This gives disutility $\int_{x-\delta}^{x+\delta}t|x-z|dz$, which is minimized for consumers located at $x=\frac{1}{2}$ who gets disutility $\frac{t}{4}$.
