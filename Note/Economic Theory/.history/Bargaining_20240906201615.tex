...
\begin{proposition}[Hamilton-Jacobi-Bellman Equation]
    ...
    \begin{equation}
        \begin{aligned}
            \rho v(x) = \underbrace{\frac{\partial v(x)}{\partial t}}_{=0} + \max_{\alpha\in A}\left\{r(x,\alpha) + \frac{\partial v(x)}{\partial x}\cdot f(x,\alpha)\right\}
        \end{aligned}
        \nonumber
    \end{equation}
...
\begin{proof}[Derivation from Discrete-time Bellman]
    ...
    \begin{equation}
        \begin{aligned}
            \rho v_t(x(t))=\max_{\alpha(t)}\ r(x(t),\alpha(t)) + \frac{\partial v(x(t))}{\partial x}\dot{x}(t)
        \end{aligned}
        \nonumber
    \end{equation}
\end{proof}
