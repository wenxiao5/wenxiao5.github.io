...
\begin{proof}
    ...
    \begin{equation}
        \begin{aligned}
            ...
            &\left(\textnormal{By KKT necessary conditions, we have }\lambda^* g(x^*;\bar{\theta})=0R\circledast\lambda^*\left[\frac{\partial g}{\partial x}(x^*;\bar{\theta})\frac{\partial x^*(\bar{\theta})}{\partial \theta_i}+\frac{\partial g}{\partial \theta_i}(x^*;\bar{\theta})\right]\right)\\
        \end{aligned}
        \nonumber
    \end{equation}
\end{proof}
