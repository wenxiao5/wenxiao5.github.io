...
Given the set of agents, alternatives, and types are $I, X, \Theta$ and a social choice function $f:\Theta \rightarrow X$.

\begin{definition}
    \normalfont
    A \textbf{mechanism} is represented as $$\Gamma=\((S_1,...,S_I), g:S \rightarrow X\)$$
