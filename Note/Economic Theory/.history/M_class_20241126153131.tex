...
Except the manufacturer that provides input $x$ with price $p_w$, there is a competitive industry that provides input $x'$ with price $p'_w$. The retailer produce outputs as $q=f(x,x')$. The difference is the retailer has market power for $x'$.
