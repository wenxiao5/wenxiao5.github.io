...
\subsection{Additional Condition}
...
\end{enumerate}
\begin{proposition}
    Conditon (5) holds in an exchange economy with assumption \ref{C} and holds in an production economy with assumption \ref{C} and \ref{F}.
\end{proposition}
