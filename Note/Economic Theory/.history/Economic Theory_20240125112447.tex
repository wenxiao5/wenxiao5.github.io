...
\begin{lemma}
    \begin{enumerate}
        \item A dominant strategy is always pure.
        \item A strategy $\sigma'_i$ dominates $\sigma_i$ iff $u_i(\sigma'_i,s_{-i})> u_i(\sigma_i,s_{-i})$, for all pure strategy profiles $s_{-i}\in S_{-i}$.
    \end{enumerate}
\end{lemma}
