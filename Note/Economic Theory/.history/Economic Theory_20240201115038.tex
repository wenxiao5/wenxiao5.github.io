...
\begin{definition}[Bayesian Game]
    ...
    where $\Omega$ is the state space, $u_i(s_i,s_{-i},\theta_i)$ maps the strategies of players and player $i$'s type $\theta_i\in \Theta_i$ to player $i$'s utilities, and $F_i\in\Delta\left(\Omega\tims\Theta_i\right)$ is the (prior) distribution of the player $i$'s type.
\end{definition}
