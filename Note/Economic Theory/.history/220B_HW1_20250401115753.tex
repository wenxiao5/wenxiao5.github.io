...
\begin{equation}
    \begin{aligned}
        ...
        \nonumber
\end{equation}
If without cost shocks, we have $\Pi^M(c)=\frac{p_m-c}{2}=W$ and $\Pi^P=0$. Thus, the LHS of the inequality decreases and the RHS increases, so the inequality is more likely to hold. That is, the collusion is more likely to sustain without cost shocks.
