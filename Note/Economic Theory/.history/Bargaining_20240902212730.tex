...
\begin{proposition}
    ...
    \begin{enumerate}
        ...
        \item State transition function: $\dot{x}(t)=\mathcal{H}_x(x(t),u(t),\lambda(t),t)=f(x(t),u(t),t)$
        \item Costate equations: $\dot{\lambda}(t)=-[I_x(x(t),u(t),t)+\lambda^T(t)f_x(x(t),u(t),t)]$
    \end{enumerate}
\end{proposition}
