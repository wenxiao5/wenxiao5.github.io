...
\begin{definition}[Joint and Meet]
    \normalfont
    \begin{enumerate}
        \item Join $\mu \vee_D \mu'$ assign the more preferred match to every $d$, that is,
        \begin{equation}
            \begin{aligned}
                \mu \vee_D \mu'=\left\{\begin{matrix}
            ...
            \nonumber
        \end{equation}
        \item Meet $\mu\wedge_D\mu'$ assign the less preferred match to every $h$.
    \end{enumerate}
\end{definition}
