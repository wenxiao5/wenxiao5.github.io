...
Fix a direct mechanism $(y(\cdot),t(\cdot))$. For a agent with $\theta_i$, the interim expected probability of trade is
\begin{equation}
    \begin{aligned}
