...
\begin{center}
    ...
    \end{tabular}
\end{center}
Except the actions, the Player 1 can choose to Burn (i.e., lose $2.5$ units of utility).
...
\end{enumerate}
The potential payoffs of playing (S2) are $1.5$ and $3.5$, which is dominated by playing (S4).
