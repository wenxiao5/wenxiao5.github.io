...
\begin{enumerate}
    ...
    \begin{equation}
        \begin{aligned}
            &c\frac{1}{\hat{N}}+2c\frac{\hat{N}-1}{\hat{N}}\frac{1}{\hat{N}-1}+\cdots \left[(N-1)c\frac{\hat{N}-1}{\hat{N}}\frac{\hat{N}-2}{\hat{N-1}}\cdots\frac{1}{2}\right]\\
            =&(\hat{N}-1)\left(\frac{1}{2}+\frac{1}{\hat{N}}\right)c
        \end{aligned}
        \nonumber
    \end{equation}
\end{enumerate}
