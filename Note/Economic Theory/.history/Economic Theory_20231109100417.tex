...
\begin{definition}[Probabilitistic Serial Algorithm]
    ...
    \end{enumerate}
    \begin{example}
        Preference: A: $1\succ 3\succ 2$; B: $1\succ 2 \succ 3$; C: $2\succ 3\succ 1$
        \begin{enumerate}
            \item A: $\frac{1}{2} Obj 1$; B: $\frac{1}{2} Obj 1$; C: $\frac{1}{2} Obj 2$.
            \item A:$ \frac{1}{2} Obj 1+\frac{1}{4} Obj 3$; B: $\frac{1}{2} Obj 1+\frac{1}{4} Obj 2$; C: $\frac{3}{4} Obj 2$.
        \end{enumerate}
    \end{example}
\end{definition}
