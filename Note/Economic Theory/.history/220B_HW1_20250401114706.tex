...
I only show the simple example of two firms and uniform cost distribution $c_i\sim\textnormal{Unif}([0,1])$.
...
\begin{enumerate}
    ...
    \begin{equation}
        \begin{aligned}
            ...
            \textnormal{F.O.C. }\left[1-p^{-1}(p_i)-\frac{1}{p'(p^{-1}(p_i))}(p_i-c)\right](a-p_i)-[1-p^{-1}(p_i)](p_i-c)=0\\
