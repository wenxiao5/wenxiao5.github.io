...
Previous works show that neither relying on average option nor a signal option is a robust strategy to give an accurate judgment. This paper shows that average the options from select crowds of most knowledgeable judges gives an accurate judgment, and this strategy is accurate and robust. Moreover, this strategy is also appealing to those who are distrustful of the crowd.
