...
\begin{proof}
    ...
    \end{lemma}
    $\Phi$ will be monotone for the partial order.
    .....


    \textbf{Read} Fleiner, T., Jankó, Z., Tamura, A., \& Teytelboym, A. (2015). Trading networks with bilateral contracts. arXiv preprint arXiv:1510.01210.
\end{proof}
