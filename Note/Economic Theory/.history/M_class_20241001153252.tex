...
Possible low signal that others receive is $f(v):=v-\delta(v)$

Possible high signal that others receive is $f^{-1}(v)$ $:=g(v)$

If seller receives signal $x_j$, possible other sellers' signals are $f(x_j),x_j,g(x_j)$.
