...
Based on the normal-Normal learning  (\ref{NNL}), the posterior belief is
\begin{equation}
    \begin{aligned}
        \theta\mid (y_1-\tilde{a}_1)\sim N(\lambda\mu_\theta+(1-\lambda)(y_1-\tilde{a}_1),\lambda\sigma_\theta^2)
    \end{aligned}
    \nonumber
\end{equation}
