...
\begin{example}[Learning by Doing]
    Suppose there are two periods $t=1,2$. The demand is $q_t=D_t(p_t)$. The cost in period one is $c_1(q_1)$ and $c_2(q_2,q_1)$ (the more you produce in period one, the lower the cost you are facing in period two).
\end{example}
