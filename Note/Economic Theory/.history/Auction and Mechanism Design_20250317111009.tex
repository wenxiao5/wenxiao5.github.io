...
\begin{definition}[Harsanyi's three axioms]
    ...
    \begin{enumerate}
        \item \textbf{EU preferences}: each agent's preference can be represented by the von Neumann-Morgenstern utility function, $x\succcurlyeq_i y\Leftrightarrow\mathbb{E}u_i(x;\theta_i)\geq \mathbb{E}u_i(y;\theta_i)$.
