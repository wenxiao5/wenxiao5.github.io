...
For the equilibrium refinement, we can also introduce the Grossman-Perry-Farrell equilibrium based on the perfect sequential equilibrium \cite{grossman1986sequential} and the neologism-proof equilibrium \cite{farrell1993meaning}. We formally define the Grossman-Perry-Farrell equilibrium by ruling out the self-signaling sets in Perfect Bayesian Equilibrium \cite{bertomeu2018verifiable,glode2018voluntary}.
