...
\begin{definition}
    ...
    \begin{enumerate}
        ...
        \item The set of non-negative, non-decreasing functions that are weakly majorized by $f$ is denoted by $$\textnormal{MPS}_w(f)=\{g\in L^1\mid g \textnormal{ is non-decreasing and }g\prec f\}$$
    \end{enumerate}
\end{definition}
