...
The payoff from the portfolio $z_i$ is $Rz_i\in \mathbb{R}^S$.
    ...
    \begin{enumerate}
        ...
        \begin{equation}
            \begin{aligned}
                ...
                \textnormal{s.t. } p_0^*\cdot x_{i0}+q^*\cdot z_i\leq p_0^*\cdot w_{i0}\\
                p_s^*\cdot x_{is}\leq p_s^*\cdot w_{is}+p_{l_s}^*(Rz_i)_s, \forall s\\
            \end{aligned}
            \nonumber
        \end{equation}
        \item $\sum_{i=1}^mz_i^*=0$, $\sum_{i=1}^m x_i^*=\sum_{i=1}^m w_{is}, \forall s$.
    \end{enumerate}
\end{definition}
