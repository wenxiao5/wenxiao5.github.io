...
\begin{enumerate}
    ...
    \item Strategy-Proof: $\Phi$ induces a game. We want that, in this game, truth-telling is a weakly dominant strategy for all agent $i\in N$.
\end{enumerate}

Asking one by one and allocate a remaining object. $\Rightarrow$ it satisfies IR, PE, SP.
