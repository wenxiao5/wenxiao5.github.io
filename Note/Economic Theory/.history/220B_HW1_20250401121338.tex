...
\begin{enumerate}
    \item Without collusion, the perfect competition makes the firm $i$ set $p_i=\max\{c_i,c_j-\epsilon\}$ to win the market if and only if $c_i< c_j$. Thus, the expected profit of firm without collusion is $\Pi^P_T=\int_0^1 \int_x^1 (t-x) dt dx$.
\end{enumerate}
