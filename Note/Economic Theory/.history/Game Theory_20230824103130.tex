...
\begin{definition}[Weak Axiom of Revealed Preference]
    \normalfont
    Given the choice structure $(C,\mathcal{B})$. If for some $B\in \mathcal{B}$ with $x,y\in B$, we have $x\in C(B)$; Then, for any $B'\in \mathcal{B}$ with $x,y\in B'$, $y\in C(B') \Rightarrow x\in C(B')$.
\end{definition}
