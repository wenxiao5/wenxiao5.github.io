...
\begin{definition}
    \normalfont
    Mechanism $\Phi$ is \textbf{good}, if whenever a $\tilde{setting}$ has stronger quotas than its setting, then it is not the case that all \underline{minority} students are worse off under the $\tilde{setting}$.
\end{definition}
