...
\begin{enumerate}
    ...
    \item We use $\mathcal{R}$ to denotes the set of all rational preference relations.
...
\begin{definition}[SWF's Properties]
    \normalfont
    A social welfare function $f: \mathcal{A}\subseteq \mathcal{R}^I\rightarrow \mathbb{R}$
\end{definition}
