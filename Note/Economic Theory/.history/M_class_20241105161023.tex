...
\begin{enumerate}
    \item Uncertainty of evolution process: Transportation probability is $\textnormal{Prob}\left(s_{t+1}\mid s_t,a_t\right)$. Then,
    \begin{equation}
        \begin{aligned}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            ...
            \item Plug in $V=(I-\delta P)^{-1}\Pi$ to obtain $V$.
        \end{enumerate}
    \end{enumerate}
\end{enumerate}
