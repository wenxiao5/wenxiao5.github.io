...
\begin{definition}[functional]
    ...
    \begin{example}
        Specifically, the input of a functional can be a function: $F(y)=\int_a^b y(x) dx$, where $y\in X\subseteq \mathbb{R} \rightarrow \mathbb{R}$ is a function in the space of functions $\mathcal{Y}$ which map $X\subseteq \mathbb{R} \rightarrow \mathbb{R}$. The $F$ is the functional between $\mathcal{Y}$ and $\mathbb{R}$.
    \end{example}
\end{definition}
