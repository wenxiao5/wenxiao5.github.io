...
\begin{equation}
    \begin{aligned}
        V(v,x,I,N)&=\max\bigg\{\underbrace{0}_\textnormal{not choosing an alternative},\underbrace{\max_{i\in I}(v-t|x-z_i|)}_\textnormal{choosing the best checked product},\\
        \sum_{i\notin I}\frac{1}{N-M}\left(v-t|x-z_i|\right), -c+\sum_{i\notin I}\frac{1}{N-M}V\left(v,x,I\cup\{i\},N\right)\bigg\}
    \end{aligned}
    \nonumber
\end{equation}
