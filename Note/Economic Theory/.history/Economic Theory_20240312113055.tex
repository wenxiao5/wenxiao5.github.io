...
\begin{proof}
    ...
    \begin{enumerate}
        ...
        \item Case 1: suppose $w^*$ doesn't give full-employment in CE. Take a intervention $w_e\&w_u$. Then, $\{\theta:r(\theta)+w_u\leq w_e\}=[\underline{\theta},\hat{\theta}]$ for some $\hat{\theta}\in[\underline{\theta},\overline{\theta}]$ such that $r(\hat{\theta})+w_u=w_e$. The budget balanced gives
        \begin{equation}
            \begin{aligned}
