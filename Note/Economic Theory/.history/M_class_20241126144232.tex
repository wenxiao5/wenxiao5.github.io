...
\begin{enumerate}
    ...
    \item Retailer knows more about demand than manufacturer: Solved by screening, i.e., a menu that the highest type gets efficient quantity ($p_w=c$) and the lowest type gets zero profit ($p_w>c$).
    \item Manufacturer knows more about demand than retailer: Solved by 
\end{enumerate}
