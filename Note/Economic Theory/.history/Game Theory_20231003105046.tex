...
Based on the idea of duality, we want to analyze problem based on the dual demand, Hicksian demand.
...
\begin{theorem}
    Competitive Equilibrium exists for all feasible endowment profiles, 
\end{theorem}
