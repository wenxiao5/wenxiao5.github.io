...
\begin{proposition}
    ...
    \begin{enumerate}
        \item Maximum principle: $\mathcal{H}_u(x(t),u(t),\lambda(t),t)=0$
        \item State transition function: $\dot{x}(t)=\mathcal{H}_\lambda(x(t),u(t),\lambda(t),t)=f(x(t),u(t),t)$
        \item Costate equations: $\dot{\lambda}(t)=-\mathcal{H}_x(x(t),u(t),\lambda(t),t)=-[I_x(x(t),u(t),t)+\lambda^T(t)f_x(x(t),u(t),t)]$
    \end{enumerate}
\end{proposition}
