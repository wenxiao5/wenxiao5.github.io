...
\normalfont
    ...
    \begin{equation}
        \begin{aligned}
            t_i(\theta_i)=\mathbb{E}_{\tilde{\theta}_{-i}}\left[\sum_{j\neq i}v_j(k^*(\theta_i,\tilde{\theta}_{-i}),\theta_j)\right]+h_i(\theta_{-i})
        \end{aligned}
        \label{EE}
    \end{equation}
    where $\mathbb{E}_{\tilde{\theta}_{-i}}\left[\sum_{j\neq i}v_j(k^*(\theta_i,\tilde{\theta}_{-i}))\right]$ is the expected externality $i$ imposes on others, from $i$'s interim perspective when her type is $\theta_i$.
\end{definition}
...
\begin{proof}
    ...
    \begin{equation}
        \begin{aligned}
           ...
           \textnormal{($k^*$ is ex-post efficient) } \geq& \mathbb{E}_{\tilde{\theta}_{-i}}\left[\sum_{j=1}^I v_j(k^*(\hat{\theta}_i,\tilde{\theta}_{-i}),\theta_j)\right]+\mathbb{E}_{\tilde{\theta}_{-i}}[h_i(\tilde{\theta}_{-i})],\quad \forall \hat{}\\
        \end{aligned}
        \nonumber
    \end{equation}
\end{proof}
