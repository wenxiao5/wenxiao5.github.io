...
\begin{equation}
    ...
    \nonumber
\end{equation}
where $\pi_t(h_t):=\pi_t(h_t|\sigma_{LR},\sigma_{SR})$ is measure over histories of length $t$ for every $t$ that considers the strategies $(\sigma_{LR},\sigma_{SR})$ together with the measure $\mu$.
