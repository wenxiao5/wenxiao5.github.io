...
\begin{definition}[Refinement and ]
    \normalfont
    Let $\Sigma, \Pi$ be two sub-algebras of some algebra.We say that $\Sigma$ is a \textbf{refinement} of $\Sigma$ and $\Pi$ is a coarsening of $\Sigma$ if $\Pi \subseteq \Sigma$.
\end{definition}
