...
\begin{enumerate}
    \item The set of actions for the short-run selves is $A$ (the set of probability measures is $\mathbf{A}$).
    \item The set of self-control actions for the long-run selves is $R$ (the set of probability measures is $\mathbf{R}$).
\end{enumerate}
The 
