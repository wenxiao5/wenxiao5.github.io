...
\begin{equation}
    \begin{aligned}
        \delta F(y,h)= \int_{\underline{x}}^{\bar{x}} \left[\frac{\partial f(x,y(x),y'(x))}{\partial y}-\frac{d}{dx}\frac{\partial f(x,y(x),y'(x))}{\partial y'}\right] h(x) dx + \frac{\partial f(x,y(x),y'(x))}{\partial y'}h(x)\bigg|_{\underline{x}}^{\bar{x}}
    \end{aligned}
    \nonumber
\end{equation}
