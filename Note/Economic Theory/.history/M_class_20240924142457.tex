...
Other models:
\begin{enumerate}
    \item vertical differenetion (S. Moorthy);
    \item defender model (John Hauser);
    \item logit/limited defender model, $u_{ij}=v_j-p_j+\epsilon_{ij}$, where $\epsilon\sim EVI$. The outside option is modeled as $u_{i0}=\epsilon_{i0}\sim EVI$.
\end{enumerate}
