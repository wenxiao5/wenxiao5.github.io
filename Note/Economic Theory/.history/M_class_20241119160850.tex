...
\begin{example}[ (Money-back Guarantees)]
    ...
    Firms' decisions are (1). Price $p$; (2). Decision to offer or not offer money-back guarantees. Suppose there are transaction costs of using money-back guarantees: $t_B$ for buyers and $t_S$ for sellers.
    ...
    \begin{equation}
        \begin{aligned}
            (1-f_L)p_H-t_Sf_L\leq (1-f_L)p_L
        \end{aligned}
        \nonumber
    \end{equation}
\end{example}
