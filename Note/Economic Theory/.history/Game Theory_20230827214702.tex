...
\begin{note}
    For a distribution $H \in \Delta([0,1])$ and a measurable set $C \subseteq[0,1]$ we denote by $H\vert_C$ the distribution of $h \sim H$ conditional on the event that $h\in C$.
\end{note}
