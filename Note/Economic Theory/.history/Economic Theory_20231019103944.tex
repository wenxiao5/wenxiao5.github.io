...
\begin{definition}[Reny 2022]
    \normalfont
    $\mu$ is \textbf{priority-neutral} iff $\exists$ no matching $u$ that can make any student whose priority is violated at $\mu$ better off unless $u$ violates the priority of some student who is made worse off.
\end{definition}
