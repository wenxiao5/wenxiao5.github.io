...
\end{enumerate}
The optimal policy is not going to be an index-based policy (what we do in multi-armed bandit). (Not going to be Gittins index policy).

Gittins index: $K_i:=V(I_i,K_i)$: Value of playing arm $i$ with information $I_i$ with the possibility of exiting and getting $K_i$.
