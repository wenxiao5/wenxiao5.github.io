...
\begin{proof}[Sketch]
    ...
    Secondly, we prove the uniqueness: Given $f(p)$, the corresponding reservation price of search is $R$. All firms charge $p\geq R$. Suppose by the way of contradiction that there is a firm $p<R$
\end{proof}
