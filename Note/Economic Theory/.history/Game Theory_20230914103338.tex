...
\begin{definition}
    \normalfont
    A lattice is complete if $X\subseteq L$ has a meet $\wedge X$ and a join $\vee X$.
\end{definition}


A function from one lattice to another lattice $f:L \rightarrow L'$ is monotone if $x\leq y \Rightarrow f(x)\leq f(y)$ for any $x,y\in L$.
