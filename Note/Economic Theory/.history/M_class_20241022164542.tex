...
Suppose there is a fixed cost $C_i$ per member on side $i$ of market and a marginal cost $c$ per interaction between 2 members. The average benefit per transaction is $b_i$ and the fixed benefit of membership is $B$.
