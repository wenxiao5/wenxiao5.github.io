...
“Peanuts Effect” has found that risk-aversion decreases with decreasing monetary amounts, such that at very small stakes people are relatively more likely to be risk seeking than risk averse. Based on the ``peanuts effect'', this paper shows that, probabilistic price promotions are more attractive than equivalent sure discounts only when those sure discounts seem trivial.
