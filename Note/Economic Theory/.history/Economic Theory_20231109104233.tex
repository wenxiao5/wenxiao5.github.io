...
\begin{example} [(Random Assignment in School Choice)]
    \begin{enumerate}[$\circ$]
        \item Preference of Agents: $A_1: s_2\succ s_1\succ s_3$; $A_2: s_3\succ s_2\succ s_1$; $A_3: s_2\succ s_3\succ s_1$.
...
\begin{example}
    \begin{enumerate}[$\circ$]
        \item Preference of Agents: $A_1: s_2\succ s_3\succ s_1$; $A_2: s_2\succ s_3\succ s_1$; $A_3: s_1\succ s_2\succ s_3$.
