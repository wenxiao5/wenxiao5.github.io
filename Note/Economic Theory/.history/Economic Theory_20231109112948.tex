...
\normalfont
    ...
    \begin{enumerate}
        ...
        \begin{equation}
            \begin{aligned}
                y_j^*\in \arg\max_{y_j\in Y_j}\quad &p^*\cdot y_j
            \end{aligned}
            \nonumber
        \end{equation}
    ...
    \end{enumerate}
\end{definition}
Production economy is a more general form of excahneg economy. It is the same that not every P.O. allocation can be supported as a price signal with transfers.
