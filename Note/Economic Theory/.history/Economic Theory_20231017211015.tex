...
\begin{definition}
    \normalfont
    An allocation $x$ is \textbf{Pareto optimal/efficient} if there doesn't exist an allocation $y$ s.t. $u_i(y_i)\geq u_i(x_i)$ for each $i$ and $u_j(y_j)> u_j(x_j)$ for some $j$.
\end{definition}
