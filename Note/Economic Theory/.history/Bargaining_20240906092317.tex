...
\begin{equation}
    ...
    \nonumber
\end{equation}
More generally, define the problem begins at $t$ with $x(t)$ as
\begin{equation}
    \begin{aligned}
    ...
    \nonumber
\end{equation}
$v(t,x(t))$ with $x=x(t)$ may be written as $v_t(x)$ in the following.
...
\begin{proposition}[Hamilton-Jacobi-Bellman Equation]
    ...
    \begin{equation}
        ...
        \nonumber
    \end{equation}
    with a transversality condition $\lim_{T \rightarrow \infty}e^{-\rho T}v(x(T))=$
