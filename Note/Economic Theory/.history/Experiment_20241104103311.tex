...
This paper studies when and how the operation of the anchoring effect is bounded in the field. It uses the ``pay what you want'' (PWYW) context and shows that 1. The distributional gap is a better predictor than the absolute gap. 2. Low anchors influence payments more than high anchors.
