...
\begin{proof}
    ...
    \begin{equation}
        \begin{aligned}
            ...
            &=\sum_{j=1}^{L} \lambda^{*} p_{j} \frac{\partial x_{j}}{\partial p_{i}}& \textnormal{ by }\frac{\partial u\left(x^{*}\right)}{\partial x_{i}}=\lambda^{*} p_{i}\\
            &=-\lambda^{*} x_{i}^{*}&\textnormal{ by }\lambda^*\left(x(p,w)+p\cdot\frac{\partial x(p,w)}{\partial p}\right)=0
        \end{aligned}
        \nonumber
    \end{equation}
\end{proof}
