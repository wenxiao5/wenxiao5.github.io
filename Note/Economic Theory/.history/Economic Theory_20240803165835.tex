...
\subsection{Which games have nonempty core?}
\begin{definition}[Balancedness]
    A vector $(\lambda_S\geq 0)_{S\subseteq N}$ is \textbf{balanced} if $\sum_{\{S\subseteq N\mid i\in S\}}\lambda_S=1,\forall i\in N$.\\
