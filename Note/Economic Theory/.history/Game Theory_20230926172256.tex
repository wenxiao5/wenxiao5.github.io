...
\begin{equation}
    ...
    \nonumber
\end{equation}
As $\frac{\partial g}{\partial k}=f'(k+x_1^2)$ and $\frac{\partial g}{\partial x}=2x_1 f'(k+x_1^2)-\frac{1}{x_1^2}\frac{1}{\delta w}$, we can conclude $\frac{\partial x_1^*}{\partial k}>0$.
