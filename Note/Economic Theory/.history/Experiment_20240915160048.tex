...
\end{enumerate}
This is a theory based on the framework used in the first paper, choice based on reasons. That is interesting and useful to think in this way, but I am also thinking why cannot we use the reference dependence and loss aversion framework used in the second paper to explain. For example, a simple explanation: the introduction of a dominated decoy option can lower down references of both desirability and feasibility of individuals and then affect the loss aversion based on the reference. Then, the loss aversion of a low feasibility of HD decreases, which can attract more market share of HD.

Despite the alternative explanation, the upscaling effect can also be studied in a non-binary choice set, which can be more useful in practice.
