...
\section{General Equilibrium with Uncertainty: Asset Markets and Raduer Equilibrium}
Set-up:
\begin{enumerate}
...
Assume assets are in zero total supply.

Let $z_i\in \mathbb{R}^k$ denote agent $i$'s portfolio, so
\begin{equation}
    \begin{aligned}
