...
\begin{theorem}[Gibbend(73)-Satthe(75)]
    Suppose that $|X|\geq 3$ and a social choice function $f:\Theta \rightarrow X$ is surjective. Then $f$ is strategy-proof (DSIC) $\Leftrightarrow$ $f$ is dictatorial (\ref{SWF_properties}).
\end{theorem}
