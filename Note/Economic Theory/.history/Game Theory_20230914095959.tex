...
\end{enumerate}
The outcome of matching is $Y\substeq X$.

\begin{definition}[Stable Contracts]
    \normalfont
    $A\subseteq X$ is \textbf{stable} if
    \begin{enumerate}[$\circ$]
        \item Individually Rational (IR): $f\in F$ $C_f(A_f)=A_f$;
        \item Unblocked: $\nexists$ non-empty $Z\subseteq X$ such that $Z\cap A=\emptyset $ and for all $f$, $Z_f\subseteq C_f(A\cup Z)$.
    \end{enumerate}
\end{definition}
