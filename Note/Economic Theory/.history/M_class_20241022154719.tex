...
\begin{enumerate}
    ...
    \item Purchase thresholds narrow as $\mu$'s increase and converge to $\frac{\sigma^2}{4c}$.
    \item The expected utility is increasing in $\sigma^2$ and decreasing in $c$.
\end{enumerate}
The probability of purchase alternative $i$ is increasing in $\mu_i$. The probability of purchase one of the alternatives can be decreased by increasing one of the $\mu_i$ (which induces more searches).
