...
\begin{note}
    ...
    \begin{equation}
        ...
        \nonumber
    \end{equation}
    where $\lambda_i:=\frac{\partial v}{\partial x_i}(x)$ and $\frac{d \lambda_i}{dt}=\frac{\partial^2 v}{\partial x_i \partial t}+\frac{\partial^2 v}{\partial x_i^2}\frac{d x_i}{dt}$
\end{note}
