...
\begin{equation}
    \begin{aligned}
        \delta^2 F(y,h)&=\int_X\frac{d^2 F(y)}{d y(x)^2}h^2(x) dx=\int_X\frac{d^2 f(y(x))}{d y^2}h^2(x) dx\\
        \delta^2 G(y,h)&=\int_X\frac{d^2 G(y)}{d y(x)^2}h^2(x) dx=\int_X\left[g''(F(y))\left(\frac{d f(y(x))}{d y}\right)^2+g'(F(y))\frac{d^2 f(y(x))}{d y^2}\right]h^2(x) dx
    \end{aligned}
    \nonumber
\end{equation}
