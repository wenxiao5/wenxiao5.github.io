...
Model: Each period is consisted of three parts, 1. Pay cost $L$ because task is not done, 2. Observe current cost to do the task, $c\sim \textnormal{Unif}[0,1]$, 3. Choose to do task in $t$ or not.
