...
Consider the case of normal learning, that is the signal $s_i=U+\epsilon_i$, where $U\sim \mathcal{N}\left(v,e^2\right)$ and $\epsilon_i\sim \mathcal{N}\left(0,s^2\right)$. In discrete form, the posterior belief of $u$ after receiving $t$ number of signals is
\begin{equation}
    \begin{aligned}
        u(t)=\frac{\frac{v}{e^2}+\sum_{j=1}^t\frac{s_j}{s^2}}{\frac{1}{e^2}+\frac{t}{s^2}}
    \end{aligned}
    \nonumber
\end{equation}
