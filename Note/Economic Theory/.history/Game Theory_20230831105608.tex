...
\begin{proof}
    ...
    As we proved $b$ is non-empty, convex-valued and uhc from $S$ to $S$ where $S$ is non-empty, compact, and convex. By the Kakutani's Fixed Point Theorem \ref{thm:Kakutani's Fixed Point Theorem}, we have $b$ has a fixed point $s\in S$, whcih should be the Nash equilibrium.
\end{proof}
