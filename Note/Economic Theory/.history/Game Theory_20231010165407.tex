...
\begin{example}
    ...
    $\tilde{\mu}_I=\frac{1}{1+2\delta \sigma_\theta^2}\mu_I+\frac{2\delta\sigma_\theta^2}{1+2\delta\sigma_\theta^2}a_j$ and the variance is $\tilde{\sigma}_\theta^2=\left(\sigma_\theta^2+2\delta\right)^{-1}$.
\end{example}
