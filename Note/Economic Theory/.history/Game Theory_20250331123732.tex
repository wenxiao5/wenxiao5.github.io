...
\begin{itemize}
    ...
    \item Dynamic setting with infinite-horizon Bertrand competition
...
Demand shock $\epsilon_t$ is revealed to all firms, followed by simultaneous pricing decisions. The environment features complete information and perfect monitoring.
