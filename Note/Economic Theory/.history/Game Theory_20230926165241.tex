...
\subsection{Case 1}
$\alpha\in (0,1)$ are "good" type who picks $x_1=x_2=0$ and $1-\alpha$ are "bad" type who picks $\hat{x}=x_1=x_2>0$.
...
By our assumption about $f$, $f(u_1)\geq f(u_1+\hat{x}^2)$ means $u_1$ is closer to zero than $u_1+\hat{x}^2$. That is, $u_1<0$.
