...
\begin{proof}[Derivation from Discrete-time Bellman]
    ...
    \begin{equation}
        \begin{aligned}
            v(x(t))=\max_{\alpha(t)}\ r(x(t),\alpha(t)) + e^{-\rho\Delta}v(x(t+\Delta))
        \end{aligned}
        \nonumber
    \end{equation}
    ...
    \begin{equation}
        \begin{aligned}
            v(x(t))=\max_{\alpha(t)}\ r(x(t),\alpha(t)) + (1-\rho\Delta)v(x(t+\Delta))
        \end{aligned}
        \nonumber
    \end{equation}
    ...
    \begin{equation}
        \begin{aligned}
            \rho \Delta v(x(t))=\max_{\alpha(t)}\ r(x(t),\alpha(t)) + (1-\rho\Delta)[v(x(t+\Delta))-v(x(t))]
        \end{aligned}
        \nonumber
    \end{equation}
\end{proof}
