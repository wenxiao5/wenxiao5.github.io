...
\begin{equation}
    ...
    \nonumber
\end{equation}
where $N_j=\textnormal{Prob}\left(U^j\geq 0\right)$.
...
\begin{equation}
    \begin{aligned}
        N_i=\textnormal{Prob}\left(U^i\geq 0\right)=\textnormal{Prob}\left(b_i+\frac{B^i-C^i}{N^j}\geq P_i\right):=D^i\left(P_i,N^j\right)
    \end{aligned}
    \nonumber
\end{equation}
