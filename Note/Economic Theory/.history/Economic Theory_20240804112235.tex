...
\begin{definition}[Axioms]
    \begin{enumerate}[-]
        \item \textbf{{Axiom} 1:} A bargaining solution $f(U,d)$ is Pareto efficient if there does not exist a $(v_1, v_2)\in U$ such that $v\geq f(U,d)$ and $v_i>f_i(U,d)$ for some $i$.
        \item 
    \end{enumerate}
\end{definition}
