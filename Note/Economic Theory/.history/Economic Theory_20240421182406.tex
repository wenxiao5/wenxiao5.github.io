    ...
    \begin{enumerate}
        ...
        \begin{equation}
            \begin{aligned}
                ...
                \frac{\partial e(p,u)}{\partial p_i}&=\frac{\partial L(x,\lambda;(p,u))}{\partial p_i}\biggg|_{x^*=h(p,u)}=x_i|_{x^*=h(p,u)}=h_i(p,u)
            \end{aligned}
            \nonumber
        \end{equation}
    \end{enumerate}
...
\begin{equation}
    \begin{aligned}
        ...
        &=\left(\int_{\underline{\theta}_i}^{\theta_i}\bar{y}_i(s)ds\right)F_i(\theta_i)\bigg|_{\underline{\theta}_i}^{\overline{\theta}_i}\\
        &=\int_{\underline{\theta}_i}^{\overline{\theta}_i}\int_{s}^{\overline{\theta}_i}\bar{y}_i(s)f_i(\theta_i)d\theta_i ds\\
