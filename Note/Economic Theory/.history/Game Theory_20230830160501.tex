...
\begin{definition}[Bi-pooling Distribution]
    ...
    \begin{enumerate}[$\circ$]
        \item For all $i\in A$, $G((\underline{y}_i,\overline{y}_i))=F((\underline{y}_i,\overline{y}_i))$ and $|\textnormal{supp}(G|_{(\underline{y}_i,\overline{y}_i)})|\leq 2$ (at most two different values of $G$ over $(\underline{y}_i,\overline{y}_i)$).
