...
Preference of Agents: $A_1: s_2\succ s_1\succ s_3$; $A_2: s_3\succ s_2\succ s_1$; $A_3: s_2\succ s_3\succ s_1$.

Priority of Schools: $s_1: A\succ (B,C)$, $s_2: B\succ (A,C)$, $s_3: C\succ (A,B)$.
\end{example}
