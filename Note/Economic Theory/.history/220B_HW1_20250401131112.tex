...
\end{enumerate}
Since the zero point of \eqref{eq_p} $\frac{p_m-1}{\frac{p_m}{2}-\frac{5}{6}}$ gives a value $\frac{1}{2}$ for \eqref{eq_t}, there is no intersection of the two functions. That is, the probability of collusion is always higher with transparency.
\begin{equation}
    \begin{aligned}
        \textnormal{Pr}\left[\Pi^D_T(c_i,c_{-i})+\frac{\delta}{1-\delta}\Pi^P_T\leq \Pi^M_T(c_i,c_{-i})+\frac{\delta}{1-\delta}W_T\right]\bigg|_{\frac{\delta}{1-\delta}=\frac{p_m-1}{\frac{p_m}{2}-\frac{1}{3}}}=0\\
    \end{aligned}
    \nonumber
\end{equation}
