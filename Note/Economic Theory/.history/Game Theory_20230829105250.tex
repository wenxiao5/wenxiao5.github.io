...
\begin{definition}
    \normalfont
    A \textbf{competitive equilibrium} is a pair $p\in \mathbb{R}^L$ (price vector over $L$ goods) and an allocation $(x^i)_{i\in I}$ such that:
    \begin{enumerate}[(i).]
        \item $x^i\in \argmax u^i(x), \forall i\in I$ s.t. $p\cdot x\leq p\cdot w$.
        \item 
    \end{enumerate}
\end{definition}
