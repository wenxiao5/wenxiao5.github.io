...
\begin{equation}
    \begin{aligned}
        U(v,x,I,N)&=\max\left\{0,\max_{i\in I}v-t|x-z_i|\right\}
    \end{aligned}
    \nonumber
\end{equation}
where $v$ is the basic value of choosing an alternative, $x$ is the location of the consumer, $I$ is the set of products checked, $N$ is the number of products checked, and $z_i$ is the location of the alternative $i$.
