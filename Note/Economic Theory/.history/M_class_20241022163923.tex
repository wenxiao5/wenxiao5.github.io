...
Interaction between two end users.
\begin{example}
...
There exists membership charges gives membership externalities (benefits/hurts the other part) and usage charges gives usage externalities.
