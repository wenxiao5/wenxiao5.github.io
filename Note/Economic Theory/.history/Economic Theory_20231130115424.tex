...
\begin{definition}
    \normalfont
    A consumption allocation $(x_1^*,...,x_m^*)$, portfolio profile $(z_1^*,...,z_m^*)$, spot price vectors $(p_0^*,p_1^*,...,p_S^*)$ (at $t=1$), and asset price vector $q^*$ (at $t=0$) are a \textbf{Radner equilibrium} if
    \begin{enumerate}
