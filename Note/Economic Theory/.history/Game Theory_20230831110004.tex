...
\begin{definition}
    \normalfont
    A Bayesian game is defined by $\Gamma=(I, \{S_i\}_{i\in I}, \{u_i(\cdot)\}_{i\in I})$
    where $u_i(s_i,s_{-i},\theta_i)$ maps the strategies of players and player $i$'s type $\theta_i$ to player $i$'s utilities.
\end{definition}
