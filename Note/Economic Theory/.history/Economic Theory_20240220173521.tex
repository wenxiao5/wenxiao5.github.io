...
Define $\Gamma(\sigma)=\times_{i=1,...,n}\gamma_i\left(\vec{u}_i(\sigma^*_{-i})\right)$
...
\begin{definition}[S5 Conditions for Knowledge]
    ...
    \begin{enumerate}
        ...
        \item $K A \subseteq A$ (Axiom of knowledge)\\ If Alice knows $A$, then $A$ has indeed occurred.
...
\begin{theorem}[S5 $\Leftrightarrow$ Partitional]
    For an information function $P$ (and associated knowledge operator $K$), follwoing conditions are equivalent:
    \begin{enumerate}
