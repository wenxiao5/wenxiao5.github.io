...
\begin{definition}[Extensive Perfect Information Game]
    \normalfont
    Am extensive game with prefect information is defined as $G=\{N,A,H,Z,P,O,\succ_{n\in N}\}$, where $N$ is the set of players, $A$ is the set of players, $H$ is the set of all histories, $Z$ is the set of all histories that are terminals, $P:H/Z \rightarrow N$ is a mapping from a non-terminal histories to a player (who moves after a non-terminal history), and $O$ is the set of outcomes.
\end{definition}
...
\normalfont
A subgame of a PIG $G=\{N,A,H,Z,P,O,\succ_{n\in N}\}$ is a game (a PIG)that starts after a given finite history $h\in H$.
\end{definition}
