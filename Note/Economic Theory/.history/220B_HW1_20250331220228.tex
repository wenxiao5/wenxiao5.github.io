...
Suppose the cost is privately observed by each firm. Suppose in collusion, firms set price $p^M$, which generates a monopoly profit $\Pi^M(c)=\frac{(p^M-c)D(p^M)}{2}$. Suppose in perfect competition, a firm's expected profit is denoted by $\Pi^P$.
