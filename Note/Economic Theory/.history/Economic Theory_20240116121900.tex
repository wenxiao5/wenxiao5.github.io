...
\begin{proof}
    ...
    Let $\mathcal{U}=\{\vec{u}(\sigma):\sigma\in\Delta(A)\}$ and $\sigma^*$ be an undominated mixed action. Then, we have $\mathcal{U}\cap\{\vec{u}(\sigma^*)+\mathbb{R}_{++}^\Omega\}=\emptyset$.

    By the Separating Hyperplane Theorem \ref{SHT},
\end{proof}
