...
\begin{theorem}[Envelope Theorem]
    Suppose that $f(x,\cdot)$ is absolutely continuous for all $x\in X$. Suppose there exists an integrable function $b:[0,1] \rightarrow \mathbb{R}_+$ such that $|f_t(x,t)|\leq b(t)$ for all $x\in X$ and almost all $t\in[0,1]$. Then $V(t)=\sup_{x\in X}f(x,t)$ is absolutely continuous.

    Suppose, in addition, that $f(x,\cdot)$ is differentiable for all $x\in X$, and that $X^*(t)=\{x\in X: f(x,t)=V(t)\}\neq \emptyset$ almost everywhere on $[0,1]$. Then, for any selection $x^*(t)\in X^*(t)$,
...
\begin{definition}[Gâteux Derivative / First Variation]
...
\begin{definition}[Second-order Gâteux derivative]
...
\end{proposition}
More generally, consider the case with two i.i.d. signals. The posterior is given by
\begin{equation}
    \begin{aligned}
        \theta\mid s_1,s_2 \sim \mathcal{N}\left(\lambda_2(\lambda_1\mu_{\theta}+(1-\lambda_1)s_1)+(1-\lambda_2)s_2,\lambda_2\lambda_1\sigma_\theta^2\right)
    \end{aligned}
    \nonumber
\end{equation}
The $\lambda_1=\frac{\sigma_\varepsilon^{2}}{\sigma_\varepsilon^{2}+\sigma_\theta^{2}}$ and $\lambda_2$ is given by
\begin{equation}
    \begin{aligned}
        \lambda_2=\frac{\sigma_\varepsilon^2}{\sigma_\varepsilon^2+\lambda_1\sigma_\theta^{2}}=\frac{\sigma_\varepsilon^{2}+\sigma_\theta^{2}}{\sigma_\varepsilon^{2}+2\sigma_\theta^{2}}
    \end{aligned}
    \nonumber
\end{equation}
Thus,
\begin{equation}
    \begin{aligned}
        \theta\mid (s_1,s_2) \sim \mathcal{N}\left(\frac{\frac{\mu_{\theta}}{\sigma_\theta^{2}}+\frac{s_1+s_2}{\sigma_\varepsilon^{2}}}{\frac{1}{\sigma_\theta^{2}}+\frac{2}{\sigma_\varepsilon^{2}}},\frac{1}{\frac{1}{\sigma_\theta^{2}}+\frac{2}{\sigma_\varepsilon^{2}}}\right)
    \end{aligned}
    \nonumber
\end{equation}
...
\begin{equation}
    \begin{aligned}
        \theta\mid (s_1,...,s_n) \sim \mathcal{N}\left(\frac{\frac{\mu_{\theta}}{\sigma_\theta^{2}}+\frac{\sum_{i=1}^ns_i}{\sigma_\varepsilon^{2}}}{\frac{1}{\sigma_\theta^{2}}+\frac{n}{\sigma_\varepsilon^{2}}},\frac{1}{\frac{1}{\sigma_\theta^{2}}+\frac{n}{\sigma_\varepsilon^{2}}}\right)
    \end{aligned}
    \nonumber
\end{equation}
where
\begin{equation}
    \begin{aligned}
        \frac{\frac{\mu_{\theta}}{\sigma_\theta^{2}}+\frac{\sum_{i=1}^ns_i}{\sigma_\varepsilon^{2}}}{\frac{1}{\sigma_\theta^{2}}+\frac{n}{\sigma_\varepsilon^{2}}}&=\frac{\frac{\mu_{\theta}}{\sigma_\theta^{2}}+\frac{\sum_{i=1}^n(\mu_\theta+\epsilon_i)}{\sigma_\varepsilon^{2}}}{\frac{1}{\sigma_\theta^{2}}+\frac{n}{\sigma_\varepsilon^{2}}},\textnormal{ where }\epsilon_i\sim N(0,\sigma_\theta^2+\sigma_\varepsilon^2)\\
        &=\mu_\theta+\sqrt{\sigma_\theta^2+\sigma_\varepsilon^2}\frac{\frac{n}{\sigma_\varepsilon^{2}}}{\frac{1}{\sigma_\theta^{2}}+\frac{n}{\sigma_\varepsilon^{2}}}e_0,\textnormal{ where }e_0\sim N(0,1)
    \end{aligned}
    \nonumber
\end{equation}
...
\begin{proof}
    ...
    \begin{equation}
        \begin{aligned}
            \frac{\partial \mathcal{L}(f^*;\lambda)}{\partial f'(\theta)}&=-1+v(\theta)-\log\left(\frac{f^*(\theta)}{f(\theta)}\right)+\lambda=0, \textnormal{ for each }\theta\in \mathbb{R}\\
            \frac{\partial \mathcal{L}(f^*;\lambda)}{\partial \lambda}&=\int_{-\infty}^\infty f^*(\theta) d\theta - 1=0
        \end{aligned}
        \nonumber
    \end{equation}
    Thus, we have
