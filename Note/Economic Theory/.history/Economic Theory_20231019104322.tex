...
\begin{definition}[Reny 2022]
    \normalfont
    $\mu$ is \textbf{priority-neutral} iff $\exists$ no matching $u$ that can make any student \underline{whose priority is violated at $\mu$} better off unless $u$ violates the priority of some student and make them worse off.
\end{definition}
