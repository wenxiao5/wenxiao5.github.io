...
\section{Optimal Control and Hamiltonians}
...
\end{definition}
By Lagrangian functional: $\mathcal{L}(x(t),\alpha(t),\lambda(t))=e^{-\rho t}r(x(t),\alpha(t))$
We can obtain necessary and sufficient conditions for an optimum using the Hamiltonian:
