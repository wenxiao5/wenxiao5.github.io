...
An agent's utility function is defined by $u^i:(\underline{m},\infty)\times \{0,1\}^J \rightarrow (-\infty, +\infty)$ with assumption $\lim_{x_0 \rightarrow \underline{m}}u^i(x_0,x_I)=-\infty$ and $\lim_{x_0 \rightarrow \infty}u^i(x_0,x_I)=+\infty$
