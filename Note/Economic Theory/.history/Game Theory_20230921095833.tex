...
\begin{equation}
    \begin{aligned}
        ...
        C_f^S(Z|Y)&\triangleq C^f(Z_f^S\cup Y_f^B)\cap X_f^S
    \end{aligned}
    \nonumber
\end{equation}
where $Y$ is buyer side and $Z$ is seller side.
...
\begin{definition}
    \normalfont
    $C^f$ is fully substitute if for $Y'\subseteq Y\subseteq X$ and $Z'\subseteq Z\subseteq X$,
    \begin{equation}
        \begin{aligned}
