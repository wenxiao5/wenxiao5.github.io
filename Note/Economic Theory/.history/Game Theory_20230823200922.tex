...
\begin{center}\begin{figure}[htbp]
    ...
    \caption{FOSD: CDF and density comparison}
    \label{}
...
\begin{theorem}
    ...
    \begin{enumerate}
        \item Second-order Stochastic Dominance: $\int u (x) dF \geq \int u(x) dG$  for every weakly increasing concave utility function $u$.
