...
The criterion requires the (off-path) belief $\mu^*(\cdot)$ satisfies $P(\tilde{\theta}|e)=0,\forall e,\theta$ such that $u^*(\theta)>\max_{w\in[\underline{\theta},\overline{\theta}]}[w-c(e,\theta)]$.
