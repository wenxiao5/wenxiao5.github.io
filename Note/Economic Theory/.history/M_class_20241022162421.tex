...
\underline{Bundling:} A and B sold together. In this case, the bundled price is $p_{BD}=2c+t$ with the total profit being $\Pi_{BD}=\frac{t}{2}$. (Bundling induces more intensive profits).
