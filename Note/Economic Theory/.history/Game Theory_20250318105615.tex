...
\chapter{Bargaining}
We will use bargaining to refer to “a process to determine the terms of trade that is not adequately captured by off-the-shelf oligopoly models.” (Loertscher and Marx, 2021).
...
Each player $i$ has preferences, represented by a utility function $u_i$ over $X\cup\{D\}$. We denote the set of possible payoffs by set $U$ defined by
\begin{equation}
    \begin{aligned}
