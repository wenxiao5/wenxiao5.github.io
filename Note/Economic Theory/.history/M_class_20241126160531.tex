...
\begin{enumerate}
    \item Moral hazard: Let $t$ be the effort and $x$ be the output/sales (which follows a distribution $f(x\mid t)$ given the effort). The profit of the firm is $(1-c)x$ and the salary of a sales person is defined by $s(x)$.
