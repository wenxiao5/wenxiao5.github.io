...
\begin{assumption}
    The condition for reveal the true value:
    \begin{equation}
        \begin{aligned}
...
\begin{equation}
    ...
    \nonumber
\end{equation}
If $u_i$ is differentiable, $u'_i(x_i)=q_i(x_i)$. Then, we can write the envelop theorem/condition
\begin{equation}
    \begin{aligned}
...
\begin{theorem}[Revenue Equivalence Theorem]
    ...
    \begin{equation}
        \begin{aligned}
            t_i(x_i)=t_i(0)+q_i(x_i)x_i-\int_0^{x_i} q_i(y_i)dy_i
        \end{aligned}
        \nonumber
    \end{equation}
\end{theorem}
