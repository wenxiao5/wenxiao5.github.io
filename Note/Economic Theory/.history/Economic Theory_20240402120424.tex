...
Given the set of agents $I$ with utility function $u_i,i\in I$, alternatives (outcomes for the society) $X$, types (of agents) $\Theta$ with prior probability $\phi$, and a social choice function $f:\Theta=(\Theta_1,...,\Theta_I) \rightarrow X$.
