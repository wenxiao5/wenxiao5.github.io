...
\end{equation}
\begin{enumerate}
    \item Prefect price discrimination: charge price $p=c$ and $A_i=\frac{(\theta_i-c)^2}{2\theta_i}$. $\Pi_1=\lambda \frac{(\theta_1-c)^2}{2\theta_1}+\left(1-\lambda\right)\frac{(\theta_2-c)^2}{2\theta_2}$.
