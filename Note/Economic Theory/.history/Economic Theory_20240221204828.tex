...
\begin{enumerate}
    ...
    Interpretation: $K(E)$ (which we write as $KE$) is the event (the set of states) at which the agent knows that the event $E$ has occurred. \textcolor{red}{An agent ``knows $E$'' if $E$ obtains at all the states that the agent believes are possible.}
    ...
    \begin{definition}[Information Function given Knowledge]
        ...
        an \textbf{information function}, which \textcolor{red}{is the set of states that the agent considers possible when the actual state is $\omega$}.
    \end{definition}
