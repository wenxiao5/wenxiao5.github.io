...
A game in strategic form is denoted by $$G =\left(\underbrace{N}_{\textnormal{players}},\underbrace{\{S_i\}_{i\in N}}_{\textnormal{Strategy Set}},O,o,\underbrace{\{u_i(\cdot)\}_{i\in N}/\{\succ_i\}_{i\in H}}_{\textnormal{VNM utility/preference}}\right)$$
