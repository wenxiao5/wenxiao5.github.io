...
\paragraph{Structure of Emotions} `Primary emotions' arise in our immediate encounters with the external world.

`Nonprimary experiences' affect emotions through backward and forward \textit{consumption effect}: we can derive utility from the past or future experiences.
