...
Restrict the exchange economies for simplicity.
...
\begin{example}
    ...
    \begin{enumerate}
        ...
        \item If $p_1$ is large, then $Z_2(p)>0$ by the boundary condition (5) and lower bound condition (4). So, $Z_1(p)=-\frac{1}{p_1}Z_2(p)<0$ by Walras' Law.
    \end{enumerate}
\end{example}
