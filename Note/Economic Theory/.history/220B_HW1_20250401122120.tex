...
\begin{enumerate}
    ...
    \end{matrix}\right.$$ That is, the firm with the lower cost captures the whole market. The collusion generates a profit $\Pi^M(c_i,c_{-i})=p_m-c_i$ if $c_i< c_{-i}$ and $\Pi^M(c_i,c_{-i})=0$ if $c_i>c_{-i}$. The expected profit from sustaining collusion is $W=\int_0^1 (p_m-c)(1-c)dc=\frac{p_m-\frac{1}{2}}{2}$.
\end{enumerate}
