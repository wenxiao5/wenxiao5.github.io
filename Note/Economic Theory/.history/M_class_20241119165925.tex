...
\begin{enumerate}
    ...
    \item \underline{Double Marginalization (under uniform price)}: Suppose $D(p)=1-p$. \subitem Coordinated channel: $p^*=\argmax_p (p-c)(1-p)=\frac{1+c}{2}$. Total profit is $\frac{(1-c)^2}{4}$.
    \subitem If not coordinated, the manufacturer chooses a price for retailer and the retailer chooses a price for consumers.
    ...
    \begin{equation}
        \begin{aligned}
            p_W^*=\argmax_{p_W}\Pi^M(p_W)=\argmax_{p_W}\frac{(p_W-c)(1-p_W)}{2}=\frac{1+c}{2}
        \end{aligned}
        \nonumber
    \end{equation}
