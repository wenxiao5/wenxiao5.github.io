...
\begin{theorem}[Envelope Theorem]
    ...
    \begin{enumerate}[$\bullet$]
        ...
        \item Let $x^{*}$ and $\lambda^{*}$ denote the optimized values of the variables. (By KKT necessary conditions, we have $\frac{\partial f(x;\theta)}{\partial x}\bigg|_{x=x^*}=\lambda \frac{\partial g(x;\theta)}{\partial x}$)
    \end{enumerate}
\end{theorem}
