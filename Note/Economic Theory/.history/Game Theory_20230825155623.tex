...
\begin{definition}
    ...
    \begin{enumerate}
        ...
        \item The set of non-decreasing functions that majorize $f$ and $f(0)\leq g\leq f(1)$ is denoted by $$\textnormal{MPC}(f)=\{g\in L^1\mid g \textnormal{ is non-decreasing and }g\prec f\}$$
    \end{enumerate}
\end{definition}
