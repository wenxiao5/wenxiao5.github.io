...
\begin{definition}[Minority Reserves]
    \normalfont
     School has minority reserve $r_s^m$ whenever $\#$ of admitted minority students is less than $r_s^m$, then any minority students has higher priority than majority students.
\end{definition}
