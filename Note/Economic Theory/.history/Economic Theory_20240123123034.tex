...
\begin{definition}[Dominant Strategy]
    \normalfont
    A strategy $\sigma_i\in \Delta(S_i)$ is \textbf{dominant} for $i$ in $G$ if for all $\sigma'_i\neq \sigma_i$, we have $u_i(\sigma_i,\sigma_{-i})> u_i(\sigma'_i,\sigma_{-i}), \forall \sigma_{-i}\in\times_{j\neq i}\Delta(S_j)$.
\end{definition}
