...
\begin{equation}
    ...
    \nonumber
\end{equation}
where $\Pi^M_T(c_L,c_L)=\frac{(a-c_L)^2}{8}=\frac{\Pi^D_T(c_L)}{2}$. Then, $W_T-\Pi^M_T(c_L,c_L)=-\frac{(a-c_L)^2-(a-c_H)^2}{32}=\frac{(c_L-c_H)(2a-c_H-c_L)}{32}$. In the previous case, $W-\Pi^M(c_L)=\frac{\Pi^M(c_H)-\Pi^M(c_L)}{2}=\frac{(c_L-c_H)(a-p^M)}{4}$.
