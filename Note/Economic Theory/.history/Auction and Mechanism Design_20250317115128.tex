...
\begin{definition}[Social Welfare Function (SWF)]
    ...
    where $\mathcal{P}$ denotes the set of all social preference relations over $X$ and the relation $\trianglerighteq = f(\succcurlyeq_1, \ldots, \succcurlyeq_I)$ is interpreted as the \textbf{social preference relation}. Note that it is not required to be rational (i.e., complete and transitive).
\end{definition}
