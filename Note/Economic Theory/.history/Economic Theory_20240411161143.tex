...
\begin{proof}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}[$\circ$]
            ...
            \item Because $f(\cdot)=\left(k^*(\cdot),t_i(\cdot)\right)$ is DSIC, we have
            \begin{equation}
                \begin{aligned}
                    v_i(k^*(\hat{\theta}_i,\theta_{-i}),\theta^\epsilon_i)+t_i(\hat{\theta}_i,\theta_{-i})\geq v_i(k^*(\theta_i,\theta_{-i}),\theta^\epsilon_i)+t_i(\theta_i,\theta_{-i})
                \end{aligned}
                \nonumber
            \end{equation}
        \end{enumerate}
