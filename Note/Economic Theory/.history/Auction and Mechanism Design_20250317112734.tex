...
\begin{definition}[SWF's Properties]\label{SWF_properties}
    ...
    \begin{enumerate}[$\circ$]
        ...
        \item is \textbf{independent of irrelevant alternatives} (IIA) if, given $\trianglerighteq,\trianglerighteq'\in \mathcal{R}^I$, if $x \trianglerighteq y \Leftrightarrow x \trianglerighteq' y$, then $x \trianglerighteq y$
    \end{enumerate}
\end{definition}
