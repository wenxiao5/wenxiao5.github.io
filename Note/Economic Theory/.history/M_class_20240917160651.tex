...
\textbf{With price competition:} transportation cost is $t x^2$, where $x$ is the distance. Suppose the firm $A$ locates at $0$ and the firm $B$ locates at $1$. The profit of consumer $x$ from purchasing $A$ is $v-p_A-tx^2$ and the profit of consumer $x$ from purchasing $B$ is $v-p_B-t(1-x)^2$.
