...
We can find that $\textnormal{Pr}[\Pi^D(c)+\frac{\delta}{1-\delta}\Pi^P\leq \Pi^M(c)+\frac{\delta}{1-\delta}W]$ in \eqref{eq_p} and $\textnormal{Pr}[\Pi^D_T(c_i,c_{-i})+\frac{\delta}{1-\delta}\Pi^P_T\leq \Pi^M_T(c_i,c_{-i})+\frac{\delta}{1-\delta}W_T]$ in \eqref{eq_t} are increasing both in $\frac{\delta}{1-\delta}$.
