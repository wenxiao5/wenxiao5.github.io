...
\begin{proposition}[Properties of Hicksian Demand]
    ...
    \end{enumerate}
\end{proposition}
\begin{proof}[Proof of Law of Compensated Demand]
\end{proof}
...
\begin{proposition}[Properties of Expenditure Function]\ref{expen}
    \begin{enumerate}[(i).]
...
\end{corollary}
\begin{proof}
    By the concavity of $e(p,u)$ (\label{expen}), we can conclude $\nabla^2 e(p,u)\preceq 0$ (negative semi-definite). Then, we know its diagonal elements are non-positive $\frac{\partial e^2}{\partial p_i\partial p_i}=\frac{\partial h_i}{\partial p_i}\leq 0$.
\end{proof}
