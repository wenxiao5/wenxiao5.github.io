...
Consider the case of normal learning, that is the signal $s_i=U+\epsilon_i$, where $U\sim \mathcal{N}\left(v,e^2\right)$ and $\epsilon_i\sim \mathcal{N}\left(0,s^2\right)$.
