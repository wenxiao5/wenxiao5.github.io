...
Coordinated channel: $p^*=\argmax_p (p-c)(1-p)=\frac{1+c}{2}$. Total profit is $\frac{(1-c)^2}{4}$.
...
\begin{equation}
    \begin{aligned}
        p_W^*=\argmax_{p_W}\Pi^M(p_W)=\argmax_{p_W}\frac{(p_W-c)(1-p_W)}{2}=\frac{1+c}{2} \Rightarrow p^*=\frac{3+c}{4}
    \end{aligned}
    \nonumber
\end{equation}
...
\begin{enumerate}
    \item \underline{Two-part Tariff (Franchise Fee):} $T(q)=A+p_w\cdot q$
\end{enumerate}
