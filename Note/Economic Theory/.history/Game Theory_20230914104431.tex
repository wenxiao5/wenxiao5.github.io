...
$f(X^D,X^H)$ produces $\left(X\backslash R_H(X^H), X\backslash R_D(X^D)\right)$.

$g(X^D,X^H)$ produces $g_H(X^H)=\{x\in X: x\in C_H(X^H)\cup\{x\}\}$ and $g_D(X^D)=\{x\in X: x\in C_D(X^D)\cup\{x\}\}$.
