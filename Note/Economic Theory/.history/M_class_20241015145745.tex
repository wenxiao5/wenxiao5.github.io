...
Consider the case of normal learning, that is the signal $s_i=U+\epsilon_i$, where $U\sim \mathcal{N}\left(v,e^2\right)$ and $\epsilon_i\sim \mathcal{N}\left(0,s^2\right)$. The posterior belief of $u$ after receiving $\tau$ number of signals is
\begin{equation}
    \begin{aligned}
        u(\tau)=\frac{\frac{v}{e^2}+\sum_{j=1}^\tau\frac{s_j}{s^2}}{\frac{1}{e^2}+\frac{\tau}{s^2}}
    \end{aligned}
    \nonumber
\end{equation}
