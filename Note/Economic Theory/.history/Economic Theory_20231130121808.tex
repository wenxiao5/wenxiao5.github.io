...
Given an aseet payoff structure $R$, the payoff from the portfolio $z_i$ is $Rz_i\in \mathbb{R}^S$.
...
\begin{definition}[Complete Asset Structure $R$]
    \normalfont
    The asset structure with return matrix $R$ is \underline{complete} if $\textnormal{rank}R=S$. And the asset structure is \underline{incomplete} if $\textnormal{rank}R<S$.
\end{definition}
