...
\begin{proof}[Second Welfare Theorem \ref{SWT_sup}]
    ...
    Fix $j$ and suppose $\exists$ $x$ with $u_j(x_j)>u_j(x_j^*)$ for some $x_j\in \mathbb{R}_+^L$. By continuity, $\exists \epsilon\in (0,1)$ sufficient small s.t. $u_j((1-\epsilon)x_j)>u_j(x_j^*)$
