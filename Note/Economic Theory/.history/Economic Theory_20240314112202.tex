...
\begin{definition}[Perfect Bayesian Equilibrium]
    ...
    \begin{enumerate}
        \item The worker strategy optimal given firm strategies.
        ...
        \item Firms offer wages that forms a NE of the stage 2 game, where their belief $\mu^*(e)$ about their workers' type. (sequential rationality).
    \end{enumerate}
\end{definition}
