...
\begin{equation}
    ...
    \nonumber
\end{equation}
where $\Pi^M_T(c_L,c_L)=\frac{(a-c_L)^2}{8}$. Therefore, the numerator of the right-hand side increases and the denominator (weakly) decreases, so the collusion is more likely to sustain with transparency.
