...
\begin{equation}
    \begin{aligned}
        \frac{\partial \Pi_A(a,b)}{\partial a}=\underbrace{(p_A^*-c)\frac{\partial D_A^*}{\partial a}}_\textnormal{direct effect}+\underbrace{\frac{\partial D_A^*}{\partial p_A^*}}_{=0}\frac{\partial p_A^*}{\partial a}
    \end{aligned}
    \nonumber
\end{equation}
