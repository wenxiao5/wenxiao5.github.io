...
For a BIC $\&$ IR mechanism, the seller's expected revenues from bidder $i$:
\begin{equation}
    \begin{aligned}
        ...
        &=-\int_{\underline{\theta}_i}^\overline{\theta_i} \left(-\theta_i \bar{y}_i(\theta_i)+U_i(\underline{\theta}_i)+\int_{\underline{\theta}_i}^{\theta_i}\bar{y}_i(s)ds\right)f_i(\theta_i) d\theta_i\\
        &=
    \end{aligned}
    \nonumber
\end{equation}
