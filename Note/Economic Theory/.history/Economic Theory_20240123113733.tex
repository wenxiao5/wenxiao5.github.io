...
\normalfont
    A subgame of a PIG $G=\{N,A,H,Z,P,O,o,\succ_{n\in N}\}$ is a game (a PIG)that starts after a given finite history $h\in H$. Formally, the subgame $G(h)$ associated with $h=(h_1,...,h_n)\in H$ is $G(h)=\{N,A,H_h,Z,P,O,o_h,\succ_{n\in N}\}$, where
    \begin{equation}
        \begin{aligned}
