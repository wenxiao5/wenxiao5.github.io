...
Consider both $\textnormal{Pr}[\Pi^D(c)+\frac{\delta}{1-\delta}\Pi^P\leq \Pi^M(c)+\frac{\delta}{1-\delta}W]$ in \eqref{eq_p} and $\textnormal{Pr}[\Pi^D_T(c_i,c_{-i})+\frac{\delta}{1-\delta}\Pi^P_T\leq \Pi^M_T(c_i,c_{-i})+\frac{\delta}{1-\delta}W_T]$ in \eqref{eq_t} as functions of $\frac{\delta}{1-\delta}$. They are both increasing functions of $\frac{\delta}{1-\delta}$. Note that $p_m>1$, so the increasing rate of \eqref{eq_t} is smaller than \eqref{eq_p}, $\left(\frac{p_m}{2}-\frac{1}{3}\right)\left(p_m-\frac{\delta}{1-\delta}\left(\frac{p_m}{2}-\frac{1}{3}\right)\right)<p_m-\frac{5}{6}$. Since the zero point of \eqref{eq_t} is $\frac{p_m-1}{\frac{p_m}{2}-\frac{1}{3}}$ which is larger than the zero point of \eqref{eq_p} $\frac{p_m-1}{\frac{p_m}{2}-\frac{5}{6}}$, there is no intersection of the two functions. That is, the probability of collusion is always higher with transparency.
\begin{equation}
    \begin{aligned}
