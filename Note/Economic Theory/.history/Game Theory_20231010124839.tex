...
\begin{enumerate}
    ...
    \item \textbf{Period 2 Belief:} Given $y_2$ and the conjecture $\tilde{a}_2$, we have $$y_2-\tilde{a}_2=\theta+\epsilon_2$$
    Based on the normal-Normal learning  (\ref{NNL}), the posterior belief about $\theta$ is
    \begin{equation}
        \begin{aligned}
            N(\underbrace{\lambda_1\bar{\mu}_\theta+(1-\lambda_1)(y_1-\tilde{a}_1)}_{\bar{\bar{\mu}}_\theta},\underbrace{\lambda_1\sigma_\theta^2}_{\bar{\sigma}_\theta^2})
        \end{aligned}
        \nonumber
    \end{equation}
\end{enumerate}
