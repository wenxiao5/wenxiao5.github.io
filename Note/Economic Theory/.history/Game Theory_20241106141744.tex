...
\begin{theorem}[Envelope Theorem]
    Suppose that $f(x,\cdot)$ is absolutely continuous for all $x\in X$. Suppose there exists an integrable function $b:[0,1] \rightarrow \mathbb{R}_+$ such that $|f_t(x,t)|\leq b(t)$ for all $x\in X$ and almost all $t\in[0,1]$
\end{theorem}
