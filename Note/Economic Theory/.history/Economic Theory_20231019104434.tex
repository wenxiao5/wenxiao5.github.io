...
\begin{definition}[Reny 2022]
    \normalfont
    $\mu$ is \textbf{priority-neutral} iff $\exists$ no matching $u$ that can make any student whose priority is violated at $\mu$ better off \underline{unless} $u$ violates the priority of some student and make them worse off.
\end{definition}

\begin{theorem}
    $\exists$ a unique Priority-efficient matching 
\end{theorem}
