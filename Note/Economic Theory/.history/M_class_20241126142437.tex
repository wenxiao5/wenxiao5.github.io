...
\begin{enumerate}
    \item \underline{Two-part Tariff (Franchise Fee):} $T(q)=A+p_w\cdot q$. Set the $p_w$ such that the retailer chooses the price $p^*=p^*_\textnormal{coordinated}$ and the $A$ that extract all surplus of retalier.
\end{enumerate}
