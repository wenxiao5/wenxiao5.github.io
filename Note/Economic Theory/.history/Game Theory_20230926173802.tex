...
\begin{equation}
    \begin{aligned}
        \textnormal{Pr}(\textnormal{good}\midu_1)=\frac{\alpha f(u_1)}{\alpha f(u_1)+(1-\alpha)f(u_1+\hat{x}^2)}
    \end{aligned}
    \nonumber
\end{equation}
where $\textnormal{Pr}(\textnormal{good}\midu_1)\geq \alpha$ $\Leftrightarrow$ $f(u_1)\geq f(u_1+\hat{x}^2)$.
...
\begin{equation}
    \begin{aligned}
        \textnormal{Pr}(\textnormal{good}\midu_1)=\frac{\alpha f(x_g^2+u_1)}{\alpha f(x_g^2+u_1)+(1-\alpha)f(x_b^2+u_1)}
    \end{aligned}
    \nonumber
\end{equation}
Hence, $\textnormal{Pr}(\textnormal{good}\midu_1)\geq \alpha$ if and only if $f(x_g^2+u_1)\geq f(x_b^2+u_1)$.
