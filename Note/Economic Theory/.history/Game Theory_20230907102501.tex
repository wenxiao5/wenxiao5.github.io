...
\begin{definition}
    \normalfont
    $\Gamma$ \textbf{impliments} $f$ in dominant strategies if $\exists$ a dominant strategy equilibrium $s^*$ of $\Gamma$ such that $g(s_i^*(\theta_i),s_{-i})=f(\theta_1,...,\theta_I)$ for all $(\theta_1,...,\theta_I)\in \Theta$.
\end{definition}
