...
\end{enumerate}
A single item offered to a group of $N$ potential bidders. There are two stage: each bidders decides whether or not to enter by a fixed cost $c$, then an auction is conducted among $n$ participants (the number of bidders who enter).
