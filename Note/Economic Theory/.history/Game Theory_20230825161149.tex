...
\begin{proposition}[Kleiner et al. (2021), Proposition 1]
    \begin{enumerate}
        \item Suppose $f\in L^1$ is non-decreasing. Then $\textnormal{MPS}(f)$, $\textnormal{MPS}_w(f)$, and $\textnormal{MPC}(f)$ are convex and compact in the norm topology $\Rightarrow$ they all have non-empty set of extreme points.
        \item 
    \end{enumerate}
\end{proposition}
