...
\begin{enumerate}
    ...
    \textbf{Answer}: 1. Anticipated Utility carries more weight when the event is uncertain with high expectations and there is a time delay of the event. 2. Experienced Utility carries more weight when the consumer has stronger sensory or emotional perceptions.
