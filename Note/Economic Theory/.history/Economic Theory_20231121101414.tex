...
\begin{definition}[Direct Mechansim]
    ...
    Then a direct mechanism can be represented as $(Q,M)$, where $Q: \mathcal{X} \rightarrow \Delta N$ is the allocation rule and $M: \mathcal{X} \rightarrow \mathbb{R}^N$ is the payment rule.
\end{definition}
