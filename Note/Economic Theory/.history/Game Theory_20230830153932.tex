...
\begin{example}[ Lexicographic preferences (not continuous)]
    Under Lexicographic preference, $x \succ y$ \underline{if and only if}
    \begin{enumerate}[$\circ$]
        \item $x_{1}>y_{1}$, or
    ...
    Violates continuity: $\left(1+\frac{1}{n}, 1\right) \succ(1,2) ; \lim \left(1+\frac{1}{n}, 1\right)=(1,1) \prec(1,2)$
\end{example}
