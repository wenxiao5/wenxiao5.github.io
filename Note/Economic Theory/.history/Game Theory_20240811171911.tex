...
\begin{equation}
    \begin{aligned}
        \delta F(y,h)= \int_{\underline{x}}^{\bar{x}} \frac{\partial f(x,y(x),y'(x))}{\partial y}h(x) dx + \frac{\partial f(x,y(x),y'(x))}{\partial y'}h(x)\bigg|_{\underline{x}}^{\bar{x}}-\int_{\underline{x}}^{\bar{x}} h(x) d \frac{\partial f(x,y(x),y'(x))}{\partial y'}
    \end{aligned}
    \nonumber
\end{equation}
