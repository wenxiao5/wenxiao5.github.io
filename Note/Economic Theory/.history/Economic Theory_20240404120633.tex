...
\end{proposition}
\begin{proof}
    ``$\Leftarrow$'': Suppose by the way of contradiction that there exists $\left(\theta, k', t\right)$ such that $\sum_{i=1}^I t_i=0$ and $u_i(k',\theta_i)+t_i> v_i(k(\theta),\theta_i)$, $\forall i\in I$.
\end{proof}
