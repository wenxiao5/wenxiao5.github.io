...
\section{}
Consider an incumbent $I$ and a citizen $c$.
\begin{enumerate}[$\bullet$]
    \item $I$ picks $x_1\in \mathbb{R}$;
    \item Voter $V$ observes $u_1=-x_1^2+\epsilon$
\end{enumerate}
where $\epsilon\sim f$ and $f$ is uninormal of $0$, symmetric, continuous, and differentiable. $f'(z)$ is positive for $z<0$, negative for $z>0$, and zero for $z=0$.
