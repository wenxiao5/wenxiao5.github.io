...
Suppose the utility of consumer is
\begin{equation}
    \begin{aligned}
        U(v_i,z_i,p_i,N)
    \end{aligned}
    \nonumber
\end{equation}
where $v_i$ is known before search, $z_i$ is learning during search, $p_i$ is the price, and $N$ is set of the products searched.
