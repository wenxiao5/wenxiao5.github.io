...
\begin{theorem}[vNM]
    ...
    \begin{equation}
        ...
        \label{*}
    \end{equation}
    Moreover, $u$ is unique up to a \underline{positive affine transformation}: there is another $u'$ represents $\succ$ in the sense of \refeq{*} if and only if there exists $c>0$ and $d$ such that
    \begin{equation}
        \begin{aligned}
            u'(\cdot)=cu(\cdot)+d
        \end{aligned}
...
\begin{theorem}[Hicksian Economy works in finding Competitive Equilibrium]
