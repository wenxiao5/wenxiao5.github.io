...
\begin{enumerate}
    ...
    \item Secondly, consumers will seek to accumulate evidence that supports choice of the promising alternative.  Generally, if consumers can identify a reason that allows them to justify choosing the HD option, they will terminate the decision process by selecting the said option.
\end{enumerate}
