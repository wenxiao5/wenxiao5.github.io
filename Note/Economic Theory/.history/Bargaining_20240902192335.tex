...
\begin{equation}
    ...
    \nonumber
\end{equation}
Here, $x_t\in\mathbb{X}\subset \mathbb{R}^N$ is the \textbf{state}, $\alpha_t\in \mathbb{A}\subset \mathbb{R}^M$ is the \textbf{control}, $\rho>0$ is the \textbf{discount factor}, $\mu(\cdot): \mathbb{A}\times \mathbb{X} \rightarrow \mathbb{R}^N$ the drift 
