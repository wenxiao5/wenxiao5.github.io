...
\subsection{Individually Rational, Block}
...
\begin{definition}[Individually Rational]
    ...
    An \underline{allocation} $x=(x_1,...,x_m)$ is \textbf{individually rational} (IR) if $x^i\succeq_i w_i$ for all $i=1,...,m$.
\end{definition}
...
\begin{definition}
    \normalfont
    The \textbf{core} is the set of \underline{allocations} that cannot be blocked by any coalition.
\end{definition}
