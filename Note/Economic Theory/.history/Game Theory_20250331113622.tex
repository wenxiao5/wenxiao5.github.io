...
The key idea in finite horizon games is using multiple Nash equilibria at a later stage as a reward/punishment device. Note that in the repeated prisoner's dilemma, such multiplicity is absent.
