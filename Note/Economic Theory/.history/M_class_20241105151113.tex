...
\end{enumerate}
A refinement: you can only condition actions on payoff relevant state variables. For example, if $\Pi(a,h_1)=\Pi(a,h_2),\forall a$, we have $h_1$ and $h_2$ in the same state.
