...
\begin{proposition}
    Suppose each agent's utility function is continuous and strongly monotone. Then, an allocation $x^*$ in an exchange economy is Pareto-Optimal \underline{iff} it is a solution of \ref{Planner P} for some choice of $\{\bar{u}_i\}_{i\neq j}$.
\end{proposition}
