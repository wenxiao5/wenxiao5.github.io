...
\begin{proof}
    ...
    \begin{equation}
        \begin{aligned}
            ...
            &=\int_{\underline{\theta}_2}^{\overline{\theta}_2}\int_{\underline{\theta}_1}^{\min\{\overline{\theta}_1,\theta_2\}} \left(\theta_2\phi(\theta_2)-1+\Phi_2(\theta_2)\right)\phi_1(\theta_1)\phi_2(\theta_2)d\theta_1d\theta_2\\
        \end{aligned}
        \nonumber
    \end{equation}
\end{proof}
