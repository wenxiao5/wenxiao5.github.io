...
\begin{theorem}[Envelope Theorem]
    ...
    \begin{enumerate}[$\bullet$]
        \item Let the value function of the probelm be $V(\theta)\triangleq f(x^*(\theta),\theta)$.
    ...
    \begin{equation}
        \begin{aligned}
            \frac{\partial V}{\partial \theta_i}(x^*(\bar{\theta});\bar{\theta})=\left.\frac{\partial L}{\partial \theta_i}\right|_{x^{*}, \lambda^{*}}=\left.\frac{\partial f}{\partial \theta_i}\right|_{x^{*}}-\lambda^*\left.\frac{\partial g}{\partial \theta_i}\right|_{x^{*}}
        \end{aligned}
        \nonumber
    \end{equation}
    where $V(\theta)$
