...
\begin{definition}
    \normalfont
    \begin{enumerate}
        \item The set of non-decreasing functions that are majorized by $f$ is denoted by $$MPS(f)=\{g\in L^1\mid g \textnormal{ is non-decreasing and }g\prec f\}$$
        \item The set of non-negative, non-decreasing functions that are weakly majorized by $f$ is denoted by $$MPS_w(f)=\{g\in L^1\mid g \textnormal{ is non-decreasing and }g\prec f\}$$
    \end{enumerate}
\end{definition}
