...
\begin{equation}
    \begin{aligned}
        V(q^i_{t-1})=\max p^i_t\cdot (q^i_t+q^i_{ot})+V(q^i_t)
    \end{aligned}
    \nonumber
\end{equation}
where the $q^i_{t-1}$ is the number of new consumers in period $t-1$ who chooses $i$ and the $q^i_{ot}$ is a function about $q^i_{t-1}$ which represents the number consumers in previous period who chooses $i$ in this period.
