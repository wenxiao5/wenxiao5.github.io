...
\begin{proof}
    ...
    \begin{note}
        \begin{enumerate}
            ...
            \item $Z(p)\neq 0$ $\Rightarrow$ $\varphi(p)\subseteq \partial \Delta$
        \end{enumerate}
    \end{note}
    ...
    \end{claim}
    Let $p^n \rightarrow p\in\Delta$ and $q^n \rightarrow q\in\Delta$ where $(p^n,q^n)\in$ graph $\varphi$ $\forall n$:
    \begin{enumerate}[$\circ$]
        \item \underline{Case 1}: Suppose $p\in \textnormal{int}\Delta$. Since $p>>0$, assume without losing generality, $p^n>>0$ $\forall n$.
    \end{enumerate}
\end{proof}
