...
\begin{proposition}[Conditions for Maximum]
...
\end{proposition}
\begin{proof}
    Let $\tilde{H}(x(t),\alpha(t),L(t))=e^{-\rho t}r(x(t),\alpha(t))+L(t)f(x(t),\alpha(t))$. By the Proposition \ref{}, the first-order necessary for the optimal $\alpha(t)$ is
\end{proof}
