...
\begin{definition}[Trail]
    \normalfont
    \textbf{Trail} is the set of distinct edges $X^1,X^2,...,X^M$ such that the buyer side (the firm who is the buyer in the edge) of $X^i$ is exactly the seller side (the firm who is the seller in the edge) of $X^{i+1}$, which is denoted by $b(X^i)=s(X^{i+1})$, $i=1,...,M-1$.
\end{definition}
...
\begin{definition}
    ...
    \begin{enumerate}
        ...
        \item There is no locally blocking trail:
        $X^i\in C^{S(X^i)}(A\cup X^i)$; $\{X^i,X^{i+1}\}\in C^{b(X^{i})}(A\cup X^i\cup X^{i+1})$; $X^M\in C^{b(X^M)}(A\cup X^M)$.
    \end{enumerate}
\end{definition}
