...
\begin{definition}
    \normalfont
    Contracts are \textbf{unilateral substitutes} if for all $z,x\in X$ and $Y\subseteq X$ such that $z_D\notin Y_D$ if $z\in C_h(Y\cup\{z\}) \Rightarrow z\in C_h(Y\cup\{z\}\cup\{x\})$
\end{definition}
