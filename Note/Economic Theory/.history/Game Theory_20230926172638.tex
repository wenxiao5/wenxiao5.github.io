...
\begin{equation}
    ...
    \nonumber
\end{equation}
As $\frac{\partial g}{\partial k}=f'(k+x_1^2)$ and $\frac{\partial g}{\partial x}=2x_1 f'(k+x_1^2)-\frac{1}{x_1^2}\frac{1}{\delta w}$, 


we can conclude the optimal $k$ satisfies $k=-{x_1^*}^2$. Then, $f(0)=\frac{1}{\delta w}+\frac{1}{x_1^*}\frac{1}{\delta w} \Rightarrow $
\begin{equation}
    \begin{aligned}
        x_1^*=\frac{1}{1+\delta w f(0)}
    \end{aligned}
    \nonumber
\end{equation}
