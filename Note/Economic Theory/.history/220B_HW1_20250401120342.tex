...
\begin{equation}
    \begin{aligned}
        ...
        \nonumber
\end{equation}
If without cost shocks that $c\equiv \frac{1}{2}$, we have $\Pi^D(c)-\Pi^M(c)=\frac{p_m-\frac{1}{2}}{2}=W$ for all $c$ and $\Pi^P=0<\frac{1}{6}$. Thus, the LHS of the inequality decreases and the RHS increases, so the inequality is more likely to hold. That is, \textbf{the collusion is more likely to sustain without cost shocks}.
