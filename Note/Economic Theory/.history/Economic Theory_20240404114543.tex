...
\subsection{Quasi-linear Model}
Consider a $X=K\times \mathbb{R}^I$, in our example, $K$ represents a set of choices for projects and $\mathbb{R}^I$ represents the set of transfers for alll platers.
