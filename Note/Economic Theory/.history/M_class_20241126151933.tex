...
\begin{enumerate}
    \item \underline{Two-part Tariff}: $T(q)=A+p_w\cdot q$. Doesn't works. Marginal increase in demand gives $p_w-c$ for manufacturer and $p-p_w$ for retailer. High $p_w$ gives more incentive for manufacturer to provide service but less incentive for retailer to provide service.
    \item \underline{Price Ceiling}: $p^*\leq p^*_\textnormal{coordinated}$. Doesn't work.
    \item \underline{Quantity Forcing}: $q\geq D(p^*_\textnormal{coordinated})$. Still works.
\end{enumerate}
