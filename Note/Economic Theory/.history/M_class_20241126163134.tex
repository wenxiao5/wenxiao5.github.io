...
$\dot{G}=(1-G)f(A)-\delta G$, where $f(A)$ is concave.

\underline{Solution}: Approach $\hat{G}$ slowly, where $0=(1-\hat{G})f(\hat{A})-\delta \hat{G}$ Once you get there you stay there.
