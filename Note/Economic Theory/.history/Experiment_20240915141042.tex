...
\end{enumerate}
Different to the previous papers, this paper provides an interesting approach to remind us that there may exist more complex process of decision-making. Incorporating the search or information acquisition model into decision-making process can be helpful in explanation and may provide new insights for the future research either in quantitative field or behaviorl field.
