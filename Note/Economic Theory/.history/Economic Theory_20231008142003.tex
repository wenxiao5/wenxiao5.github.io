...
\begin{theorem}[Envelope Theorem]
    ...
    \begin{equation}
        \begin{aligned}
            \frac{\partial f}{\partial \theta_i}(x^*(\bar{\theta});\theta(\bar{\theta}))=\left.\frac{\partial L}{\partial \theta_i}\right|_{x^{*}, \lambda^{*}}=\left.\frac{\partial f}{\partial \theta_i}\right|_{x^{*}}-\lambda^*\left.\frac{\partial g}{\partial \theta_i}\right|_{x^{*}}
        \end{aligned}
        \nonumber
    \end{equation}
\end{theorem}
