...
\begin{example}
    ...
    Suppose there is a probability $x$ that the player 1 is ``irrational'' such that it always chooses $C$ in the first period, and it chooses $C$ in the second period if the player 2 chooses $C$ in the first period and chooses $\tilde{C}$ in the second period if the player 2 chooses $\tilde{C}$ in the first period.
\end{example}
