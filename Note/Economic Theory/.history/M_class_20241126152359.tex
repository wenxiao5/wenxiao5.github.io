...
Except the manufacturer that provides input $x$ with price $p_w$, there is a competitive industry that provides input $x^1$ with price $p_w^1$. The retailer produce outputs as $q=f(x,x^1)$.

The problem is the input distortion: use less $x$ than optimal,
\begin{equation}
    \begin{aligned}
        \frac{p_w}{p_w^1}>\frac{c}{c^1}
    \end{aligned}
    \nonumber
\end{equation}
