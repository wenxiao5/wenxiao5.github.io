...
Player $i$'s payoff with action $a_t$ at time $t$ is written as $\Pi_t^i(a_t,s_t)$, where $s_t$ is the payoff relevant state at time $t$. Let
\begin{equation}
    \begin{aligned}
        V^i(s_t)=\max_{a_t}\Pi_t^i(a_t,s_t)
    \end{aligned}
    \nonumber
\end{equation}
