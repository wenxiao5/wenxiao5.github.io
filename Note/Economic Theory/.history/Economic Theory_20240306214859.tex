...
Consider a labor market that has many identical firms. In competitive equilibrium, firms' profits are $0$. Firms are price (wage) takes. There are continuum of workers with productivity levels $\theta\in\left[\underbar{\theta},\bar{\theta}\right]$ ()
