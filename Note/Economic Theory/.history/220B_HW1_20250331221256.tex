...
If a firm $i$ has cost $c_L$, it may be beneficial to deviate to $p=\frac{a+c_L}{2}$ that gives a profit $\frac{(a-c_L)^2}{4}$ in that period and give $\Pi^P$ in following periods.
