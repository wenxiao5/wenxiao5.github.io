...
\begin{lemma}
    ...
    \end{enumerate}
    Then, in all separating PBE, $e\in \left[\underline{e},\overline{e}\right]$.\\
...
\end{enumerate}
In this application, the only PBE that survives Intuitive Criterion is the best separating PBE, $e^*(\theta_H)=\underline{e}$ (lowest effort).
