...
\begin{equation}
    \begin{aligned}
        p(c) = c + \frac{1}{[1-F(c)]^{n-1}}\int_{c}^{\overline{c}} [1-F(t)]^{n-1} dt
    \end{aligned}
    \nonumber
\end{equation}
...
The equilibrium expected profit of a firm with cost $c$ is:
\begin{equation}
    \begin{aligned}
        \int_{c}^{\overline{c}} [1-F(t)]^{n-1} dt
    \end{aligned}
    \nonumber
\end{equation}
Alternatively, we can express the expected profit across all possible cost realizations:
\begin{equation}
    \begin{aligned}
        \int_{\underline{c}}^{\overline{c}}\left(\int_{c}^{\overline{c}} [1-F(t)]^{n-1} dt\right)dF(c)=\int_{\underline{c}}^{\overline{c}} [1-F(c)]^{n-1}F(c) dc
    \end{aligned}
    \nonumber
\end{equation}
\end{example}
