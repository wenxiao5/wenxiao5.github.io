...
\begin{proposition}[$K_C A$ is common knowledge at $\omega\in K_C A$]
    Since $K_C A\in\Sigma_i$ for any $i$, we have $K_i K_C A=K_C A$. Hence, $K_C A$ is common knowledge at $\omega\in K_C A$
\end{proposition}
