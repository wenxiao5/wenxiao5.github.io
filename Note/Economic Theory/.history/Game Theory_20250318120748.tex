...
\begin{definition}[Nash-in-Nash Bargaining Solution]
    ...
    \begin{equation}
        ...
        \nonumber
    \end{equation}
    In other words, the outcome between each pair is the bilateral Nash bargaining solution, given the “equilibrium” conjecture that all other agreements are reached. (Nash equlibrium in Nash bargaining)
\end{definition}
