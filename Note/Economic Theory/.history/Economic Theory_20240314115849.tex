...
\begin{lemma}
    Define $\underline{e}$ and $\overline{e}$ such that $\theta_L=\theta_H-c(\underline{e},\theta_L)$ and $\theta_L=\theta_H-c(\overline{e},\theta_H)$. Then, in all PBE, $e\in \left[\underline{e},\overline{e}\right]$.
\end{lemma}
