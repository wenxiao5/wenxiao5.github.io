...
For the equilibrium refinement, we introduce the Grossman-Perry-Farrell equilibrium based on the perfect sequential equilibrium \citep{grossman1986sequential} and the neologism-proof equilibrium \citep{farrell1993meaning}. We formally define the Grossman-Perry-Farrell equilibrium by ruling out the self-signaling sets in Perfect Bayesian Equilibrium \citep{bertomeu2018verifiable,glode2018voluntary}.
