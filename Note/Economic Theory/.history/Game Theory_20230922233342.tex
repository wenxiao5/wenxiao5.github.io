...
\begin{example}
    ...
    where the distribution of $\varepsilon$ can be solved by $\left\{\begin{matrix}
        ...
        G(200)&=F(198)P(\varepsilon=2|x_F=198)+F(202)P(\varepsilon=-2)\\
        \frac{1}{100}&=F(198)P(\varepsilon=-98|x_F=198)+F(202)P(\varepsilon=-102)
    \end{matrix}\right.$
\end{example}
...
\begin{enumerate}
    ...
    Hence, the distribution of the posterior mean $s$ given the signal policy $\pi$, denoted by $F_\pi\in\Delta([0,1])$ is a \textit{mean-preserving contraction} of $F$ (i.e., $\exists \varepsilon_\omega\in\Delta([0,1])$ such that $\mathbb{E}[\varepsilon_\omega|\omega]=0$, $s=\omega+\varepsilon_\omega$ for all $\omega\in F$ and $s\in F_\pi$).
