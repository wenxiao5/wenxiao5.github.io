...
\begin{equation}
    ...
    \nonumber
\end{equation}
The price in second period should be $p_2=\frac{v_1^*}{2}$. Then, $v_1^*=p_1-\delta \frac{v_1^*}{2} \Rightarrow $ The price in the first period is given by
\begin{equation}
    \begin{aligned}
        \max_{p_1}\ p_1(1-v_1^*)+\delta \frac{(v_1^*)^2}{4}=p_1(1-p_1+\delta p_2)+\delta \frac{(v_1^*)^2}{4}
    \end{aligned}
    \nonumber
\end{equation}
