...
\begin{definition}[Properties of a Social Choice Function]\label{SWF_properties}
    ...
    \begin{enumerate}[$\circ$]
        ...
        \item \textbf{Independence of Irrelevant Alternatives (IIA)}: For any $\theta, \theta' \in \Theta$, if $u(x, \theta) > u(y, \theta) \Leftrightarrow u(x, \theta') > u(y, \theta')$, then $x = f(\theta) \Rightarrow y \neq f(\theta')$.
    \end{enumerate}
\end{definition}
...
\begin{definition}[Properties of a Social Welfare Function (SWF)]
    ...
    \begin{enumerate}[$\circ$]
        ...
        \item \textbf{Independence of Irrelevant Alternatives (IIA)}: For any $\theta, \theta' \in \Theta$, if $\mathbb{E}_xu_i(x, \theta) >\mathbb{E}_yu_i(y, \theta) \Leftrightarrow \mathbb{E}_xu_i(x, \theta') >\mathbb{E}_yu_i(y, \theta')$ for all $i$, then $x f(\theta) y \Rightarrow x f(\theta') y$.
    \end{enumerate}
\end{definition}
