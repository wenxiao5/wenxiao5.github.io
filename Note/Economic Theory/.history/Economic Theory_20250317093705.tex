...
\begin{definition}[Social Welfare Function (SWF)]
    %\normalfont
    Given the preference domain $\mathcal{A}\subseteq \mathcal{R}^I$,
    a \textbf{social welfare function} (SWF) is a mapping $$f:\mathcal{A} \rightarrow \mathcal{P}$$
...
\begin{definition}[SWF's Properties]\label{SWF_properties}
    %\normalfont
    A social welfare function $f: \mathcal{A}\rightarrow \mathcal{P}$
    \begin{enumerate}[$\circ$]
