...
This paper studies a new context effect, upscaling effect, that is when a systematically dominated decoy option is introduced to a set, the choice share of the option that is good at desirability (``HD'' option) increases rather than the option that is good at feasibility (``HF'' option).
