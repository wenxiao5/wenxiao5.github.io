...
\underline{2-Period Model:} Suppose consumers are uniformly distributed on $[0,1]$. $t\sim \textnormal{Unif}[0,1]$ is the transportation cost, $s$ is he switching cost, $f$ is the fraction of consumers that have the same preferences from period to period, and $\delta$ is the discount factor.
