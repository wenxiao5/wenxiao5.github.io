...
There are buyers $i\in N$ and goods $j\in J$. The indivisible demand is represented by $X_I\in\{0,1\}^J$ and the divisible money is represented by $x_0\in(\underline{m},\infty)$. The endowments of agents are denoted by $(w_0,w_I)$.
