...
\end{enumerate}
This is a theory based on the framework used in the first paper, choice based on reasons. That is interesting and useful to think in this way, but I am also thinking why cannot we use the reference dependence and loss aversion framework used in the second paper to explain. For example, a simple explanation: the introduction of a dominated decoy option can lower down references of both desirability and feasibility of individuals. Then, the loss aversion of a low feasibility of HD based on the reference decreases, which can attract more market share of HD.
