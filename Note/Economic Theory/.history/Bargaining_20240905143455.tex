...
\begin{definition}[Hamilton-Jacobi-Bellman Equation]
    The value function of the generic optimal control problem satisfies the Hamilton-Jacobi-Bellman equation
