...
\begin{proof}
    ...
    \begin{enumerate}
        ...
        Suppose by the way of contradiction $h^*(\theta_i,\theta_{-i})\neq h^*(\hat{\theta}_i,\theta_{-i})$, WLOG, we consider $h^*(\theta_i,\theta_{-i})>h^*(\hat{\theta}_i,\theta_{-i})$. There is an $\epsilon>0$ s.t. $h^*(\theta_i,\theta_{-i})>h^*(\hat{\theta}_i,\theta_{-i})+\epsilon$.\\
