...
\begin{enumerate}
    \item Consider the second period first. Suppose $q_1^i$ consumers bought $i$ in the first period, where $q_1^i=1-q_1^{-i}$.\\
    Assume the consumers who bought from one firm in the first period and did not change preferences continue to buy from that firm in the second period.
    \item 
\end{enumerate}
