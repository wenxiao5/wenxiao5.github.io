...
\begin{example}
    ...
    - Any majority-coalition of 2 or 3 parties-may control the allocation of output.
    ...
    - A firm, player 0 , may hire from the pool of workers $\{1,2, \ldots, n\}$.
    - Profit from hiring $k$ workers is $f(k)$.
    $$
