...
\begin{enumerate}
    ...
    \textbf{Answer}: Experienced utility. As I mentioned before, it is the easiest to measure and exhibits the least variability among consumers. It is most useful one and the one that is most likely to be accurately predicted if we want to study some pattern of consumer behavors.
