...
\begin{definition}[Strictly Convex]
    \normalfont
    $\succeq$ is \textbf{strictly convex} if for every $x\in X$, $y_1\neq y_2$, $y_1\succeq x$ and $y_2\succeq x$ $\Rightarrow$ $\alpha y_1+ (1-\alpha) y_2\succ x$ for all $\alpha\in(0,1)$.
\end{definition}
