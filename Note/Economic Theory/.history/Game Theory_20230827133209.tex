...
\section{Definitions}
\begin{definition}[Jensen (2018), Defnition 1]
    \normalfont
...
\begin{corollary}[Majorization $\Leftrightarrow$ Mean-preserving Contraction]\label{}
    \begin{center}
        $F$ majorizes $G$ $\Leftrightarrow$ $F$ is a mean-preserving contraction of $G$ ($G$ is a mean-preserving spread of $F$)
    \end{center}
    Moreover, based on the majorization definition that restrict $F$ and $G$ being non-decreasing (weakly increasing), $F$ is a mean-preserving contraction of $G$
\end{corollary}
