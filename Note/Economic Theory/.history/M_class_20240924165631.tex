...
\begin{equation}
    ...
    \nonumber
\end{equation}
where $(v_j,z_j)$ are the parameters of the consumer that reflects his preference, h $v_j$ is known before search, $z_j$ is learning during search, $p_j$ is the price, $N$ is set of the products searched by the consumer, $s_k$ is the search cost of product $k$.
