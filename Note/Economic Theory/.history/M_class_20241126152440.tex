...
Except the manufacturer that provides input $x$ with price $p_w$, there is a competitive industry that provides input $x'$ with price $p'_w$. The retailer produce outputs as $q=f(x,x')$.

The problem is the input distortion: use less $x$ than optimal,
\begin{equation}
    \begin{aligned}
        \frac{p_w}{p'_w}>\frac{c}{c^1}
    \end{aligned}
    \nonumber
\end{equation}
