...
\begin{equation}
    ...
    \nonumber
\end{equation}
Therefore, there exists $\delta\in \left[\frac{1}{\sqrt{2}},\frac{1}{2}\right]$ that can make collusion in both markets.
...
\begin{enumerate}
    ...
    \begin{equation}
        ...
        \nonumber
    \end{equation}
    \item Cournot competition: $P_{ts}=MC_{its}-\farc{1}{2}Q_{ts}\frac{\partial P_{ts}}{\partial q_{1ts}}$.
\end{enumerate}

Then, testing the perfect competition or collusion, can be given by estimation
\begin{equation}
    \begin{aligned}
