...
\begin{equation}
    \begin{aligned}
        ...
        &=\int_X \left[\frac{\partial f(x,y(x),y'(x))}{\partial y}h(x)+ \frac{\partial f(x,y(x),y'(x))}{\partial y'}h'(x)\right] dx\\
        &=\int_X \frac{\partial f(x,y(x),y'(x))}{\partial y}h(x) dx + \int_X \frac{\partial f(x,y(x),y'(x))}{\partial y'}d h(x)
    \end{aligned}
    \nonumber
\end{equation}
...
\begin{equation}
    \begin{aligned}
        \int_X \frac{\partial f(x,y(x),y'(x))}{\partial y'}d h(x) = \frac{\partial f(x,y(x),y'(x))}{\partial y'}h(x)\bigg|_X
    \end{aligned}
    \nonumber
\end{equation}
