...
\begin{enumerate}
    ...
    \end{matrix}\right.$$ That is, the firm with the lower cost captures the whole market. Given $c_1<c_2$, the collusion generates a profit $\Pi^M(c_1,c_2)=$ for a firm with cost $c$. The expected profit from sustaining collusion is $W=\int_0^1 \Pi^M(c)dc=\frac{p_m-\frac{1}{2}}{2}$.
\end{enumerate}
