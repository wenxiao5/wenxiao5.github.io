...
\begin{definition}[Axioms]
    ...
    \textbf{Axiom 3 (Invariance to Linear Transformations)}: A bargaining solution $f$ is invariant if for any bargaining problem $(U, d)$ and all $\alpha_i\in (0, \infty)$, $\beta_i\in \mathbb{R}$ ($i=1,2$), if we consider the bargaining problem $(U',d')$ with
    \begin{equation}
        \begin{aligned}
