...
\begin{equation}
    ...
    \nonumber
\end{equation}
If products are complementary, $P$'s are lower. $\frac{P-MC}{P}<\frac{1}{E}$. In competition, the complementary properties decrease the prices, giving lower expected profits.
