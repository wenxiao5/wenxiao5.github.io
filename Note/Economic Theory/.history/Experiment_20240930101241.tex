...
\begin{enumerate}
    ...
    \item \textit{Interim stage}: after taking the quiz but before learning her own score or the score of anyone. (We think of $i$ as having observed a signal of her score, which is assumed to be a realization of a random variable $Y_i=X_i+E_i$, where $E_i\sim \mathcal{N}(0,v_E)$.)
