...
\begin{enumerate}
    ...
    \item Retailer knows more about demand than manufacturer: Solved by screening, i.e., a menu that the highest type gets efficient quantity and the lowest type gets zero profit.
\end{enumerate}
