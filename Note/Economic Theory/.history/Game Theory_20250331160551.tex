...
\begin{example}[Battle of the Sexes]
    Consider a coordination game between a couple deciding where to spend their evening:
    \begin{itemize}
        \item Players: Husband (H) and Wife (W)
        \item Actions: Opera (O) or Movie (M)
        \item Payoffs: Both prefer being together, but H prefers Opera while W prefers Movie
    \end{itemize}
    ...
    \begin{enumerate}
        \item Pure strategy NE 1: (O,O) with payoffs (3,2)
        \item Pure strategy NE 2: (M,M) with payoffs (2,3) 
        \item Mixed strategy NE: H plays O with probability 3/5, W plays O with probability 2/5
    \end{enumerate}
\end{example}
