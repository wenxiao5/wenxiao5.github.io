...
\begin{proof}
    ...
    \begin{equation}
        \begin{aligned}
            ...
            &\left(\textnormal{By KKT necessary conditions, we have }\frac{\partial f}{\partial x}(x^*;\theta)=\lambda^* \frac{\partial g}{\partial x}(x^*;\theta)\right)\\
            &=\frac{\partial f}{\partial \theta_i}(x^*;\bar{\theta})+\lambda^* \frac{\partial g}{\partial x}(x^*;\theta)\frac{\partial x^*(\bar{\theta})}{\partial \theta_i}\\
        \end{aligned}
        \nonumber
    \end{equation}
\end{proof}
