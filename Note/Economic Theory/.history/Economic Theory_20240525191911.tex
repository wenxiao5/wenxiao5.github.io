...
\begin{note}
    Different to the original paper, we focus on the ``free entry'' case (i.e., the mechanism can be denoted by the reserve prices $R=\{R_1,...,R_N\}$). We also assume the seller's valuation is $\underline{v}>0$.
\end{note}
