...
\begin{enumerate}
    ...
    The mixed strategies of the long-run self are maps from histories $h$ and the current state $y$ to self-control actions $r$: $$\sigma_{LR}: H\times Y \rightarrow \mathbb{R}$$
