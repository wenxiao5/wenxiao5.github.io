...
\begin{definition}
    \normalfont
    An allocation $(x^*,y^*)$ in a private ownership production economy is \textbf{Pareto optimal} if there is no other allocation $(x,y)$ s.t. $x_i\succ_i x_i^*, \forall i$ and $x_h\succ_h x_h^*$ for some $h$.
\end{definition}
