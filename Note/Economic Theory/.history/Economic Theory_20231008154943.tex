...
\begin{proof}
    ...
    \begin{equation}
        \begin{aligned}
            ...
            \left(\textnormal{By }\frac{\partial u\left(x^{*}\right)}{\partial x_{i}}=\lambda^{*} p_{i}\right)&=\sum_{j=1}^{L} \lambda^{*} p_{j} \frac{\partial x_{j}}{\partial p_{i}}\\
            \left(\textnormal{By }\lambda^*\left(x(p,w)+p\cdot\frac{\partial x(p,w)}{\partial p}\right)=0\right)&=-\lambda^{*} x_{i}^{*}
        \end{aligned}
        \nonumber
    \end{equation}
\end{proof}
