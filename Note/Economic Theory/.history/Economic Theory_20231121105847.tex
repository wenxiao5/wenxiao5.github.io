...
\begin{theorem}[Standard Revenue Equivalence Theorem]
...
\end{theorem}
\begin{proof}
    If equilibrium, is symmetric and increasing, then object is \underline{always} allocated to the bidder with the highest value.
\end{proof}
