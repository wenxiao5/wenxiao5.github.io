...
\begin{equation}
    \begin{aligned}
        ...
        &\frac{A}{p\cdot D}=(p-c)\underbrace{\frac{\partial D}{\partial A}\frac{A}{p\cdot D}}_\textnormal{elasticity: demand wrt advertising}\\
        &\frac{A}{p\cdot D}=(p-c)E_\textnormal{demand wrt advertising}
    \end{aligned}
    \nonumber
\end{equation}
