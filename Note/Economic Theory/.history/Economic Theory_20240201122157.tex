...
\begin{definition}[Normal-form Bayesian game]
    \normalfont
    Assume a finite game. The normal-form game can be represented by $$\left(I,(S_i,U_i)_{i\in I}\right)$$ defined by letting $S_i$ be the set of strategies based on types $s_i:\Theta_i \rightarrow A_i$ and
    \begin{equation}
        \begin{aligned}
    ...
    A \textbf{Bayesian Nash equilibrium} of a Bayesian game is a strategy profile $(\sigma_1,...,\sigma_n)$ that is a Nash equilibrium of the derived normal-form game.
\end{definition}
