...
\begin{proof}
    ...
    \begin{equation}
        \begin{aligned}
            \frac{\partial V}{\partial \theta_i}(\bar{\theta})=\frac{\partial f}{\partial \theta_i}(x^*;\bar{\theta})+\frac{\partial f(x^*;\bar{\theta})}{\partial x}\frac{\partial x^*(\bar{\theta})}{\partial \theta_i}
        \end{aligned}
        \nonumber
    \end{equation}
\end{proof}
