...
\paragraph*{Two-part Tariffs (Linear Price):} $T(q)=A+p\cdot q$ (quantity discount).
...
\begin{enumerate}
    ...
    \item Two-part tariff: $A=\min\{S_1(p),S_2(p)\}=S_1(p)$. The optimal $p$ is given by
    \begin{equation}
        \begin{aligned}
