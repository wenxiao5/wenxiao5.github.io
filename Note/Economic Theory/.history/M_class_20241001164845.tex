...
\begin{enumerate}
    ...
    \item The expected search cost to find this product is $c\frac{1}{\hat{N}}+2c\frac{\hat{N}-1}{\hat{N}}\frac{1}{\hat{N}-1}+\cdots \left[(N-1)c\frac{\hat{N}-1}{\hat{N}}\frac{\hat{N}-2}{\hat{N-1}}\cdots\frac{1}{2}\right]$
\end{enumerate}
