...
\begin{enumerate}
    ...
    \item There are $J$ firms. Each firm $j=1,...,J$ has a production set $y_j\subseteq \mathbb{R}^L$ that is nonempty, (which can represent both input and output).
\end{enumerate}

\begin{note}
    Standard sign convention regarding net output vectors: $y$ represents net output; $y_k\leq 0$ $\Rightarrow$ good $k$ is a net input in $y$; $y_k\geq 0$ $\Rightarrow$ good $k$ is a net output in $y$
\end{note}
