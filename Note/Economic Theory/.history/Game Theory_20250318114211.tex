...
\section{Bilateral Negotiations (Axiomatic Complete Information)}
...
\section{Multiple Simultaneous Negotiations (Axiomatic Complete Information)}
Suppose that instead of just two agents, we have a finite set $\{1,...,N\}$. Let $\mathcal{G}$ be the set of pairs, $ij$, that can feasibly form agreements to work together.

Let $p_{ij}$ be the transfer from $j$ to $i$ if they reach agreement.
