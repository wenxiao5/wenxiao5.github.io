...
Cross subsidizing deviation by a firm, $(\tilde{w},\tilde{t})$ (signed by low type) and $(\tilde{\tilde{w}},\tilde{\tilde{t}})$ (signed by high type), is a profitable deviation if $\lambda$ is large enough.
...
\begin{enumerate}[$\circ$]
    ...
    \item Each bidder has a valuation for the object, $X_i$, $x_i\in[\underline{x},\overline{x}]$.
    \item Strategy of $i$: $b_i:[\underline{x},\overline{x}] \rightarrow \mathbb{R}$, a \underline{bid function}.
\end{enumerate}

\begin{assumption}
    1. Independence; 2. Symmetry; 3. Private Values.
\end{assumption}
