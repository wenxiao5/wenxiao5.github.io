...
\begin{equation}
    \begin{aligned}
        ...
        \frac{p_m-c}{2}\leq\frac{\delta}{1-\delta}\left(\frac{p_m-\frac{1}{2}}{2}-\frac{1}{6}\right)\\
        \frac{\delta}{1-\delta}\geq \frac{p_m-c}{p_m-\frac{5}{6}}
        \end{aligned}
        \nonumber
\end{equation}
If without cost shocks that $c\equiv c$, we have $\Pi^M(c)=\frac{p_m-c}{2}=W$ and $\Pi^P=0$. Thus, the LHS of the inequality decreases and the RHS increases, so the inequality is more likely to hold. That is, the collusion is more likely to sustain without cost shocks.
