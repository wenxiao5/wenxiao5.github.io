...
\begin{equation}
    \begin{aligned}
        \int_{\underline{c}}^{\overline{c}}\left(\int_{c}^{\overline{c}} F^{n-1}(t) dt\right)dF(c)=\left(\int_{c}^{\overline{c}} F^{n-1}(t) dt\right)F(c)\bigg|_{\underline{c}}^{\overline{c}}-\int_{\underline{c}}^{\overline{c}}\left(\int_{c}^{\overline{c}} F^{n-1}(t) dt\right)dF(c)
    \end{aligned}
    \nonumber
\end{equation}
\end{example}
