...
\begin{theorem}[Envelope Theorem]
    ...
    \begin{equation}
        \begin{aligned}
            \frac{\partial V}{\partial \theta_i}(\bar{\theta})=\frac{\partial L}{\partial \theta_i}(x^{*}, \lambda^{*};\bar{\theta})=\frac{\partial f}{\partial \theta_i}(x^{*};\bar{\theta})-\lambda^*\left.\frac{\partial g}{\partial \theta_i}\right|_{x^{*}}
        \end{aligned}
        \nonumber
    \end{equation}
\end{theorem}
