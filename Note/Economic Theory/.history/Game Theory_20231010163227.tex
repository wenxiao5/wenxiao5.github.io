...
\textbf{Motivated Reasoning:} the voter is maximizing $\log f_{\theta|s}(\tilde{\theta}_I|s)+\delta v(a_j,\tilde{\theta}_I)$.\\
Assumptions: weakly concave in $\tilde{\theta}_I$ and $\frac{\partial^2 v(a_j,\tilde{\theta}_I)}{\partial a_j \partial \tilde{\theta}_I}$
