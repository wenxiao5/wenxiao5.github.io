...
\begin{definition}
    An $\epsilon$-constrained equilibrium of a strategic form game is a mixed strategy profile $\sigma^\epsilon$ such that there exists $\bar{\epsilon}: \bigcup_{i \in I} S_i \rightarrow(0, \epsilon)$ such that for each player $i$,
    \begin{equation}
        \begin{aligned}
...
\begin{definition}[Trembling-hand Perfect Equilibrium]
    A strategy profile $\sigma$ is a trembling-hand perfect equilibrium of a strategic form game if it is a limit of $\epsilon$-constrained equilibria as $\epsilon \rightarrow 0$.
\end{definition}

\begin{note}
    Trembling-hand Perfect Equilibrium is always a Nash equilibrium, while a Nash equilibrium is not always a trembling-hand perfect equilibrium.
\end{note}
