...
\begin{enumerate}
    \item Very Negative to Very Positive (can be combined with confidence level).
    \item Neutral to Extreme.
    \item Ambivalence (e.g. someone has both extremely negative ideas and extremely positive ideas).
\end{enumerate}
