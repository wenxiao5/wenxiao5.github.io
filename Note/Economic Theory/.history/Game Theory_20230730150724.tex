...
\begin{definition}[Nash Equilibrium]
    ...
    \begin{enumerate}
        \item $\sigma(t,s)>0$ implies $\sum_a \alpha(s,a)u(t,s,a) = \max_{s'\in \mathcal{S}}\left(\sum_a \alpha(s',a)u(t,s',a)\right)$.
        \item For each $s$ such that $\sum_{t}\sigma(t,s)\rho(t)>0$
    \end{enumerate}
\end{definition}
