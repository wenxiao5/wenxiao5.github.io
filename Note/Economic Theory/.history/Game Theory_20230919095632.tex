...
Doctors, $D$; Hospitals, $H$; Contracts $X=D\times H\times \textnormal{terms}$

Hospitals preference $\succ_h$ over $2^X$;

Doctors preference $\succ_d$ over $X$;

Outcome is $Y\subseteq X$ s.t. $|Y_d|\leq 1$ for all $d\in D$ (a doctor signs at most one contract).
