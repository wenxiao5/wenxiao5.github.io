...
\begin{example}[ (Representative Agent Model)]
    ...
    For example, suppose there are $2$ goods: time (label/leisure) $x_l$ and consumption $x_c$.\\
    Suppose the firm's production set is defined by a production function $f: \mathbb{R}_+ \rightarrow \mathbb{R}$.
\end{example}
