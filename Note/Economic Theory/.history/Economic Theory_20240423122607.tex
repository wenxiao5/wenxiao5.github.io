...
\begin{proof}
    ...
    \begin{equation}
        \begin{aligned}
            ...
            &=\int_{\underline{\theta}_2}^{\overline{\theta}_2}\int_{\underline{\theta}_1}^{\min\{\overline{\theta}_1,\theta_2\}} \left(\theta_2\phi(\theta_2)-1+\Phi_2(\theta_2)\right)\phi(\theta_1)d\theta_1d\theta_2-\int_{\underline{\theta}_2}^{\overline{\theta}_2}\int_{\underline{\theta}_1}^{\min\{\overline{\theta}_1,\theta_2\}}\left(\theta_1\phi(\theta_1)+\Phi(\theta_1)\right)\phi_2(\theta_2)d\theta_1d\theta_2\\
