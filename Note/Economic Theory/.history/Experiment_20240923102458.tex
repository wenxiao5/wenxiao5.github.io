...
Prior research establish the dual-system model that both the emotional system and the cognitive system contribute to decision-making. This paper hypothesizes that a higher reliance on emotional system can lead to greater interpersonal consistency in preferences.

In the experiments, they try to control the use of emotional systems through different ways. However, I found the control of experiments are not very reliable. The word ``emotional'' is not that accurate and convincing to relate to the controls using in the experiments.
