...
\end{assumption}
Given this assumption, the identified set for the true outcome probabilities given $x\in \mathcal{X}$, denoted by $\mathcal{H}(P(\cdot\mid x);\mathcal{B}_x)$, equals the set of $\tilde{P}(\cdot\mid x)\in\Delta \mathcal{Y}$
