...
\begin{enumerate}
    ...
    \begin{equation}
        \begin{aligned}
            \pi_j(\boldsymbol{p},\boldsymbol{z}=(\boldsymbol{x},\boldsymbol{w}),\boldsymbol{\xi},\omega_j,\boldsymbol{\theta}=(\theta_d,\boldsymbol{\gamma}))&=p_jq_j-C_j(q_j,w_j,\omega_j,\boldsymbol{\gamma})\\
    ...
    \begin{equation}
        \begin{aligned}
            q_j+\frac{\partial q_j}{\partial p_j}p_j-\frac{\partial q_j}{\partial p_j}\frac{\partial C_j}{\partial q_j}=0
        \end{aligned}
        \nonumber
    \end{equation}
    we have
    \begin{equation}
        \begin{aligned}
            p_j=c_j-\frac{\natural_j}{\frac{\partial \natural_j}{\partial p_j}}=c_j+\frac{\natural_j}{|\frac{\partial \natural_j}{\partial p_j}|}
        \end{aligned}
        \nonumber
    \end{equation}
\end{enumerate}
