...
By the Lemma \ref{lemma:max_gumbel}, the \textbf{expected utility from purchase} is $$\mathbb{E}[\max_{j\in\{0,1...,J\}} u_{ij}]=\log\left(\sum_{k=0}^{J}\exp\left(\beta x_k\right)\right)+\gamma$$
...
\subsection{Welfare}
By the Lemma \ref{lemma:max_gumbel}, the consumer $i$'s utility
\begin{equation}
    \begin{aligned}
    \end{aligned}
    \nonumber
\end{equation}
By the Lemma \ref{lemma:max_gumbel}, the \textbf{expected utility from purchase} is $$\mathbb{E}[\max_{j\in\{0,1...,J\}} u_{ij}]=\log\left(1+\sum_{j=1}^{J}\exp(\delta_{ij})\right)+\gamma$$
