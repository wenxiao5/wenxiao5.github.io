...
\begin{assumption}
    \begin{enumerate}
        ...
        \item $\mathbb{E}[p_t|z_t=1]\neq\mathbb{E}[p_t|z_t=0]$
...
\begin{lemma}
    ...
    \begin{equation}
        \begin{aligned}
            \mathbb{E}[q_t|z_t=1]-\mathbb{E}[q_t|z_t=0]=\mathbb{E}_t\left[\int_{\tilde{p}(0,t)}^{\tilde{p}(1,t)}\frac{\partial q^d_t(s)}{\partial s}ds\right]
        \end{aligned}
        \nonumber
    \end{equation}
\end{lemma}
