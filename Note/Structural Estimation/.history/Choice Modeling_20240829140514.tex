...
\begin{equation}
    \begin{aligned}
        \hat{\alpha}_{1,0}=\frac{\widehat{\mathbb{E}[q_t|z_t=1]}-\widehat{\mathbb{E}[q_t|z_t=0]}}{\widehat{\mathbb{E}[p_t|z_t=1]}-\widehat{\mathbb{E}[p_t|z_t=0]}}\stackrel{P}{\longrightarrow}\frac{\mathbb{E}[q_t|z_t=1]-\mathbb{E}[q_t|z_t=0]}{\mathbb{E}[p_t|z_t=1]-\mathbb{E}[p_t|z_t=0]}
    \end{aligned}
    \nonumber
\end{equation}
but it is not an estimator of a structural parameter.
