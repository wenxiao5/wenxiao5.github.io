...
The second choice data directly reveals which products are close substitutes (diversion ratios are always about second choices). Therefore, no need for an instrument to identify substitution patterns.
\begin{note}
