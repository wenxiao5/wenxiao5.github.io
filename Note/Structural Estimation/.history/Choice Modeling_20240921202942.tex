...
\begin{equation}
    \begin{aligned}
        \Delta CW=\frac{1}{\alpha}\left[\log\left(1+\sum_{g\in G}\sum_{j\in g}\exp\left(\frac{\delta_j}{1-\rho}\right)\right)-\log\left(1+\sum_{j=1}^{J}\exp(\delta'_{jt})\right)\right].
    \end{aligned}
    \nonumber
\end{equation}
