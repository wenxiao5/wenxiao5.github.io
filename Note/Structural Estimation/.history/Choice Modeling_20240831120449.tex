...
\begin{enumerate}
    \item \textbf{Inversion}: By equating data $\tilde{s}_{jt}$ and $\hat{s}_{jt}(\delta_{1t},...,\delta_{Jt})$, we have a system of $J$ nonlinear equations:
    \begin{equation}
        \begin{aligned}
        \end{aligned}
        \nonumber
...
\begin{equation}
    \begin{aligned}
        ...
        \underbrace{\ln s_{jt}-\ln s_{0t}}_\text{Data}&=\delta_{jt}:= x_{jt}\beta-\alpha p_{jt}+\xi_{jt}
    \end{aligned}
    \nonumber
\end{equation}
