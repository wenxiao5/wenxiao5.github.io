...
\begin{equation}
    \begin{aligned}
        s_{jt}=\frac{1}{N}\sum\frac{\exp\left(\frac{\delta_{jt}+\mu_{ijt}}{1-\rho}\right)}{\exp\left(\frac{I_{igjt}}{1-\rho}\right)}\frac{\exp\left(I_{igjt}\right)}{\exp\left(I_{irt}\right)}
    \end{aligned}
    \nonumber
\end{equation}
