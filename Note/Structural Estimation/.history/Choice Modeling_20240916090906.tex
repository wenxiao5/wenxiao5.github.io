...
\section{\cite{mcfadden1972conditional,mcfadden1981econometric}: Multinomial logit}
...
\begin{equation}
    \begin{aligned}
        \frac{\partial s_{ij}}{\partial x_j}=\frac{\beta\exp\left(\beta x_j\right)\left(\sum_{k=0}^{J}\exp\left(\beta x_k\right)-\exp\left(\beta x_j\right)\right)}{\left(\sum_{k=0}^{J}\exp\left(\beta x_k\right)\right)^2}=\beta s_{ij}(1-s_{ij});\quad
        \frac{\partial s_{ij}}{\partial x_k}=-\beta s_{ij}s_{ik}
    \end{aligned}
    \nonumber
\end{equation}
Then, the \textbf{elasticity} is given by
\begin{equation}
    \begin{aligned}
        \frac{\partial \log s_{ij}}{\partial \log x_j}=\beta x_j (1-s_{ij})
    \end{aligned}
    \nonumber
\end{equation}
