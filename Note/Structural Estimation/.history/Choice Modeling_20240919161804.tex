...
\begin{equation}
    ...
    \nonumber
\end{equation}
By the Lemma \ref{lemma:max_gumbel}, the \textbf{expected utility from purchase} is $$\mathbb{E}[\max_{j\in\{0,1...,J\}} u_{ijt}]=\log\left(1+\sum_{j=1}^{J}\exp(\delta_{jt})\right)+\gamma$$
