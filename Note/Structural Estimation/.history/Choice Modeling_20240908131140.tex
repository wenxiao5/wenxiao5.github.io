...
\begin{equation}
    \begin{aligned}
        \frac{\partial \tilde{\Pi}_k}{\partial p_j}=D^j+\sum_{j'\in \mathcal{K}}\frac{\partial D^{j'}}{\partial p_j}\left(p_j-\frac{\partial C^{j'}}{\partial q}\right)=0,\ \forall j\in \mathcal{K},\forall k
    \end{aligned}
    \nonumber
\end{equation}
