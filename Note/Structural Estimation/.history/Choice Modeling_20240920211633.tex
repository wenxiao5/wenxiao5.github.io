...
\begin{equation}
    \begin{aligned}
        \frac{\partial \log s_{j}}{\partial \log p_j}=\frac{\frac{\partial \log s_{j}}{\partial s_j}}{\frac{\partial \log p_j}{\partial p_j}}\frac{\partial s_j}{\partial \delta_j}\frac{\partial \delta_j}{\partial p_j}=-\alpha\frac{p_j}{s_j}\frac{\partial s_j}{\partial \delta_j}
    \end{aligned}
    \nonumber
\end{equation}
...
\begin{equation}
    \begin{aligned}
        \log(s_{jt})-\log(s_{0t})=x_{jt}\beta-\alpha p_{jt}+\rho\log\left(s_{jt|g}\right)+\xi_{jt}=-\frac{\alpha}{1-\rho}p_j\left(1-\rho s_{j|g}-(1-\rho)s_j\right)
    \end{aligned}
    \nonumber
\end{equation}
