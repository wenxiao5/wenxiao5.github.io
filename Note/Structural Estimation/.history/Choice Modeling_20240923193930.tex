...
\paragraph*{Step 2: Estimation of $\theta$}
\begin{enumerate}
    \item Use the $\delta_t(\theta_2):=\sigma_{t}^{-1}\left(s_t; x_t,p_t,\theta_2\right)$ and estimate $\theta_1$ by linear-GMM (or 2SLS) using the instruments $Z$:
    \begin{equation}
        \begin{aligned}
