...
\begin{equation}
    \begin{aligned}
        s_{ij}=\frac{\exp\left(\frac{\delta_{ij}}{1-\rho}\right)\left(\sum_{k\in g}\exp\left(\frac{\delta_{ik}}{1-\rho}\right)\right)^{-\rho}}{\sum_{h=1}^G\left(\exp\left(\frac{\delta_{ik}}{1-\rho}\right)\right)^{-\rho}}
    \end{aligned}
    \nonumber
\end{equation}
