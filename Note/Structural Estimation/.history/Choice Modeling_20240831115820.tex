...
\begin{equation}
    \begin{aligned}
        s_{jt}=\frac{\exp(x_{jt}\beta-\alpha p_{jt}+\xi_{jt})}{1+\sum_{k=1}^{J_t}\exp(x_{kt}\beta-\alpha p_{kt}+\xi_{kt})}=\frac{\exp(\delta_{jt})}{1+\sum_{k=1}^{J_t}\exp(\delta_{kt})}:=\hat{s}_{jt}(\delta_{1t},...,\delta_{Jt})
    \end{aligned}
    \nonumber
\end{equation}
...
\begin{equation}
    \begin{aligned}
        ...
        \underbrace{\ln s_{jt}-\ln s_{0t}}_\text{Data}&=\delta_{jt}\equiv x_{jt}\beta-\alpha p_{jt}+\xi_{jt}
    \end{aligned}
    \nonumber
\end{equation}
