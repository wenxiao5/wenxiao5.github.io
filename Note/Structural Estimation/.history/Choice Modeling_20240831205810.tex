...
\begin{equation}
    ...
    \nonumber
\end{equation}
Note that $\theta$ represents the information of all $\alpha_{it}$ and $\beta_{it}$.
...
\begin{enumerate}
    ...
    \item For each market $t$, ``invert'' the demand model at the observed market shares $\tilde{s}_{jt}$ to find 
\end{enumerate}
