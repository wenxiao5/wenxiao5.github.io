...
\begin{equation}
    \begin{aligned}
        \frac{\partial s_{ij}}{\partial x_j}=\frac{\beta\exp\left(\beta x_j\right)\left(\sum_{k=0}^{J}\exp\left(\beta x_k\right)-\exp\left(\beta x_j\right)\right)}{\left(\sum_{k=0}^{J}\exp\left(\beta x_k\right)\right)^2}=\beta s_{ij}(1-s_{ij})
    \end{aligned}
    \nonumber
\end{equation}
