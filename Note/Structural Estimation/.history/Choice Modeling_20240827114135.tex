...
\begin{enumerate}
    \item $\{J_t\}_{\forall t}$: the number of goods available to consumers in each market $t$;
    \item $\{p_t,x_t\}_{\forall t}$: prices and additional characteristics of goods in each market $t$;
