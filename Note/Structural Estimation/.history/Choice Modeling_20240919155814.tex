...
\end{lemma}
\begin{lemma}
    Suppose $g-1,...,g_n$ be independent samples of $\textnormal{Gumbel}(0,1)$. Then,
    \begin{enumerate}
        \item $\max_{i}(g_i + \delta_i) \sim \textnormal{Gumbel}\left(\log\left(\sum_{i}e^{\delta_i}\right)\right)$
    \end{enumerate}
\end{lemma}
