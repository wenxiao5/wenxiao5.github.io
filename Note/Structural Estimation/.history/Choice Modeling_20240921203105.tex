...
\begin{equation}
    \begin{aligned}
        \Delta CW=\frac{1}{\alpha}\left[\log\left(\sum_{g\in G}\left(\sum_{j\in g}\exp\left(\frac{\delta_j}{1-\rho}\right)\right)^{1-\rho}\right)-\log\left(1+\sum_{j=1}^{J}\exp(\delta'_{jt})\right)\right].
    \end{aligned}
    \nonumber
\end{equation}
