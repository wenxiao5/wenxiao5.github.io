...
Define $\delta_j:=\sum_{k}x_{jk}\bar{\beta}_{k}+\xi_{j}$.

We want to estimate $\delta=\{\delta_j\}_j,\beta^o,\beta^u$.
...
\begin{enumerate}
    ...
    \end{enumerate}
    \item To estimate $(\bar{\beta},\beta^o,\beta^u)$ imposing conditions on the joint distribution of $(x, \xi)$.
\end{enumerate}
