...
2SLS can work in linear models: $\hat{\alpha}_{1,0}=\frac{\widehat{\textnormal{Cov}(q_t,z_t)}}{\widehat{\textnormal{Cov}(p_t,z_t)}}\stackrel{P}{\longrightarrow}\frac{\mathbb{E}[q_t|z_t=1]-\mathbb{E}[q_t|z_t=0]}{\mathbb{E}[p_t|z_t=1]-\mathbb{E}[p_t|z_t=0]}$.
