...
We have two endogenous variables $p_{jt}$ and $\log\left(s_{jt|g}\right)$. So, we need an additional instrument that moves the within-nest market share but is not correlated with $\xi_{jt}$.
