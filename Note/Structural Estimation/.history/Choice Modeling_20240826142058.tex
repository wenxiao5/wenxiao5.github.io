...
\begin{enumerate}
    ...
    \item $\epsilon_{ijt}$ is the \textit{error term}. It is most often specified as an i.i.d. draw from a standard type-1 extreme value distribution, yielding a mixed multinomial logit model (MNL). In this case, the choice probabilities in the population (i.e., the market shares) are given by
    \begin{equation}
        \begin{aligned}
