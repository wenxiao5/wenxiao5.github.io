...
\begin{equation}
    \begin{aligned}
        \frac{\partial \log s_{j}}{\partial \log p_k}=\frac{\frac{\partial \log s_{j}}{\partial s_j}}{\frac{\partial \log p_k}{\partial p_k}}\frac{\partial s_j}{\partial \delta_k}\frac{\partial \delta_k}{\partial p_k}=-\alpha\frac{p_k}{s_j}\frac{\partial s_j}{\partial \delta_j}=
        \left\{\begin{matrix}
            -\frac{\alpha}{1-\rho}p_j\left(1-\rho s_{j|g}-(1-\rho)s_j\right),&\\
            &
        \end{matrix}\right.
    \end{aligned}
    \nonumber
