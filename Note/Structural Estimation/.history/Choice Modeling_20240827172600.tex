...
\subsection{Model}
Assume binary instrument $z_t\in\{0,1\}$ to make things easier. We assume the regularity conditions (existence of first and second moment and being stationary) and $q^d_t(p,z,x),q^s_t(p,z,x)$ are continuously differentiable in $p$.
