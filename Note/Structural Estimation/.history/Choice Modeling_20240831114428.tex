...
\begin{equation}
    \begin{aligned}
        \hat{\alpha}_{1,0}=\frac{\widehat{\mathbb{E}_t[q_t|z_t=1]}-\widehat{\mathbb{E}_t[q_t|z_t=0]}}{\widehat{\mathbb{E}_t[p_t|z_t=1]}-\widehat{\mathbb{E}_t[p_t|z_t=0]}}\stackrel{P}{\longrightarrow}\frac{\mathbb{E}_t[q_t|z_t=1]-\mathbb{E}_t[q_t|z_t=0]}{\mathbb{E}_t[p_t|z_t=1]-\mathbb{E}_t[p_t|z_t=0]}\equiv \alpha_{1,0}
    \end{aligned}
    \nonumber
\end{equation}
...
\begin{equation}
    \begin{aligned}
        u_{ijt}=\underbrace{x_{jt}\beta-\alpha p_{jt}+\xi_{jt}}_{\equiv\delta_{jt}}+\epsilon_{ijt}
    \end{aligned}
    \nonumber
\end{equation}
the choice probabilities in the population are given by
\begin{equation}
    \begin{aligned}
        s_{jt}=\frac{\exp(x_{jt}\beta-\alpha p_{jt}+\xi_{jt})}{1+\sum_{k=1}^{J_t}\exp(x_{kt}\beta-\alpha p_{kt}+\xi_{kt})}
    \end{aligned}
    \nonumber
\end{equation}
...
\begin{equation}
    \begin{aligned}
        \frac{1}{J}\sum_{j=1}^{J_t}\xi_{jt}z_{jt}=\frac{1}{J}\sum_{j=1}^{J_t}\left(\delta_{jt}-x_{jt}\beta+\alpha p_{jt}\right)z_{jt}
    \end{aligned}
    \nonumber
\end{equation}
...
\begin{equation}
    \begin{aligned}
        \ln s_{0t}&=-\log\left(1+\sum_{k=1}^{J_t}\exp(x_{kt}\beta+\xi_{kt})\right)\\
        \ln s_{jt}&=[x_{jt}\beta-\alpha p_{jt}+\xi_{jt}]-\log\left(1+\sum_{k=1}^{J_t}\exp(x_{kt}\beta+\xi_{kt})\right)\\
        \underbrace{\ln s_{jt}-\ln s_{0t}}_\text{Data}&=x_{jt}\beta-\alpha p_{jt}+\xi_{jt}
    \end{aligned}
    \nonumber
\end{equation}
