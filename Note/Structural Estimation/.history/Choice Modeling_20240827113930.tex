...
\begin{enumerate}
    \item $J_t,\forall t$: the number of goods available to consumers in each market $t$;
    \item $p_t$ and $x_t$: prices and additional characteristics of goods in each market $t$;
    \item $\tilde{s}_{jt}$: observed market shares, typically measured by the total quantity of good $j$ sold in market $t$ divided by the total number of consumers in market $t$.
\end{enumerate}
