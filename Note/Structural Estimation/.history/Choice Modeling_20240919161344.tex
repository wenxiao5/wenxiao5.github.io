...
By the Lemma \ref{lemma:max_gumbel}, the \textbf{expected utility from purchase} is $$\mathbb{E}[\max_{j\in\{0,1...,J\}} u_{ij}]=\log\left(\sum_{j=1}^{J}\exp(\delta_{ij})\right)+\gamma$$
