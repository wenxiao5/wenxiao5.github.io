...
$\hat{\beta}=\arg max_{\beta} l(\beta,\vec{x})$ maximizes the likelihood function $l(\beta)$, $\hat{\beta}=\arg max_{\beta}\log l(\beta,\vec{x})$ also maximizes the logarithm of the likelihood function $L(\beta) = \log(l(\beta))$.
