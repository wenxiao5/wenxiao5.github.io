...
\begin{definition}[Standardized Residuals]
    ...
    The \textbf{leverages} are the diagonal elements of the (estimated) hat matrix
    $$
    ...
    $$
    where $\hat{\boldsymbol{W}}^{1 / 2}$ is the diagonal matrix of square roots of the diagonal elements of $\hat{W}$.
\end{definition}
