...
\begin{table}[htbp]
    \centering
    \begin{tabular}{rllll}
        \multicolumn{1}{r}{}&\multicolumn{2}{l}{$x_2=1$}&\multicolumn{2}{l}{$x_2=0$}\\
        \cline{2-5}
        \multicolumn{1}{r|}{$x=1$}&\multicolumn{2}{l|}{$Y_{11}$}&\multicolumn{2}{l|}{$Y_{12}$}\\
        \cline{2-5}
        \multicolumn{1}{r|}{$x=0$}&\multicolumn{2}{l|}{$Y_{21}$}&\multicolumn{2}{l|}{$Y_{22}$}\\
        \cline{2-5}
        \multicolumn{1}{l}{}&&&&
    \end{tabular}\\
