...
$$
\begin{aligned}
& \text { sensitivity }=\mathrm{P}(\hat{Y}=1 \mid Y=1) \\
& \text { specificity }=\mathrm{P}(\hat{Y}=0 \mid Y=0)
\end{aligned}
$$
Q: What happens to sensitivity and specificity as $\pi_0$ increases?
\end{definition}
...
\begin{table}[htbp]
    ...
    \begin{tabular}{rcccc}
        ...
        \cline{2-5}
        \multicolumn{1}{r|}{$x=1$}&\multicolumn{2}{c|}{}&\multicolumn{2}{c|}{}\\
        \cline{2-5}
        \multicolumn{1}{r|}{$x=0$}&\multicolumn{2}{c|}{}&\multicolumn{2}{c|}{}\\
        \cline{2-5}
        \multicolumn{1}{c}{}&&&&
    \end{tabular}\\
\end{table}
