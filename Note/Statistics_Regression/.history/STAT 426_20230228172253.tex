...
\begin{enumerate}[$\bullet$]
    ...
    \begin{enumerate}[1.]
        ...
        \item The deviance changes, since the saturated model for the grouped data is different.
        \item But deviance-based comparisons between nested sub-models do not change, since the saturated model log-likelihood cancels out.
    \end{enumerate}
\end{enumerate}
