...
\subsection{Parameter Interpretation and Inference}
...
So $\beta$ is the \textbf{log-odds ratio for the effect of increasing $X$ by one unit} (which depends on the units of $X$).
