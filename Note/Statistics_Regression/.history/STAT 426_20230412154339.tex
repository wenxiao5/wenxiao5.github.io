...
Suppose there is just one explanatory variable $X$ (quantitative or indicator). Then we call $\frac{\pi_{j}(x)}{\pi_J(x)}=e^{\alpha_j+\beta_j x}$ "the odds of $j$ relative to $J$."
