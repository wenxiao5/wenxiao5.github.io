...
“Nested” means that one model is a subset of another. Model A is nested in Model B if the parameters in Model A are a subset of the parameters in Model B.
