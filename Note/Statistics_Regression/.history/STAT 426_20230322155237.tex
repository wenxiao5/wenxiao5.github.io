...
\end{aligned}
$$
Note:$\boldsymbol{\eta}=\boldsymbol{X} \boldsymbol{\beta}$ and
\begin{equation}
    \begin{aligned}
        l(\boldsymbol{\beta})=\prod_{i}\pi\left(\boldsymbol{x}_i\right)^{y_i} (1-\pi\left(\boldsymbol{x}_i\right))^{n_i-y_i}
    \end{aligned}
    \nonumber
\end{equation}
