...
https://cdn.mathpix.com/snip/images/5-PsoMCIcfXV7mdWCjgXlp2yBRAIRH07NtfPRmAxRa8.original.fullsize.png
\begin{center}
    \begin{tabular}{cc|c|c|c|c}
        \multicolumn{3}{c}{\quad}\multicolumn{1}{c}{$Y$}\multicolumn{3}{c}{\quad}\\
        & &$1$&$\cdots$&$J$\\
        \cline{3-5}
        &$1$& & &\\
        \cline{3-5}
