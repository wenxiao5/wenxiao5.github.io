...
Remark: $G=\textnormal{logit}^{-1}$ is the c.d.f. of the standard logistic distribution.

In general, this kind of model may be called a \textbf{cumulative link model}.
