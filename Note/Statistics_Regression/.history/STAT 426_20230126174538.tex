...
\begin{definition}[Wald Test]
    ...
    \begin{enumerate}
        \item We reject the $H_0$ if $|z_W|\geq z_{\frac{\alpha}{2}}$ for a two-sided level $\alpha$ test.
        \item The $(1-\alpha)100\%$ Wald (confidence) interval is $$\{\beta_0:|z_W|=\frac{|\hat{\beta}-\beta_0|}{SE}<z_{\frac{\alpha}{2}}\}=(\hat{\beta}-z_\frac{\alpha}{2}SE,\hat{\beta}+z_\frac{\alpha}{2}SE)$$
