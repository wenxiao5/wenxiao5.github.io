...
The chi-squared approximation is never valid for binary responses $\left(n_i=1\right.$, i.e. ungrouped data). Indeed, in that case, the deviance is completely useless for model checking.
