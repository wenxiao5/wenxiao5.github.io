...
\begin{definition}[Likelihood Ratio Test]
    ...
    \begin{enumerate}[(1)]
        ...
        \item The $(1-\alpha)100\%$ likelihood-ratio (confidence) interval is $$\{\beta_0:-2\ln\Lambda=-2\left(L(\beta_0)-L(\hat{\beta})\right)<\chi_1^2(\alpha)\}$$
...
\begin{definition}[Score Test]
    ...
    Thus, reject $H_0$ if $|z_S|\geq z_{\frac{\alpha}{2}}$ for a \underline{two-sided level $\alpha$ test}.\\
