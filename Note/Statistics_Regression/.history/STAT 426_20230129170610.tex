...
\begin{enumerate}
    ...
    (In the multinomial model: $\theta=\frac{\pi_11\pi_{22}}{\pi_{12}\pi_{21}}$ ("cross-product ratio"); in Poisson model: $\theta=\frac{\mu_{11}\mu_{22}}{\mu_{12}\mu_{21}}$)\\
...
\begin{table}[htbp]
    ...
    $Z=1:$
    \begin{tabular}{rllll}
        \multicolumn{1}{c}{}                    & \multicolumn{2}{c}{Y}                         &  &  \\ \cline{2-3}
        \multicolumn{1}{r|}{\multirow{2}{*}{X}} & \multicolumn{1}{l|}{} & \multicolumn{1}{l|}{} &  &  \\ \cline{2-3}
        \multicolumn{1}{r|}{}                   & \multicolumn{1}{l|}{} & \multicolumn{1}{l|}{} &  &  \\ \cline{2-3}
        \multicolumn{1}{l}{}                    &                       &                       &  & 
        \end{tabular}
\end{table}
