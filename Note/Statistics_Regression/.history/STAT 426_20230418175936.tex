...
\begin{enumerate}[(1)]
    ...
    \item \textbf{Multinomial:} $N_{i j k}$ jointly distributed as $\operatorname{Multinomial}(n, \boldsymbol{\pi})$, where $n$ is the fixed total for the table, and $\pi$ is the vector of all $I J K$ cell probabilities $\pi_{i j k}$ in some particular order.
\end{enumerate}
