...
& \multicolumn{1}{c}{ success } & \multicolumn{1}{c}{ failure } \\
\cline { 3 - 4 }$X$ category & $\vdots$ & $Y_1$ & $n_1-Y_1$ \\
& $\vdots$ & $\vdots$ & $\vdots$ \\
& $\vdots$ & $\vdots$ & $\vdots$ \\
& $I$ & $Y_I$ & $n_I-Y_I$ \\
\cline { 3 - 4 } & & &
...
Then
$$
Y_i \sim \Perp \operatorname{binomial}\left(n_i, \pi_i\right) \quad i=1, \ldots, I
$$
