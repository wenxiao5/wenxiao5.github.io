...
\begin{center}
    \begin{tabular}{rccccr}
        \multicolumn{1}{r}{}&\multicolumn{2}{c}{$Y=1$}&\multicolumn{2}{c}{$Y=2$}&\multicolumn{2}{r}{$Y=3$}\\
        \cline{2-6}
        \multicolumn{1}{r|}{$X=1$}&\multicolumn{2}{c|}{$\pi_1(1)$}&\multicolumn{2}{c|}{$\pi_2(1)$}&\multicolumn{2}{r|}{$\pi_3(1)$}\\
        \cline{2-6}
        \multicolumn{1}{r|}{$X=0$}&\multicolumn{2}{c|}{$\pi_1(0)$}&\multicolumn{2}{c|}{$\pi_2(0)$}&\multicolumn{2}{r|}{$\pi_3(0)$}\\
        \cline{2-6}
        \multicolumn{1}{c}{}&&&&
    \end{tabular}
\end{center}
