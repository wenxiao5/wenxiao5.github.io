...
\begin{enumerate}[$\bullet$]
    ...
    \begin{enumerate}[1.]
        ...
        \item Note: “Fitted values” from \begin{lstlisting}[language=R]
        R
        \end{lstlisting} are still the probabilities $\hat{\pi}(x_i)$ (rather than estimated means $n_i\hat{\pi}(x_i)$).
    \end{enumerate}
\end{enumerate}
