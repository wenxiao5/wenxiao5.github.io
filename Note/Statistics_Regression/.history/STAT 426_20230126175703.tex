...
\begin{definition}[Score Test]
    ...
    \begin{enumerate}[(1)]
        ...
        \item The \underline{$(1-\alpha)100\%$ score (confidence) interval} is $$\{\beta_0:|z_S|=\frac{u(\beta_0)}{\sqrt{\iota(\beta_0)}}beta}-\beta_0|}{SE}<z_{\frac{\alpha}{2}}\}=(\hat{\beta}-z_\frac{\alpha}{2}SE,\hat{\beta}+z_\frac{\alpha}{2}SE)$$
