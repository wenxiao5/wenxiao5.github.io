...
\subsection{Deviance and Goodness of Fit}
...
$$
Note: $D(\boldsymbol{y} ; \hat{\boldsymbol{\mu}})$ is the LRT chi-squared statistic for
\begin{enumerate}[-]
...
$$
D(\boldsymbol{y} ; \hat{\boldsymbol{\mu}}) \underset{\mathrm{H}_0}{\dot{\sim}} \quad \chi_{\mathrm{df}}^2
$$
