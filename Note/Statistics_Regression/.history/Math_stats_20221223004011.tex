...
\end{lemma}
\begin{proof}
    $\mathbb{E}\hat{\beta}_{1}=\mathbb{E}\left[\frac{\sum_{i=1}^{n}\left(x_{i}-\bar{x}\right)(\beta_0+\beta_1x_i+\varepsilon_i)}{\sum_{i=1}^{n}\left(x_{i}-\bar{x}\right)^{2}}\right]=\mathbb{E}\left[\frac{\sum_{i=1}^{n}\left(x_{i}-\bar{x}\right)\beta_1x_i}{\sum_{i=1}^{n}\left(x_{i}-\bar{x}\right)^{2}}\right]=\beta_1$.
\end{proof}
