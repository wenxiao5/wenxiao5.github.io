...
which is also equivalent to maximizing the logarithm of the likelihood function $L(\beta,\vec{x}) = \log(l(\beta,\vec{x}))$, $$\hat{\beta,\vec{x}}=\arg\max_{\beta}L(\beta,\vec{x})$$
