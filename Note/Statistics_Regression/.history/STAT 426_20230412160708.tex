...
\textbf{Note:} The total number of (scalar) free parameters is $(J-1)(1+p)$, where $\boldsymbol{x}$ has $p$ elements. The (residual) degrees of freedom depends on the data format —-- grouped data with N multinomial observations generally have $(J-1)(N-(1+p))$ degrees of freedom.\\
