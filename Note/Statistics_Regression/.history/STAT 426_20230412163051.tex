...
We use the differenece of $\alpha_j$ to represent the different of cumularive probaility for different $j$, but fixing the $\boldsymbol{\beta}$ for all $j$ to avoid the wrong order.
