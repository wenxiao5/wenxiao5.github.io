...
\begin{proof}
    \begin{equation}
        \begin{aligned}
            \mathbb{E}_{\vec{x}}\left(\frac{\partial^2 L(\vec{x}\mid\beta)}{\partial \beta^2}\right)=\mathbb{E}_{\vec{x}}\left(\frac{\partial \frac{\nabla_{\beta} l(\vec{x}\mid \beta)}{l(\vec{x}\mid \beta)}}{\partial \beta}\right)=\mathbb{E}\left(\frac{\nabla^2_{\beta} l(\vec{x}\mid \beta)l(\vec{x}\mid \beta)-\nabla_{\beta} l(\vec{x}\mid \beta)\nabla_{\beta} l(\vec{x}\mid \beta)^T}{} \right)
        \end{aligned}
        \nonumber
    \end{equation}
\end{proof}
