...
\begin{definition}[Wald Test]
    ...
    Usually, as $n \rightarrow \infty$, $z_W \stackrel{d}{\longrightarrow} N(0,1)$ under $H_0:\beta=\beta_0$. So we reject the $H_0$ if $|z_W|\geq z_{\frac{\alpha}{2}}$ for a two-sided level $\alpha$ test.
\end{definition}
