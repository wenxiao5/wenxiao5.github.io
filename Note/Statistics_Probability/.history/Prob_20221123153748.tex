...
\begin{definition}[Brownian Motion]
    ...
    \begin{enumerate}
        \item $X_0=0$.
        \item For any $s_1<t_1<s_2<t_2\cdots<s_n<t_n$, the random variables $X_{t_1}-X_{s_1}$,...,$X_{t_n}-X_{s_n}$ are independent. This is the independent increments property.
    \end{enumerate}
\end{definition}
...
A process statrts from $0$, $B(0)=0$, has independent and stationary increments, $B_t-B_s\sim \mathcal{N}(0,\sigma^2(t-s))$, and has continunity of simple path.
