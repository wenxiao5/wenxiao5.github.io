...
\begin{definition}
    ...
    \begin{enumerate}[$\circ$]
        \item $X$ is \textbf{discrete} \underline{if and only if} $\exists f_X: \mathbb{R} \rightarrow [0,1]$ such that $F_X(x)=\sum_{t\leq x}f_X(x)$.
    \end{enumerate}
    
    We say $X$ is \underline{continuous} if $F_X$ is continuous.
\end{definition}
