...
\begin{definition}[Cumulative Distribution Function]
    \normalfont
    The \textbf{cumulative distribution function} (cdf) of $X$ is the function $F_X: \mathbb{R} \rightarrow [0,1]$ given by $$F_X(x)\triangleq P_X((-\infty,x])=P(\{s\in S: X(s)\in (-\infty,x]\}), \forall x\in \mathbb{R}$$
\end{definition}
