...
\end{definition}
\begin{claim}
    We can also speak of a BM starting from $x$; this is a process satisfying conditions 2 to 4 in the above definition along with the initial condition X0 = x. If Xt is a SBM then the process Yt = Xt +x is a BM starting at x. We can also speak of Brownian Motion with drift μ. If Xt is a SBM and Yt =Xt+μtthenYt isaBMwithdriftμ.Wecanrefertoa(μ,σ2)BMasaBrownian
\end{claim}
