...
\section{Spatial Poisson Process (dimension $\geq 2$)}
...
As in the $1 \mathrm{D}$ case, the superposition of independent $2 \mathrm{D}$ Poisson processes is a $2 \mathrm{D}$ Poisson process, and the intensities add. We can also thin a $2 \mathrm{D}$ Poisson process to get independent $2 \mathrm{D}$ Poisson processes.
