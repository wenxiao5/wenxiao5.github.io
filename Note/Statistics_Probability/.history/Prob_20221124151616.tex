...
\begin{proposition}
    A process $W$ is Gaussian with mean $0$ and $\textnormal{Cov}(W_s,W_t)=\textnormal{Var}(W_s),\forall s\leq t$ \textbf{if and only if} $W$ has (1). Independent increments; (2). Stationary normal increments.
\end{proposition}
