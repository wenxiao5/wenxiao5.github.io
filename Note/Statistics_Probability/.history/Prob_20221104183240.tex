...
\begin{enumerate}[(a)]
    \item 
\end{enumerate}
(a) Initialize $\left(x_0, y_0\right)=(0,0)$. Also initialize $n=1$.
(b) Generate $x_n \sim N\left(\rho y_{n-1}, 1-\rho^2\right)$.
(c) Generate $y_n \sim N\left(\rho x_n, 1-\rho^2\right)$.
(d) Update $n=n+1$.
(e) Return to Step $(b)$.
