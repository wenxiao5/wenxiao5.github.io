...
\begin{lemma}
    A process $W$ is Gaussian with \underline{mean $0$ and $\textnormal{Cov}(W_s,W_t)=\min\{s,t\}\sigma^2$} \textbf{if and only if} $W$ has (1). Independent increments; (2). Stationary normal increments.
\end{lemma}
