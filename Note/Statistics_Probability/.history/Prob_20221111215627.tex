...
P\left(N\left(J_i\right)=k_i, \forall i \in[1: m] \mid N(1)=k\right)=\frac{k !}{k_{1} ! \ldots k_{m} !} \prod_{i=1}^m\left(\frac{\left|J_i\right|}{t}\right)^{k_i}
$$)
...
\begin{equation}
    ...
    \nonumber
\end{equation}
That is $B_t$ has a Poisson distribution with parameter $\lambda p$.
