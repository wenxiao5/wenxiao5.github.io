...
\begin{definition}[Sample Space]
    \normalfont
    The \textbf{sample space} $S$ of an experiment is the list of all possible outcomes of the experiment. Elements $s\in S$ are called \underline{elementary events}.
\end{definition}
\begin{example}
