...
\begin{corollary}
    If independent Poisson processes of rates $\lambda_1$ and $\lambda_2$ are superposed, the arrival types are i.i.d and the probability of a type 1 arrival is $\frac{\lambda_1}{\lambda_1+\lambda_2}$.
\end{corollary}
