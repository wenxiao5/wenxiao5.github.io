...
\begin{proof}
    ...
    \begin{equation}
        \begin{aligned}
            P(T\leq V)=P\left(\frac{\tilde{T}}{\lambda_1}\leq \frac{\tilde{V}}{\lambda_2}\right)=P\left(\frac{\tilde{T}}{\tilde{T}+\tilde{V}}\leq \frac{\lambda_1}{\lambda_2}\frac{\tilde{V}}{\tilde{T}+\tilde{V}}\right)
        \end{aligned}
        \nonumber
    \end{equation}
\end{proof}
