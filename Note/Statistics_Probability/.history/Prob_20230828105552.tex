...
\subsection{Represeting / Specifying $P_X$}
...
\begin{theorem}[Correspondence Theorem]
    Let $X\& Y$ be random variables and let the associated probability functions and cdfs be $P_X\& P_Y$ and $F_X\&F_Y$. Then, $F_X=F_Y$ if $P_X=P_Y$
\end{theorem}
