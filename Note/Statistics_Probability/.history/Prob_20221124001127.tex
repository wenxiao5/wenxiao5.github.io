...
\begin{definition}[Gaussian Process]
    ...
    \begin{enumerate}
        \item $W$ is a Gaussian process if $(W(t_1),...,W(t_n))$ has a joint normal distribution for all numbers $n$ and times $t_1,...,t_n$.
        \item $W$ is a Gaussian process if $a_1 W(t_1)+\cdots +a_n W(t_n)$ is normally distributed for all $t_1,...,t_n$ and real numbers $a_1,...,a_n$.
    \end{enumerate}
\end{definition}
