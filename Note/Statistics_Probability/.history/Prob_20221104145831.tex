...
\subsubsection{Example of generate standard normal distribution with }




\subsubsection{A method to generate standard normal distribution without MCMC: Box Muller Transform}
Box-Muller Method:
