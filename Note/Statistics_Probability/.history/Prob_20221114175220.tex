...
\begin{proof}
    Let $n$ be a large integer. Define $X_1,...,X_n$ i.i.d Bernoulli with success probability $\frac{\lambda}{n}$. Define $Y_1,...,Y_n$ i.i.d Bernoulli with success probability $p$. Now consider the i.i.d sequence $Z_1,...,Z_n$ where $Z_i=X_iY_i$.
\end{proof}
