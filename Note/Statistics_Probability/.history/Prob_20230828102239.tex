...
\begin{definition}[Probability Space]
    \normalfont
    A \textbf{probability space} is triple $(S,B,P)$, where $S$ is a \underline{sample space}, $B$ is a \underline{$\sigma-$algebra} of \underline{events}, and $P$ is a \underline{probability function}.
\end{definition}
