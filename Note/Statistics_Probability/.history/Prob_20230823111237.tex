...
\begin{definition}[Probability Space]
    \normalfont
    A \textbf{probability space} is triple $(S,B,P)$, where $S$ is a \underline{sample space}, $B$ is a \underline{$\sigma-$algebra} of \underline{events}, and $P$ is a \underline{probability function} over $S$.
\end{definition}
...
\begin{definition}
    \normalfont
    A function $P: B \rightarrow [0,1]$ is a probability function 
\end{definition}
