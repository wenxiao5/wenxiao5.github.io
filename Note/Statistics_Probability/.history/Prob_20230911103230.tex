...
\begin{proposition}
    If $(X,Y)'$ is a discrete/continuous random vector with joint pmf/pdf $f_{X,Y}$ and marginal pmf/pdf $f_X, f_Y$, then $X,Y$ are independent ($X\prep Y$) \underline{if and only if}
\end{proposition}
