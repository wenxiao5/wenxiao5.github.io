...
\begin{proposition}
    ...
    \begin{enumerate}[(i).]
        ...
        \item A function $f_{X,Y}: \mathbb{R}^2 \rightarrow \mathbb{R}_+$ is a joint pdf \underline{if and only if} $\int_{x\in \mathbb{R}}\int_{y\in \mathbb{R}}f_{X,Y}(x,y) dx dy=1$
    \end{enumerate}
\end{proposition}
