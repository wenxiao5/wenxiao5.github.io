...
\title{\textbf{Notes of Probability}}
\author{Wenxiao Yang}
...
\subsection{Variance: $Var X_n=\left\{\begin{matrix}
    n\sigma^2,&\mu=1\\
...
\begin{center}
    \fcolorbox{black}{green!10}{\parbox{.9\linewidth}{\begin{definition}[Definition 2 of PP]
...
\subsection*{Example: enter and leave}
...
\subsection{Superposition Theorem: $\lambda_1$ PP + $\lambda_2$ PP = $\lambda_1+\lambda_2$ PP}
...
\end{lemma}
\begin{proof}
    $X,Y$ equal to $S_1,S_2$ of a Poisson process with $\lambda$.
\end{proof}
