...
\begin{lemma}
    If a Gaussian process having continuous paths, mean $0$, and covariance function $\textnormal{Cov}(W_s,W_t) = \textnormal{Var}(W_{\min\{s, t\}})$ is a standard Brownian motion.
\end{lemma}
