...
\begin{definition}[Exponential Family]
    ...
    \begin{equation}
        ...
        \nonumber
    \end{equation}
    for some $k\in \mathbb{N}$, $h: \mathbb{R} \rightarrow \mathbb{R}_+$, $c: \Theta \rightarrow \mathbb{R}_{++}\triangleq (0,\infty)$, $w_j: \Theta \rightarrow \mathbb{R}$, $t_j: \mathbb{R} \rightarrow \mathbb{R}$.
\end{definition}
