...
\begin{proof}
    ...
    \begin{equation}
        \begin{aligned}
            P(S_N=k_1|N-S_N=k_2)&=\frac{P(S_N=k_1,N=k_1+k_2)}{P(N-S_N=k_2)}\\&=\frac{P(S_{k_1+k_2}=k_1)P(N-S_N=k_2)}{P(N=k_1+k_2)}\\
            &=\frac{\frac{(k_1+k_2)!p^{k_1}(1-p)^{k_2}}{k_1! k_2!}\frac{[\lambda(1-p)]^{k_2}e^{-\lambda(1-p)}}{k_2!}}{\lambda e^{-\lambda (k_1+k_2)}}
        \end{aligned}
        \nonumber
    \end{equation}
\end{proof}
