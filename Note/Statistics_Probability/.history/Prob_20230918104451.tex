...
\begin{example}\quad
    \begin{enumerate}
        ...
        \begin{equation}
            ...
            \nonumber
        \end{equation}
        \textbf{Fact:} $\hat{p}_{MM}=\bar{X}$ is the "best" estimator of $p$.
        \item Suppose $X_i\sim \textnormal{i.i.d.}U(0,\theta)$ where $\theta>0$ is unknown. The \underline{moment function} is
    \end{enumerate}
\end{example}
