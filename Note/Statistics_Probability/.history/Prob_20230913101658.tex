...
\begin{definition}[Sample Mean and Sample Variance]
    ...
    \begin{enumerate}
        ...
        \item The \textbf{sample variance} is $S^2=\frac{1}{n-1}\sum_{i=1}^n (X_i-\bar{X})^2$
    \end{enumerate}
\end{definition}
...
\begin{theorem}
    Suppose $X_1,...,X_n$ is a random sample from a distribution with mean $\mu$ and variance $\sigma^2$ (denoted by $X_i\sim \textnormal{i.i.d}(\mu,\sigma^2)$)
\end{theorem}
