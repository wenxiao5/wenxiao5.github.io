...
\vspace{-1cm}
Its skewness (measure of the asymmetry of the probability distribution) is: $\mathbb{E}\frac{(X-\mu)^3}{\sigma^3}=\frac{1}{\sqrt{\mu}}$.

\subsection*{Derivation process (an approximation to the binomial distribution when $n$ is large and $\pi$ is small, such that $\mu=n\pi$.)}
