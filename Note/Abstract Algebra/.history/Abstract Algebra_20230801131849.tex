...
\end{definition}
\begin{claim}
    \textnormal{Do symmetry and transitivity imply reflexivity?} No. It is tempting to think so, but there may be \underline{elements unrelated to any element}. However if we add the assumption that every element is related to some other element, then reflexivity is redundant.
\end{claim}
