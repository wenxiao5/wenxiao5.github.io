...
\end{definition}
\begin{claim}
    Do symmetry and transitivity imply reflexivity? \textit{No. It is tempting to think so, but there may be elements unrelated to any element. However if we add the assumption that every element is related to some other element, then reflexivity is redundant.}
\end{claim}
