...
\begin{definition}[Coercive]
    A real-valued function $f:\& \rightarrow \mathbb{R}$ is \underline{coercive} if for every $\left\{x_{k}\right\} \subset \&$ s.t. $\left\|x_{k}\right\| \rightarrow \infty, f\left(x_{k}\right) \rightarrow \infty$
\end{definition}
