...
\begin{proof}
    ...
    Since $f$ is closed, $f(x)<\infty,\ \forall x\in\&$. And $f$ is coercive on $\&$, which means $f(x)\rightarrow \infty$ if $\|x\| \rightarrow\infty$. Hence, $\left\{\sigma_{k}\right\}\in\&$ is bounded.

Rest of proof same as proof $\mathrm{O} \mathrm{WT}$.
\end{proof}
