...
A set \& $\subseteq \mathbb{R}^{n}$ is open if $\forall x \in \&$ we can draw a ball around $x$ that is contanined in $\&$. i.e. $\forall x \in \&, \exists \varepsilon>0$ s.t. $\{y:\|y-x\|<\varepsilon\} \leq-\sigma$
