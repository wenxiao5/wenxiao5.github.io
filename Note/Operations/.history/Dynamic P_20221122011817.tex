...
\end{enumerate}
After pulling arm $i$ some number of times, gambler has a posterior distribution over types. Call this the \textbf{state} of arm $i$ (i.e., the posterior distribution over types after getting informtaion).
