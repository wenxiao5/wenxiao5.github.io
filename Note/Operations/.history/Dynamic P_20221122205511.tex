...
\begin{claim}[Equivalent Interpretation]
...
\begin{equation}
    \begin{aligned}
        \mathcal{V}(a)=\max_{S(a)\subseteq \mathcal{X}}\frac{\mathbb{E}\left[\sum_{t=0}^{T(S(a))}\beta^tr_t\mid X_0=a\right]}{\mathbb{E}\left[\sum_{t=0}^{T(S(a))}\beta^t\mid X_0=a\right]}
    \end{aligned}
    \tag{1}
\end{equation}
