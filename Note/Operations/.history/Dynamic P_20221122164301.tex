...
problem is to set it up as a Markov decision process (MDP) and use Markov decision theory to solve it. However, such an approach does not scale well with the number of bandit processes because of the curse of dimensionality.
