...
\begin{definition}[Multi-Armed Bandit Problem]
    ...
    \begin{center}
        \fcolorbox{black}{gray!10}{\parbox{.9\linewidth}{ for $i=1,...,n$ do:
        \begin{enumerate}
            \item Take action $a_t\in A$
            \item Observe reward $r_t\sim v(a_t)$
        \end{enumerate}
        endfor}}
    \end{center}

    Reward distribution $v(a)$ may have different expected reward for different $a$: $\mu(a)=\mathbb{E}[r(a)]$.
\end{definition}
