...
\begin{definition}[Upper/Lower Hemicontinuous]
    ...
    \begin{enumerate}
        ...
        \end{center}
        \textit{A set to “jump up” at the limit $x_0$: It should mean that the set suddenly gets bigger -- it “explodes in the limit” -- that is, there is a point $y$ in $\Psi(x_0)$ and a sequence $x_n \rightarrow x_0$ such that $y$ is far from every point of $\Psi(x_n)$ as $n \rightarrow \infty$.}
    \end{enumerate}
\end{definition}
\begin{center}\begin{figure}[htbp]
    \centering
