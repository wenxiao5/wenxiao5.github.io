...
\begin{theorem}[Union of open sets is open, Intersection of finite open sets is open]
    In any metric space $(X, d)$, The union of an arbitrary (finite, countable, or uncountable) collection of open sets is open, and the intersection of finite open sets is open.
\end{theorem}
