...
\begin{example}
    Consider the second order linear differential equation $y''=2y+y'$, we can solve the eigenvalues $\lambda_1=2,\lambda_2=-1$ and eigenvectors $v_1=(1,2), v_2=(1,-1)$.

    The general solution can be solved by the Theorem \ref{theorem:Solutions of Linear Differential Equations with Constant Coefficients}.
\end{example}
