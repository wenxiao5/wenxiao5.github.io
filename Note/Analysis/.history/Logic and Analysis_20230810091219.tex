...
\begin{definition}
    \normalfont
    A differential equation is an equation of the form $y'(t)=F(y(t), t)$.
\end{definition}
where $F : U \rightarrow \mathbb{R}^n$ and $U$ is an open subset of $\mathbb{R}^n\times \mathbb{R}$.

An initial value problem is a differential equation combined with an initial condition $$y(t_0)=y_0$$
where $(y_0,t_0)\in U$
