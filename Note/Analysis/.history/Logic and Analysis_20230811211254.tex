...
\begin{proof}[Prove Inverse Function Theorem Given Implicit Function Theorem]
    ...
    \begin{equation}
        ...
        \nonumber
    \end{equation}
    We can apply the implicit function theorem, there are open sets $U \subseteq \mathbb{R}^n$ and $W \subseteq \mathbb{R}^n$ such that $x_0 \in U$, $y_0 \in W$ and a function $g : W → U$ differentiable at y0 such that (g(y), y) ∈ A and F(g(y), y) = 0 for all y ∈ V .
