...
\begin{enumerate}
    ...
    \begin{enumerate}[(1).]
        ...
        \item $C=(k_1,k_2)$, where $k_1,k_2\in \mathbb{R}$. In this case $f^{-1}(C)=E[f>k_1]\cap E[f<k_2]$, which is a finite intersection of two open sets. So, $f^{-1}(C)$ is open.
        \item $C=\mathbb{R}$. In this case $f^{-1}(C)=E[f>k_1]\cup E[f<k_2], \forall k_1,k_2\in \mathbb{R}$ s.t. $k_1<k_2$. $f^{-1}(C)$ is a union of two open set, which is open.
        \item $C=(-\infty,k_2)\cup(k_1,\infty)$. In this case $f^{-1}(C)=E[f>k_1]\cup E[f<k_2], \forall k_1,k_2\in \mathbb{R}$ s.t. $k_1>k_2$. $f^{-1}(C)$ is a union of two open set, which is open.
    \end{enumerate}
\end{enumerate}
\end{proof}
