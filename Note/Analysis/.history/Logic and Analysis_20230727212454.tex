...
\begin{definition}[Lim Sups and Lim Infs]
    ...
    Either $\alpha_n = +\infty$ for all $n$, or $\alpha_n \in \mathbb{R}$ and $\alpha_1 \geq \alpha_2 \geq \alpha_3 \geq...$. Either $\beta_n = -\infty$ for all n, or $\beta_n \in \mathbb{R}$ and $\beta_1 ≤ \beta_2 ≤ \beta_3 ≤ ...$.
\end{definition}
