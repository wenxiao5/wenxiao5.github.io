...
\begin{proof}[Prove Inverse Function Theorem Given Implicit Function Theorem]
    ...
    \begin{equation}
        ...
        \nonumber
    \end{equation}
    We can apply the implicit function theorem, there are open sets $U \subseteq X$ and $W \subseteq \mathbb{R}^n$ such that $x_0 \in U$, $y_0 \in W$ and a function $g : W \rightarrow U$ differentiable at $y_0$ such that $F(g(y), y) = 0$ for all $y \in V$. Let $g$ be the function $0=F(g(y),y)=y-f(g(y))$, we have $f(g(y))=y$, that is $g=f^{-1}$.
