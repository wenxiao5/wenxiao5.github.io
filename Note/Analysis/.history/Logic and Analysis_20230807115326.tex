...
Theorem 13 Suppose $X \subseteq \mathbf{R}^n$ is open and $x \in X$. If $f: X \rightarrow \mathbf{R}^m$ is differentiable, then
$$
...
Theorem 14 (Corollary of 4.4) Suppose $X \subseteq \mathbf{R}^n$ is open and $x \in X$. If $f: X \rightarrow \mathbf{R}^m$ is $C^2$, then
$$
...
& \Rightarrow D^2 f(x) \text { has an orthonormal basis of eigenvectors }
\end{aligned}
$$
