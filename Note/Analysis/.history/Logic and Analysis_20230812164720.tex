...
\subsection{Theorem: Compact is preserved in compact-valued, uhs, correspondence}
\begin{theorem}
    Let $X$ be a compact set and $\Psi : X \rightarrow 2^X$ be a non-empty, compact-valued upper-hemicontinuous correspondence. Show that if $C \subseteq X$ is compact, then $\Psi(C)$ is compact.
\end{theorem}
