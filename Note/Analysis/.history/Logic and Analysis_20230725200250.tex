...
\subsection{Properties of Function}
...
\subsection{Associativity of Functions}
\begin{proposition}[Associativity of Functions]
    Suppose $\sigma:A \rightarrow B, \tau:B \rightarrow C, \rho:C \rightarrow D$ are functions and $\circ$ is the composition of functions, then $\rho\circ(\tau\circ\sigma)=(\rho\circ\tau)\circ\sigma$
\end{proposition}
