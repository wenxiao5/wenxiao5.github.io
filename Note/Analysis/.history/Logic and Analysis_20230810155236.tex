...
\subsection{Solutions of Special Case: One-dimension}
\begin{proposition}
    Given $y'=(y-y_s)'=\lambda (y-y_s)$, we have
    \begin{equation}
        \begin{aligned}
            y(t)=y_s+e^{\lambda(t-t_0)}(y(t_0)-y_s)
        \end{aligned}
        \nonumber
    \end{equation}
\end{proposition}
\begin{proof}
    $\lambda=\frac{y'(t)}{y(t)-y_s}=\frac{y(t+h)-y(t)}{h(y(t)-y_s)},\forall t$
\end{proof}
