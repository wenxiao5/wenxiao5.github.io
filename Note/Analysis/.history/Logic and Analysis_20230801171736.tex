...
\begin{proof}
\begin{enumerate}
    \item "$\Rightarrow$": Suppose $f$ is continuous. Consider any $c\in \mathbb{R}$. Since $(-\infty,c)$ and $(c,\infty)$ are open and $f$ is continuous, $E[f<c]=f^{-1}((-\infty,c))$ and $E[f>c]=f^{-1}((c,\infty))$ are open.
\end{enumerate}
\end{proof}
