...
\begin{definition}[Upper/Lower Hemicontinuous]
    ...
    \begin{enumerate}
        \item $\Psi$ is \textbf{upper hemicontinuous} (uhc) at $x_0 \in X$ if, for every open set $V \supseteq \Psi(x_0)$, there is an \underline{open set} $U$ with $x_0 \in U$ such that
        \begin{center}
