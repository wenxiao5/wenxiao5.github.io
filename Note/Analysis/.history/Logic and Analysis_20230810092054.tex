...
\begin{theorem}
    ...
    \begin{enumerate}
        ...
        \item If, in addition, F is Lipschitz in $y$ on $U$ (i.e. there is a constant K such that for all $(y,t),(\har{y},t)\in U$, $|F(y,t)-F(\hat{y},t)|\leq K|y-\hat{y}|$), then there is an interval $(a, b)$ containing $t_0$ such that the solution is unique on $(a, b)$.
    \end{enumerate}
\end{theorem}
