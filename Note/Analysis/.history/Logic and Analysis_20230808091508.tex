...
\begin{corollary}
    ...
    1. If $f \in C^3$, we may strengthen $o\left(|\gamma|^2\right)$ to $O\left(|\gamma|^3\right)$.
    2. If $f$ has a local maximum or local minimum at $x$, then
    $$
    D f(x)=0
    $$
    3. If $D f(x)=0$, then
    ...
    \lambda_1, \ldots, \lambda_n \geq 0, \lambda_i>0 \text { for some } i & f \text { has a local minimum } \\
    & \text { or a saddle at } x \\
    \lambda_1, \ldots, \lambda_n \leq 0, \lambda_i<0 \text { for some } i \Rightarrow f \text { has a local maximum } \\
    & \text { or a saddle at } x \\
