...
\begin{example}
    \begin{enumerate}
        ...
        \item Any finite set has Lebesgue measure zero in $\mathbb{R}^n$.
        \item \textit{Finite Union of sets that have Lebesgue measure zero has Lebesgue measure zero:} If $A_n$ has Lebesgue measure zero $\forall n$ then $\cup_{n\in N}A_n$ has Lebesgue measure zero.
    \end{enumerate}
\end{example}
