...
\begin{example}
    ...
    \begin{equation}
        \begin{aligned}
            D_{w_1}F(x_1^*,x_2^*;p,w_1,w_2)&=\begin{bmatrix}
                pa(a-1)(x_1^*)^{a-2}(x_2^*)^b\frac{\partial x_1^*}{\partial w_1}+pab(x_1^*)^{a-1}(x_2^*)^{b-1}\frac{\partial x_2^*}{\partial w_1}-1\\
                pab(x_1^*)^{a-1}(x_2^*)^{b-1}\frac{\partial x_1^*}{\partial w_1}+pb(b-1)(x_1^*)^{a}(x_2^*)^{b-2}\frac{\partial x_2^*}{\partial w_1}\\
                &=\begin{bmatrix}
                    pa(a-1)(x_1^*)^{a-2}(x_2^*)^b&pab(x_1^*)^{a-1}(x_2^*)^{b-1}\\
                    pab(x_1^*)^{a-1}(x_2^*)^{b-1}&pb(b-1)(x_1^*)^{a}(x_2^*)^{b-2}
                \end{bmatrix}
    ...
    \begin{equation}
        \begin{aligned}
            \frac{\partial (x_1,x_2)}{\partial w_1}(p,w_1,w_2)=-[D_{(x_1,x_2)}F(x_1^*,x_2^*;p,w_1,w_2)]^{-1}[D_{w_1}F(x_1^*,x_2^*;p,w_1,w_2)]
        \end{aligned}
        \nonumber
    \end{equation}
\end{example}
