...
\begin{proof}[Prove Inverse Function Theorem Given Implicit Function Theorem]
    ...
    \begin{equation}
        ...
        \nonumber
    \end{equation}
    We can apply the implicit function theorem, there are open sets $U \subseteq \mathbb{R}^n$ and $W \subseteq \mathbb{R}^n$ such that $x_0 \in U$, $y_0 \in W$ and a function $g : W \rightarrow U$ differentiable at $y_0$ such that (g(y), y) ∈ A and F(g(y), y) = 0 for all y ∈ V .
    Let $g$ be the function $0=F(g(y),y)=y-f(g(y))$, we have $f(g(y))=y$, that is $g=f^{-1}$.
    By the implicit function, $g(y)$ is differentiable and
    \begin{equation}
        \begin{aligned}
        ...
        \nonumber
    \end{equation}
    where $y_0=f(x_0)$. So, the inverse function theorem is proved.
\end{proof}
