...
\begin{proposition}[Facts about cardinality]
    \begin{enumerate}
        ...
        \item If $A\subseteq B$, then $|A|\leq|B|$. ($\Rightarrow$ if $B$ is countable and $A\subseteq B$, then $A$ is at most countable, that is, $A$ is either empty, finite, or countable)
