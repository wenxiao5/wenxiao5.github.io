...
An alternative notion of continuity looks instead at properties of the graph of the correspondence. The graph of a correspondence $\Psi : X \rightarrow 2^Y$ is the set
