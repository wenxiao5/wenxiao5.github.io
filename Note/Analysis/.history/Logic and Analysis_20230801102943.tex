...
\begin{definition}[Upper/Lower Hemicontinuous]
    ...
    \begin{enumerate}
        \item $\Psi$ is \textbf{upper hemicontinuous} (uhc) at $x_0 \in X$ if, for every open set $V \supseteq \Psi(x_0)$, there is an open set $U$ with $x_0 \in U$ such that $\Psi(x) \subseteq V$ for every $x \in U \cap X$
    \end{enumerate}
\end{definition}
\begin{center}\begin{figure}[htbp]
    \centering
