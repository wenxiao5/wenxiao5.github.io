...
\begin{definition}[Supremum and Infimum]
    ...
    \end{enumerate}
    If $\mathbb{X}$ is not bounded above, write sup $\mathbb{X} = \infty$. If $\mathbb{X}$ is not bounded below, write inf $\mathbb{X} = -\infty$. By convention, $\sup \emptyset = -\infty$, $\inf \emptyset = +\infty$.
\end{definition}
\begin{proposition}
