...
\begin{definition}[Upper/Lower Hemicontinuous]
    ...
    \begin{enumerate}
        ...
        \end{center}
        \textit{A set to “jump down” at the limit x0: It should mean the set suddenly gets smaller -- it “implodes in the limit” -- that is, there is a sequence $x_n \rightarrow x0$ and points $y_n \in \Psi(x_n)$ that are far from every point of $|Psi(x_0)$ as $n \rightarrow \infty$.}
    \end{enumerate}
\end{definition}
\begin{center}\begin{figure}[htbp]
    \centering
