...
\begin{theorem}[Transversality Theorem]
    ...
    \begin{enumerate}
        ...
        \item $\eixsts A_0 \subseteq A$ such that $A \backslash A_0$ has Lebesgue measure zero.
    \end{enumerate}
    Then there is a set $A_0 \subseteq A$ such that $A \backslash A_0$ has Lebesgue measure zero and for all $a \in A_0$, $0$ is a regular value of $f_a = f(\cdot, a)$.
\end{theorem}
