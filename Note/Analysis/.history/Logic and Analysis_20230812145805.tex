...
\begin{example}
    ...
    \begin{equation}
        ...
        \nonumber
    \end{equation}
    The firm selects $x_1$ and $x_2$ in order to maximize profits. \textbf{We aim to know how its choice of $x_1$ is affected by a change in $w_1$}.
    ...
    \begin{equation}
        \begin{aligned}
            ...
            \frac{\partial \pi}{\partial x_2}(x_1^*,x_2^*;p,w_1,w_2)=pb(x_1^*)^{a}(x_2^*)^{b-1}-w_1=0
        \end{aligned}
        \nonumber
    \end{equation}
