...
By the Theorem \ref{theorem:Solutions of Linear Differential Equations with Constant Coefficients}, we can now solve it. Specifically, the eigenvalues of $\begin{bmatrix}
    0&1\\
    c&b
\end{bmatrix}$ is $\frac{b\pm\sqrt{b^2+4c}}{2}$.

\begin{example}
    Consider the second order linear differential equation $y''=2y+y'$, we can solve the eigenvalues, $\lambda_1=-1,\lambda_2=2$.
\end{example}
