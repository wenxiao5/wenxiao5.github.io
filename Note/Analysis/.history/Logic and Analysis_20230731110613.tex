...
\begin{theorem}[Subset is Compact $\Leftrightarrow$ Complete and Totally Bounded]
...
\begin{proof}
    ...
    Conversely, suppose complete and totally bounded. Because totally bounded, we can extract a Cauchy subsequence. Because complete, subsequence converges to a limit in the subset, which shows that A is sequentially compact and hence compact.
\end{proof}
