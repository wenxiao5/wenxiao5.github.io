...
\begin{equation}
    ...
    \nonumber
\end{equation}
The requirement of "regular point" is necessary for the $Df(x_0,a_0)$ being invertible. Let $f(x_0,a_0)=0$:
\begin{equation}
    \begin{aligned}
        f(x,a)=Df(x_0,a_0)(x-x_0)+Df(x_0,a_0)(a-a_0)+\textnormal{remainder}
    \end{aligned}
    \nonumber
\end{equation}
