...
\subsection{Mean Value Theorem: $\exists c\in (a,b),f(b)-f(a)=f'(c)(b-a)$}
\begin{theorem}[Mean Value Theorem, Univariate Case]
...
\begin{theorem}[Mean Value Theorem, Genearl]
    Suppose $f : \mathbb{R}^n \rightarrow R$ is differentiable on an open set $X \subseteq \mathbb{R}^n$, $x, y \in X$ and $l(x, y) \subseteq X$. Then there exists $z \in l(x, y)$ such that $$f(y)-f(x)=Df(z)(y-x)$$
\end{theorem}
