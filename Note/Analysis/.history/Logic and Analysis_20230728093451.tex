...
\begin{proof}
    ...
    \begin{enumerate}[$\circ$]
        ...
        \item If $\inf_{x\in\mathbb{X}} f(x)$ is infinite, let $f\left(\sigma_{k}\right) \leq -k$. By the Bolzano-Weierstrass Theorem (\ref{B-W}), $\{\sigma_k\}$ contains a subsequence $\{\sigma_{k_n}\}\}$
    \end{enumerate}
