...
\begin{definition}
\normalfont
    Suppose $f : (X, d) \rightarrow (Y, \rho)$. $f$ is uniformly continuous if $$\forall \varepsilon>0, \exists \delta(\varepsilon)>0 \textnormal{ s.t. }\forall x_0\in X, d(x,x_0)<\delta(\varepsilon) \Rightarrow \rho(f(x), f(x_0))<\varepsilon$$
\end{definition}
