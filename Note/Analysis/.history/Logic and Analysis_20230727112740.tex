...
\begin{theorem}[Continuous $\Leftrightarrow$ Preimage of open set is open]\label{Continuous $\Leftrightarrow$ Preimage of open set is open}
...
\end{theorem}
\begin{proof}
    Proved by theorem \ref{Continuous $\Leftrightarrow$ Preimage of open set is open}.
\end{proof}
