...
Theorem 3 (Thm. 3.3) Suppose $X \subseteq \mathbf{R}^n$ is open and $f: X \rightarrow \mathbf{R}^m$ is differentiable at $x \in X$. Then $\frac{\partial f^i}{\partial x_j}$ exists at $x$ for $1 \leq i \leq m, 1 \leq j \leq n$, and
$$
