...
\begin{definition}[Cauchy Sequence]
    ...
    $$d(x_{k},x_{m})<\varepsilon,\  \forall k, m \geqslant N(\varepsilon)$$
\end{definition}
\textbf{Note:} In $\mathbb{E}_1=(\mathbb{R},\|\cdot\|)$, $\left\{x_{k}\right\} \text { converges } \Longleftrightarrow\left\{x_{k}\right\} \text { is Cauchy}$.
