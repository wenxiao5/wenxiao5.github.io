...
\end{theorem}
\begin{proof}
    Firstly, we prove "$g$ is differentiable":
    ...
    \begin{equation}
        ...
        \nonumber
    \end{equation}
    Find a $\Delta x$ such that the new $x$ can let the value go back to $0$, i.e., $f(x_0+\Delta x,a_0+h)=0$
    \begin{equation}
        \begin{aligned}
            0&=f(x_0+\Delta x,a_0+h)\\
            &=f(x_0,a_0)+D_xf(x_0,a_0+h)\Delta x+ D_a f(x_0,a_0)h
        \end{aligned}
        \nonumber
    \end{equation}
\end{proof}
