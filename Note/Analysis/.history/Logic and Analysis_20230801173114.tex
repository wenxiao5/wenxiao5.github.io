...
\begin{enumerate}
    ...
    \item "(b)$\Rightarrow$(a)": Suppose $E[f<c]=\{x\in A\mid f(x)<c\}$ and $E[f>c]=\{x\in A\mid f(x)>c\}$ are open for all $c\in \mathbb{R}$. Let $C\subseteq \mathbb{R}$ be an arbitrary open set. There are following cases about the $C$:
    \begin{enumerate}
        \item 
    \end{enumerate}
\end{enumerate}
