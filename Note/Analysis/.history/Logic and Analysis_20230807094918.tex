...
\begin{definition}[New Definition]
    \normalfont
    Using this notation, note that $f$ is \textbf{differentiable} at $x$ $\Leftrightarrow$ $\exists T_x\in L(\mathbb{R}^n,\mathbb{R}^m)$ such that $$f(x+h)=f(x)+T_x(h)+o(|h|)\textnormal{ as }h \rightarrow 0$$
\end{definition}
