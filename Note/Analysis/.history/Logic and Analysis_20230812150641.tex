...
\begin{example}
    ...
    \begin{equation}
        ...
        \nonumber
    \end{equation}
    The firm selects $x_1$ and $x_2$ in order to maximize profits. \textbf{We aim to know how its choice of $x_1$ and $x_2$ is affected by a change in $w_1$ and $w_2$}.
    ...
    \begin{equation}
        \begin{aligned}
            D_{(w_1,w_2)}F(x_1^*,x_2^*;p,w_1,w_2)=\begin{bmatrix}
                -1&0\\
                0&-1
            \end{bmatrix}
        \end{aligned}
