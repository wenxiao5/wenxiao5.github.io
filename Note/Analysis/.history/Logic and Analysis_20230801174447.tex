...
\begin{enumerate}
    ...
    \begin{enumerate}[(1).]
        ...
        \item $C=(k_1,k_2)$, where $k_1,k_2\in \mathbb{R}$. In this case $f^{-1}(C)=\{x\in A\mid f(x)\in (k_1,k_2)\}=E[f>k_1]\cap E[f<k_2]$, which is a finite intersection of two open sets. So, $f^{-1}(C)$ is open.
    ...
    \end{enumerate}
    Hence, $f^{-1}(C)=\{x\in X: f(x)\in C\} \textnormal{ is open in $X$ $\forall C\subseteq \mathbb{R}$ s.t. $C$ is open in $\mathbb{R}$}$
\end{enumerate}
\end{proof}
