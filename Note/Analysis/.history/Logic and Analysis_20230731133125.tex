...
\begin{proof}
    \begin{enumerate}
        \item Proof of maximum: Since $C$ is compact and $f$ is continuous, $f(C)\subset \mathbb{R}$ is compact (hence closed and bounded) by theorem \ref{con_compact_is_compact}.
    \end{enumerate}
