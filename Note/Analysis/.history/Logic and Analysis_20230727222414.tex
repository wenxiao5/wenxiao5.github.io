...
\subsection{Definition: $\lim\sup$ and $\lim\inf$}
...
\subsection{Exists Limit $\Rightarrow$ $\lim=\lim\sup=\lim\inf$}
\begin{theorem}
...
\subsection{Rising Sun Lemma: Sequence in $\mathbb{R}^n$ contains monotone subsequence}
...
\subsection{Bolzano-Weierstrass: Bounded Sequence in $\mathbb{R}^n$ contains a convergent subsequence}
\begin{theorem}[Bolzano-Weierstrass]
    Every bounded sequence of real num- bers contains a convergent subsequence.
\end{theorem}
