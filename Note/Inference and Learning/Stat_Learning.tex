...
\title{Statistical Computation and Learning}
\author{Wenxiao Yang}
...
\begin{enumerate}
    ...
    \end{definition}
    \item 
    \begin{definition}[$\ell_0$ pseudo-norm / Sparsity Index]
        The \underline{$\ell_0$ pseudo-norm} of a vector $x \in \mathbb{R}^n$ is $$\|x\|_0 \triangleq \sum_{i=1}^n \mathbf{1}_{\left\{x_i \neq 0\right\}}$$ i.e., the number of nonzero components of $x$.
    \end{definition}
    \item 
