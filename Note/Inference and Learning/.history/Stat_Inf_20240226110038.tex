...
\end{equation}
\begin{remark}
    (Actually, all we want to do is constructing a matrix $Q$ such that $Q\alpha_i=0$, so that we can get rid of fixed effect.) Another example of this kind of matrix is $\begin{bmatrix}
        -1&1&0&\cdots&0&0\\
        0&-1&1&\cdots&0&0\\
        &&&\cdots&&\\
        0&0&0&\cdots&-1&1\\
