...
\begin{equation}
    ...
    \nonumber
\end{equation}
where $\epsilon(1),\epsilon(0)$ are jointly normal. $\epsilon(1)-\epsilon(0)\sim N(0,\sigma^2_{\epsilon(1)-\epsilon(0)})$. It gives probit link function, $\beta=\frac{y_1-y_0}{\sigma_{\epsilon(1)-\epsilon(0)}}\in \mathbb{R}^d$.
