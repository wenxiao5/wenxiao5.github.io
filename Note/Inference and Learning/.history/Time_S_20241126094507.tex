...
\begin{enumerate}[$\cdot$]
    ...
    \begin{theorem}[Helly-Bray Theorem]
        ...
        for every \underline{bounded and continuous} function $f: \mathbb{R} \rightarrow \mathbb{R}$.
    \end{theorem}
    ...
    for every \underline{bounded and continuous} function $F: D[0,1] \rightarrow \mathbb{R}$.
\end{enumerate}
