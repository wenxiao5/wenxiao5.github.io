...
\begin{proof}[for the unbiased property]
    ...
    \begin{equation}
        \begin{aligned}
            \frac{\sigma^2}{N}\mathbb{E}[\nabla_Z g(\mathbf{Z})]&=\frac{\sigma^2}{N}\int_z f_Z(z)\nabla_z g(z) dz\\
            &=\frac{\sigma^2}{N}\int_z f_Z(z)d g(z)\\
            &=\frac{\sigma^2}{N}\left(f_Z(z)g(z)\bigg|_{\partial\mathbb{R}^K}-\int_z g(z)\frac{\partial  f_Z(z)}{\partial z}dz\right)\\
            &=\frac{\sigma^2}{N}\int_z g(z)\left(\frac{N}{\sigma^2}(z-\theta)'f_Z(z)\right)dz\\
