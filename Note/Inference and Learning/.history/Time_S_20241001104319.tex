...
\end{enumerate}
Consider $\bar{Y}=\frac{1}{T}\sum_{t=1}^T Y_t=\argmin_m\sum_{t=1}^T (Y_t-m)^2$.
\begin{remark}
    $\epsilon_t\sim i.i.d.(0,\sigma^2) \Rightarrow $ $\epsilon_t\sim \textnormal{WN}(0,\sigma^2)$ (i.e., a stronger assumption than white noise).
\end{remark}
