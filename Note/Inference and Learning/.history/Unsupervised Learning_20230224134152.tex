...
\begin{enumerate}[1.]
    ...
    \subitem 1. Choose the cluster with the most amount of points in it.
    \subitem Benefit: you'll end up with more balanced clusters
    \subitem 2. Choose the clusters with the highest inertia
    \subitem Benefit: you'll end up with a clustering with lower inertia
