...
\begin{definition}[Score Function]
    \normalfont
    The \textbf{score function} is $$u(\theta,\bar{X})=\frac{\partial}{\partial \theta}\log f(\vec{X}\mid\theta)=\frac{1}{f(\vec{X}\mid\theta)}\frac{\partial}{\partial \theta}f(\vec{X}\mid\theta)$$
