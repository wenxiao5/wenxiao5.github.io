...
\begin{equation}
    \begin{aligned}
        ...
        &=\textnormal{Pr}(\frac{\epsilon(0)-\epsilon(1)}{\sqrt{\textnormal{Var(\epsilon(0)-\epsilon(1))}}})\leq X^T\left(\frac{\gamma_1-\gamma_0}{\sqrt{\textnormal{Var}(\epsilon(0)-\epsilon(1))}}\right)\\
        &=F_{\epsilon(0)-\epsilon(1)}\left(X^T\left(\frac{\gamma_1-\gamma_0}{\sqrt{\textnormal{Var}(\epsilon(0)-\epsilon(1))}}\right)\right)
    \end{aligned}
    \nonumber
\end{equation}
