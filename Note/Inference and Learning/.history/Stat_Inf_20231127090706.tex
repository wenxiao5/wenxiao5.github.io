...
Let $\hat{\Lambda}=\hat{\Gamma}^{-1}\hat{\Omega}\hat{\Gamma}^{-1}$, $\Lambda=\Gamma_0^{-1}\Omega_0 \Gamma_0^{-1}$ $\sqrt{N}(\hat{\beta}_k-\beta_k) \xrightarrow{D} N\left(0,\hat{\Lambda}_{kk}\right)$. Hence,
\begin{equation}
    \begin{aligned}
        T_N\triangleq \hat{\Lambda}^{-\frac{1}{2}}\left(\hat{\beta}_k-\beta_k\right)\xrightarrow{D} N(0,1)
    \end{aligned}
    \nonumber
\end{equation}
...
\begin{equation}
    \begin{aligned}
        ...
        &=\mathbf{1}\left\{\hat{\beta}_k-1.96\frac{}{}\beta_k\right\}
    \end{aligned}
    \nonumber
\end{equation}
