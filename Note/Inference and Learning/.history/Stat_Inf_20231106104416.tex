...
Conisder the problem given $X=\begin{pmatrix}
    1\\
    R
\end{pmatrix}$. Let $\beta_0=\arg\min_{b\in \mathbb{R}^k}\mathbb{E}_{Y|X}[(Y-X'b)^2]$. By the F.O.C.
\begin{equation}
    \begin{aligned}
        \mathbb{E}_{Y|X}[(\underbrace{Y-X'\beta_0}_{\triangleq u})X]=0
    \end{aligned}
    \nonumber
\end{equation}
