...
\begin{definition}
    \normalfont
    "Regularity" condition: If $X$ are continuous, then $\mathbb{E}_\theta[\frac{\partial}{\partial \theta}\log f(x|\theta)]=\int_{-\infty}^\infty \left[\frac{\partial}{\partial \theta}\log f(x|\theta)\right]f(x|\theta) dx$
\end{definition}
\begin{remark}
