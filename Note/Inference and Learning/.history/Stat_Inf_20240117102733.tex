...
\begin{assumption}[Fundamental Assumption]
    $x$ is the realization of a random vector $X=(X_1,...,X_n)'$. The $X$ follows a distribution $P_0$, which is the \textbf{True Probability Generating Data}.
\end{assumption}
