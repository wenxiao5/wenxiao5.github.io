...
\begin{example}[ (Sample Mean)]
    We consider the parameter $\theta(P_0)=\mathbb{E}_{P_0}(Z)$, $\theta(P_m)=\bar{Z}_m=\frac{1}{m}\sum_{i=1}^m Z_i$. $v(P_0)(t)=\textnormal{Pr}_{P_0}\left(\frac{1}{m}\sum_{i=1}^m (Z_i-\mathbb{E}_{P_0}(Z))\leq t\right)$. The Bootstrap estimator is given by
    \begin{equation}
        \begin{aligned}
            v(P_m)(t)=\textnormal{Pr}_{P_0}\left(\frac{1}{m}\sum_{i=1}^m (Z_i^*-\underbrace{\mathbb{E}_{P_m}(Z)}_{\bar{Z}_m})\leq t\right)
        \end{aligned}
        \nonumber
    \end{equation}
    or
