...
\begin{example}
    ...
    \underline{Converge probability:} $P_\mu\left[\bar{X}-\frac{1.96}{\sqrt{n}}\leq\mu\leq\bar{X}+\frac{1.96}{\sqrt{n}}\right]=P_\mu\left[-\frac{1.96}{\sqrt{n}}\leq\bar{X}-\mu\leq \frac{1.96}{\sqrt{n}}\right]$.
\end{example}
