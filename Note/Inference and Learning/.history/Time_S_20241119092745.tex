...
\begin{equation}
    \begin{aligned}
        t(\rho_0)&=\frac{\hat{\rho}-\rho_0}{\hat{\sigma}/\sqrt{\sum_{t=1}^Ty_{t-1}^2}}=\frac{\sum_{t=1}^Ty_{t-1}\epsilon_t}{\sum_{t=1}^Ty_{t-1}^2}\frac{1}{\hat{\sigma}/\sqrt{\sum_{t=1}^Ty_{t-1}^2}}=\frac{\sum_{t=1}^Ty_{t-1}\epsilon_t}{\hat{\sigma}\sqrt{\sum_{t=1}^Ty_{t-1}^2}}
    \end{aligned}
    \nonumber
\end{equation}
