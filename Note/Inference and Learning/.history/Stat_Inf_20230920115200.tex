...
\begin{proof}
    \begin{enumerate}[(a).]
        ...
        \begin{equation}
            \begin{aligned}
                \mathbb{E}_\theta(\hat{\theta})=\mathbb{E}_\theta[\mathbb{E}[\tilde{\theta}\mid T]]=\mathbb{E}_\theta[\tilde{\theta}]
            \end{aligned}
            \nonumber
        \end{equation}
        ...
        \begin{equation}
            \begin{aligned}
                \textnormal{Var}(\hat{\theta})=\textnormal{Var}_\theta[\mathbb{E}[\tilde{\theta}\mid T]]\leq \textnormal{Var}_\theta(\tilde{\theta})
            \end{aligned}
            \nonumber
        \end{equation}
    \end{enumerate}
