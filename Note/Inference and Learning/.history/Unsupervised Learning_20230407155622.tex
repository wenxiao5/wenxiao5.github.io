...
\textbf{Underlying Model for single object $\vec{x}$ Drawn Using this Random Process}
...
\textbf{Underlying Model for the Entire Dataset $X=\left\{\vec{x}_1, \vec{x}_2, \ldots, \vec{x}_m\right\}$ Drawn Using this
Random Process}
\begin{enumerate}[$\bullet$]
    \item assuming $\Theta=\left\{\begin{array}{lll}\theta_1, \theta & , & 2, \ldots, \theta\end{array}\right\}$ distributions.
\end{enumerate}
$$
\begin{gathered}
P\left(x_1, x_2, \ldots, x_m \mid \Theta\right)=\prod_{i=1}^m P\left(x_i \mid \Theta\right)=\prod_{i=1}^m \sum_{k=1}^K P\left(x \in C_k\right) P\left(x \mid x \in C_k, \theta_k\right), \text { where } \\
\sum_{k=1}^K P\left(x \in C_k\right)=1
\end{gathered}
$$
