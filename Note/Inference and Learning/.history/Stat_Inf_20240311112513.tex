...
\begin{example}
    $\theta_0=\argmin_{\theta\in\Theta} \mathbb{E}\log f(x|\theta)$, where $f(x|\theta)$ is a likelihood function if and only if $f(x|\theta)\geq 0,\forall x$ and $\int_x f(x|\theta)dx=1,\forall \theta\in\Theta$.
\end{example}
