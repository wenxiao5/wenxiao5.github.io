...
\begin{equation}
    \begin{aligned}
        ...
        &=\sqrt{\mathbb{E}_{P_0}\left[(\bar{Z}^*_m-\mathbb{E}_{P_m}[\bar{Z}^*_m])^2\right]}
    \end{aligned}
    \nonumber
\end{equation}
...
\begin{equation}
    \begin{aligned}
        \textnormal{BSE}(P_m)&=\sqrt{\mathbb{E}_{P_0}\left[\left(\frac{1}{m}\sum_{i=1}^m(Z^*_i-\bar{Z}_m)\right)^2\right]}
    \end{aligned}
    \nonumber
\end{equation}
\end{remark}
