...
\begin{equation}
    \begin{aligned}
        T(\hat{\rho}-1)=\frac{\frac{1}{T}\sum_{t=1}^Ty_{t-1}\epsilon_t}{\frac{1}{T^2}\sum_{t=1}^Ty_{t-1}^2} \stackrel{d}{\longrightarrow} \frac{\frac{\sigma^2}{2}\left[W(1)^2-1\right]}{\sigma^2 \int_0^1 W(r)^2 dr}
    \end{aligned}
    \nonumber
\end{equation}
