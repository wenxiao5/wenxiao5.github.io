...
\begin{definition}
    \normalfont
    The \textbf{power function} of a test unit critical region $C\subseteq \mathbb{R}^n$ is the function $\beta:\Theta \rightarrow [0,1]$ given by $\beta(\theta)=P_\theta[\textnormal{Reject $H_0$}]=P[(X_1,...,X_n)'\in C]$
\end{definition}
