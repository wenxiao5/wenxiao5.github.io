...
\begin{equation}
    ...
    \nonumber
\end{equation}
where $\epsilon(1),\epsilon(0)$ are jointly normal. $\epsilon(1)-\epsilon(0)\sim N(0,\sigma^2_{\epsilon(1)-\epsilon(0)})$. It gives probit link function, $\beta=\frac{y_1-y_0}{\sqrt{\textnormal{Var}(\epsilon(0)-\epsilon(1))}}\in \mathbb{R}^d$.

The relative importance of $X_j$ relative to $X_k$ is $\frac{\beta_j}{\beta_k}=\frac{(y_1-y_0)_j}{(y_1-y_0)_k},\forall j,k\in \{1,...,d\}$.
