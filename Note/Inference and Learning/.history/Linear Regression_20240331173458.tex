...
\begin{equation}
    \begin{aligned}
        ...
        &=\frac{\textnormal{Var}\left(Y\mid X;\theta_0\right)}{F(X^T\beta_0)^2(1-F(X^T\beta_0))^2}\cdot\left(F'(X^T\beta_0)\cdot X\right)\cdot\left(F'(X^T\beta_0)\cdot X\right)^T\\
        &=\frac{(F'(X^T\beta_0))^2}{F(X^T\beta_0)^2(1-F(X^T\beta_0))^2}\cdot X X^T
    \end{aligned}
    \nonumber
\end{equation}
