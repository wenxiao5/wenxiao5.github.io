...
\begin{definition}[Fisher Information]
    ...
    \begin{equation}
        \begin{aligned}
            \mathcal{I}(\theta)=\textnormal{Var}_\theta(u(\theta,\vec{X}))
        \end{aligned}
        \nonumber
    \end{equation}
\end{definition}
\begin{lemma}[Fisher Information]
    ...
    \begin{equation}
        \begin{aligned}
            \mathcal{I}(\theta)&=\textnormal{Var}_\theta\left[\frac{\partial}{\partial \theta}\log f(\vec{X}\mid\theta)\right]\\
            &=\mathbb{E}_\theta\left[\left(\frac{\partial}{\partial \theta}\log f(\vec{X}\mid\theta)\right)^2\right]\\
            &=-\mathbb{E}_\theta\left[\frac{\partial^2}{\partial \theta^2}\log f(\vec{X}\mid\theta)\right]
        \end{aligned}
        \nonumber
    \end{equation}
\end{lemma}
...
\begin{proposition}[Cramér-Rao Lower Bound]
    ...
    \begin{equation}
        \begin{aligned}
            \textnormal{Var}_\theta[\hat{\theta}(\vec{X})]\geq \frac{\left(\frac{d}{d\theta}\mathbb{E}_\theta[\hat{\theta}(\vec{X})]\right)^2}{\mathcal{I}(\theta)}\equiv \textnormal{CRLB}\\
            \mathcal{I}(\theta)^{-1}
        \end{aligned}
        \nonumber
    \end{equation}
    , where $\mathcal{I}(\theta)=n \mathbb{E}_\theta[\left(\frac{\partial}{\partial \theta}\log f(x|\theta)\right)^2]$
\end{proposition}
\begin{remark}
