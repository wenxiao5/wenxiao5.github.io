...
\subsection{$K$-normal Means Probelm}
\begin{assumption}
...
Consider sample $\mathcal{Z}\sim N(\theta,\sigma^2 I_K)$, and a estimator based on $\mathcal{Z}$, $\hat{\theta}=\hat{\theta}(\mathcal{Z})$. Let $g(\hat{\theta})=\hat{\theta}-\mathcal{Z}$.
\begin{equation}
    \begin{aligned}
...
\begin{equation}
    \begin{aligned}
        g_{JS}(\mathcal{Z})&=-\frac{(K-2)}{\mathcal{Z}'\mathcal{Z}}\frac{\sigma^2}{N}\mathcal{Z}\\
        \sum_{k=1}^K \frac{\partial g_k(\mathcal{Z})}{\partial \mathcal{Z}_k}&=-\frac{(K-2)}{\mathcal{Z}'\mathcal{Z}}\frac{\sigma^2}{N}\sum_{k=1}^K\left(1-\frac{2 \mathcal{Z}_k^2}{\mathcal{Z}'\mathcal{Z}}\right)\\
        &=-\frac{(K-2)^2}{\mathcal{Z}'\mathcal{Z}}\frac{\sigma^2}{N}
    \end{aligned}
    \nonumber
\end{equation}
Hence,
...
\begin{equation}
    ...
    \nonumber
\end{equation}
As $\mathcal{Z}_k\sim N(\theta_k,\frac{\sigma^2}{N})$, $\mathcal{Z}'\mathcal{Z}=\sum_{k=1}^K \mathcal{Z}_k^2\sim \frac{\sigma^2}{N}V$ such that $V\sim \chi^2_{K+2W}$ where $W\sim \textnormal{Poisson}(\frac{\rho}{2}), \rho=N\sum_{k=1}^K \frac{\theta_K^2}{\sigma^2}$. So,
\begin{equation}
    \begin{aligned}
