...
\begin{proposition}[Long Regression]
    ...
    \end{pmatrix}=\mathbb{E}[ZZ']^{-1}\mathbb{E}[ZY]$, $Z=\begin{pmatrix}
        X\\
        W
    \end{pmatrix}$. The same as best linear predictor.
\end{proposition}
...
\begin{proposition}[Auxiliary Regression]
    $\mathbb{E}^*[W|X]=\Pi_0 X$, which multivariate regression. $\mathbb{E}^*[W_j|X]=X'\Pi_{j0}$, where $\Pi_{j0}=\mathbb{E}[XX']^{-1}\mathbb{E}[XW_j]$.
\end{proposition}
