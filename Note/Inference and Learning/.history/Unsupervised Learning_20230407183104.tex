...
a. $\Theta=\left\{\left(\mu_1, \Sigma_1\right), \ldots,\left(\mu_{\mathrm{K}}, \boldsymbol{\Sigma}_K\right)\right\}$ and $W=\left\{P\left(x \in C_1\right), \ldots, P\left(x \in C_K\right)\right\}$
Can be selected randomly, or with some pre-set starting values.
- Repeat
