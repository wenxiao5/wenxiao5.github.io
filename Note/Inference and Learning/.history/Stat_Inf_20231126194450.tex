...
\section{Card-Krueger Model: Proxy Variable Regression}
...
\begin{equation}
    ...
    \nonumber
\end{equation}
Given a \textbf{proxy variable} (cost function) about $s$:
\begin{equation}
    \begin{aligned}
...
\end{equation}
\begin{enumerate}
    \item \textbf{Long Regression}: $$\mathbb{E}^*[Y|S,A]=\alpha_0+\beta_0s+A$$
    \item Short Regression: $$\mathbb{E}^*[Y|s]=\alpha_0+b_0s$$
    \item \textbf{Auxillary Regression}: $$\mathbb{E}^*[A|s]=\mathbb{E}[A]-\eta_0\mathbb{E}[s]+\eta_0 s$$
    where $\eta_0=\frac{\text{Cov}(A,s)}{\text{Var}(s)}$ and $s=\frac{\beta_0-C}{k_0}$
    \begin{equation}
        \begin{aligned}
    ...
    \begin{equation}
        \begin{aligned}
            ...
            &=\alpha_0+\beta_0s+\mathbb{E}[A]+k_0\rho_{AC}\frac{\sigma_A}{\sigma_C}\mathbb{E}[s]-k_0\rho_{AC}\frac{\sigma_A}{\sigma_C} s
        \end{aligned}
        \nonumber
    \end{equation}
\end{enumerate}
