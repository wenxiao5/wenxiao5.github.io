...
\paragraph*{A.}
Derive the average log-likelihood function $L_N(\beta)$ for this problem, and show that the first-order condition for the maximum likelihood (ML) estimator ^ can be rewritten in the form
