...
\begin{equation}
    \begin{aligned}
        \frac{1}{n_1}\sum_{i=1}^n Y_i T_i=\frac{n}{n_i}\frac{1}{n}\sum_{i=1}^n Y_i T_i=\left(P[T=1]\right)^{-1} \mathbb{E}[YT]= \left(P[T=1]\right)^{-1}\mathbb{E}[YT\mid T=1]P[T=1]=\mathbb{E}[YT\mid T=1]
    \end{aligned}
    \nonumber
\end{equation}
