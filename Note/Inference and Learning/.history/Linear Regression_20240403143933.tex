...
Define
\begin{enumerate}[$\circ$]
    \item the score function, $g(Z,\theta)=\frac{\partial}{\partial \theta}m(Z,\theta)\in \mathbb{R}^d$.
    \item and the Hessian matrix, $G(Z,\theta)=\frac{\partial^2}{\partial \theta\partial \theta^T}m(Z,\theta)\in \mathbb{R}^{d\times d}$.
\end{enumerate}
\begin{definition}
\normalfont
\begin{enumerate}
