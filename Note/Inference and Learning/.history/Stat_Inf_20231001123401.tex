...
\begin{definition}[Score Function]
    \normalfont
    The score function is $$u(\theta,X_1,...,X_n)=\frac{\partial}{\partial \theta}\log f(\vec{X}\mid\theta)=\frac{1}{f(\vec{X}\mid\theta)}\frac{\partial}{\partial \theta}f(\vec{X}\mid\theta)$$
