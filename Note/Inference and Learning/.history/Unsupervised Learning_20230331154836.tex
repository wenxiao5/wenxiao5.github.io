...
We can project our $X_{m\times n}$ onto a new matrix $Y_{m\times p}=X_{m\times n}U_{n\times p}$ with $p\leq n$ attributes. Each column of $Y_{m\times p}$ (i.e., the projected attributes $Y_{*j}$) is known as a \textbf{principal component}.
