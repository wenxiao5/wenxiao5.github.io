...
\begin{theorem}[Asymptotic Normality of M-estimators, Theorem 22.3 (Hansen, 2022)]\label{thm:asymptotic_normality_of_m_estimators}
    ...
    \begin{enumerate}
        ...
        \item[A5.] $G:=G(\theta_0)=\mathbb{E}_{\theta_0}\left[\frac{\partial^2}{\partial \theta\partial \theta^T}m(Z,\theta_0)\right]$ is invertible.
    \end{enumerate}
    Then,
    \begin{equation}
        \begin{aligned}
