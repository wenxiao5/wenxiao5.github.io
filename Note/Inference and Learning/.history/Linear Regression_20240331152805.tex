...
\begin{corollary}
    If $g(\theta_0)=0$, then $I(\theta_0)=\mathbb{E}g(z,\theta_0)g(z,\theta_0)^T=G(\theta_0)$. Hence, $$\sqrt{n}\left(\hat{\theta}-\theta_0\right) \stackrel{d}{\Rightarrow} N\left(0,I(\theta_0)^{-1}\right)$$
\end{corollary}
