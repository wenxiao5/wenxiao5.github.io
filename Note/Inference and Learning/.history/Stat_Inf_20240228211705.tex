...
\begin{example}[ (Sample Mean)]
    ...
    \begin{equation}
        \begin{aligned}
            v(P_m)(t)(t)=\textnormal{Pr}_{P_m}\left(\frac{1}{m}\sum_{i=1}^m (Z_i^*-\bar{Z}_m)\leq t\right)
        \end{aligned}
        \nonumber
    \end{equation}
    or
    \begin{equation}
        \begin{aligned}
            v_A(P_m)(t)=\textnormal{Pr}_{P_m}\left(\sqrt{m}\frac{\frac{1}{m}\sum_{i=1}^m (Z_i^*-\bar{Z}_m)}{\sqrt{\text{Var}_{P_0}(\theta(P_m))}}\leq t\right)
        \end{aligned}
        \nonumber
    \end{equation}
