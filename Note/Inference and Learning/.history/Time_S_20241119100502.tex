...
\begin{enumerate}
    ...
    \item The $\rho=1$ distribution of $\{y_t:0\leq t\leq T\}$ can be approximated by (mean of) that of a continuous time Gaussian random walk.
\end{enumerate}
...
\begin{lemma}
    ...
    \begin{enumerate}
        ...
        \item For any $0\leq t_1\leq t_2$, $y_{t_2}-y_{t_1}=\sum_{i=t_1+1}^{t_2}\epsilon_i\perp \{y_t:0\leq t\leq t_1\}$.
    \end{enumerate}
\end{lemma}
