...
\begin{enumerate}
    ...
    \item Let $\boldsymbol{U}_{n \times p}=\left[\boldsymbol{v}_{* 1}\left|\boldsymbol{v}_{* 2}\right| \ldots \mid \boldsymbol{v}_{* p}\right]$ we call these eigenvectors the loading vectors.
\end{enumerate}
