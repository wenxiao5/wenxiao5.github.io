...
\begin{definition}[Prediction-error Decomposition]
    ...
    \begin{equation}
        \begin{aligned}
            f_{2:T}\left(Y_2,...,Y_T\mid Y_1;\phi,\sigma^2\right)=f_2\left(Y_2\mid Y_1;\phi,\sigma^2\right)f_3\left(Y_3\mid Y_2, Y_1;\phi,\sigma^2\right)f_T\left(Y_T\mid Y_{T-1}, Y_{T-2},..., Y_1;\phi,\sigma^2\right)
        \end{aligned}
        \nonumber
    \end{equation}
\end{definition}
