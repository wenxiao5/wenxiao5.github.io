...
\begin{enumerate}
    ...
    \item Hessian: $G(\theta):=\mathbb{E}_{\theta_0}G(Z,\theta)$. (We use $G$ denote the true population Hessian, $G:=G(\theta_0)$).
\end{enumerate}
\end{definition}
...
\begin{proof}
    ...
    \begin{equation}
        \begin{aligned}
            ...
            \textnormal{Var}(\hat{g}(\theta_0))&=\frac{1}{n}\textnormal{Var}(g(Z,\theta_0))
        \end{aligned}
        \nonumber
    \end{equation}
    By Taylor,
    \begin{equation}
        \begin{aligned}
            \sqrt{n}\left(\hat{g}(\hat{\theta})-\hat{g}(\theta_0)\right)=\hat{G}(\bar{\theta})(\hat{\theta}-\theta_0)
        \end{aligned}
        \nonumber
    \end{equation}
    ...
    \begin{equation}
        \begin{aligned}
            -\sqrt{n}\hat{g}(\theta_0)=\sqrt{n}\left(\hat{g}(\hat{\theta})-\hat{g}(\theta_0)\right)\approx G(\hat{\theta}-\theta_0)\\
            \hat{\theta}-\theta_0\approx -G^{-1}\sqrt{n}\hat{g}(\theta_0)
        \end{aligned}
        \nonumber
    \end{equation}
\end{proof}
