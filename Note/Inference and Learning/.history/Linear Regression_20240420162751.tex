...
\begin{equation}
    \begin{aligned}
        \frac{\partial^2 L_N(\hat{\beta})}{\partial \beta\partial \beta^T}=\frac{1}{N}\sum_{i=1}^N\left[\frac{1}{x_i^T\hat{\beta}}+\log y_i\right]x_i=\frac{1}{N}\sum_{i=1}^N u_i(\hat{\beta})\cdot x_i
    \end{aligned}
    \nonumber
\end{equation}
