...
\begin{definition}[Prototype-Based Cluster]
    A prototype-based cluster defines a cluster as a set of objects in which each object is closer (or more similar) to the \underline{prototype} that defines the cluster than to the \underline{prototype} of any other cluster.
\end{definition}
