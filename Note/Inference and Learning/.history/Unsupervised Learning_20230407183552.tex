...
\begin{enumerate}[$\bullet$]
    ...
    \begin{equation}
        \begin{aligned}
            P\left(\vec{x}_i \in C_t \mid \vec{x}_i, \Theta, W\right)=\frac{P\left(\vec{x}_i \mid \vec{x}_i \in C_t, \Theta, W\right) P\left(\vec{x} \in C_t\right)}{\sum_{k=1}^K P\left(\vec{x}_i \mid \vec{x}_i \in C_k, \Theta, W\right) P\left(\vec{x} \in C_k\right)}\\
            t=1,\dots,K
        \end{aligned}
        \nonumber
    \end{equation}
