...
\begin{enumerate}[$\bullet$]
    ...
    \begin{equation}
        \begin{aligned}
            T_{LR}\left(X_1,...,X_n\right)&=2\left\{l(\hat{\theta}_{ML}\mid X_1,...,X_n)-l(\theta\mid X_1,...,X_n)\right\}\\
            &=2\log\left\{\frac{l(\hat{\theta}_{ML}\mid X_1,...,X_n)}{l(\theta\mid X_1,...,X_n)}\right\}
        \end{aligned}
        \nonumber
    \end{equation}
    The motivation is Neyman-Pearson Lemma (\ref{NP_lemma})
\end{enumerate}
