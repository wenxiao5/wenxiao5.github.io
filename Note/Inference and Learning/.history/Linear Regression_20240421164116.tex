...
Given $|y_i|>c$, $Y\mid x_i\sim N(x_i^T\beta,\sigma^2) \Rightarrow \frac{Y-x_i^T\beta}{\sigma}\mid x_i \sim N(0,1)$, $P(y_i\mid x_i;\beta,\sigma^2)=\textnormal{Pr}\left(\right)$
