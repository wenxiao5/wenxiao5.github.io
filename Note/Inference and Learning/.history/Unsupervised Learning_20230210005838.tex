...
\tetxbf{\underline{Goal}}: project multidimensional data onto a $2$ or $3$-dimensional plane while preserving \textbf{clustering structure} of the dataset.

Using t-SNE plots help us visualize some aspects of the underlying clustering structure of the data.
