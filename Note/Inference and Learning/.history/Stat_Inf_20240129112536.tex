...
\begin{enumerate}
    ...
    \begin{example}
        ...
        \begin{equation}
            \begin{aligned}
                v(P_m)(t)>\text{Pr}\left(\max\{\mathcal{Z}-c,0\}\leq t\right)>v(P_0)(t)
            \end{aligned}
            \nonumber
        \end{equation}
        We have
        \begin{equation}
            \begin{aligned}
                v(P_m)(t)=\text{Pr}_{P_m}\left(\left(\max\{\frac{1}{\sqrt{m}}\sum_{i=1}^m(Z_i^*-\bar{Z}_m)+\sqrt{m}\bar{Z}_m,0\}-\max\{\sqrt{m}\bar{Z}_m,0\}\right)\leq t\right)
            \end{aligned}
            \nonumber
        \end{equation}
    \end{example}
