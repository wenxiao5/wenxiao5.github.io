...
\begin{enumerate}[$\circ$]
    ...
    \begin{equation}
        \begin{aligned}
            \mathbb{E}\left[\tilde{Y}_{t-1}^2\epsilon_t^2\mid\epsilon_{t-1},\epsilon_{t-2},...\right]=\tilde{Y}_{t-1}^2\mathbb{E}\left[\epsilon_t^2\mid\epsilon_{t-1},\epsilon_{t-2},...\right]=\tilde{Y}_{t-1}^2\sigma^2
        \end{aligned}
        \nonumber
    \end{equation}
    \begin{proof}
        ...
        \begin{equation}
            \begin{aligned}
                \frac{1}{T}\sum_{t=2}^T\left[\sigma^2\tilde{Y}_{t-1}^2\right]=\sigma^2\frac{1}{T}\sum_{t=2}^T\tilde{Y}_{t-1}^2 \stackrel{P}{\longrightarrow} \frac{\sigma^2}{1-\sigma^4} \stackrel{P}{\longrightarrow} \mathbb{E}\left[\tilde{Y}_{t-1}^2\epsilon_t^2\right]
            \end{aligned}
            \nonumber
        \end{equation}
        ...
        \begin{equation}
            \begin{aligned}
                \mathbb{E}\left[\tilde{Y}_{t-1}^2\epsilon_t^2\right]=\mathbb{E}[\tilde{Y}_{t-1}^2]\mathbb{E}[\epsilon_t^2]=\frac{\sigma^4}{1-\sigma^2}
            \end{aligned}
            \nonumber
        \end{equation}
    \end{proof}
...
\begin{equation}
    \begin{aligned}
        \frac{1}{\sqrt{T}}\sum_{t=1}^T \tilde{Y}_{t-1}\epsilon_t \stackrel{d}{\longrightarrow} \mathcal{N}\left(0,\frac{\sigma^4}{1-\sigma^2}\right)
    \end{aligned}
    \nonumber
\end{equation}
Since $\hat{\phi}=\frac{\sum_{t=2}^TY_{t-1}Y_t}{\sum_{t=2}^T Y_{t-1}^2}=\phi+\frac{\sum_{t=2}^TY_{t-1}\epsilon_t}{\sum_{t=2}^T Y_{t-1}^2}$,
\begin{equation}
    \begin{aligned}
        \sqrt{T}\left(\hat{\phi}-\phi\right) = 
    \end{aligned}
    \nonumber
\end{equation}
