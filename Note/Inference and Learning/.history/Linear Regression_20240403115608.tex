...
\begin{equation}
    \begin{aligned}
        \sqrt{n}\left(\tau(\hat{\beta})-\tau(1)\right)\sim \mathcal{N}(0,\tau'(1)\hat{\mathcal{I}}^{-1}\tau'(1))
    \end{aligned}
    \nonumber
\end{equation}
...
\begin{equation}
    \begin{aligned}
        g(Z\mid \beta)=\frac{\partial (Y-\rho(B(X)^T\beta))^2}{\partial \beta}=-2\left[Y-\rho(B(X)^T\beta)\right]\rho'(B(X)^T\beta)\cdot B(X)
    \end{aligned}
    \nonumber
\end{equation}
...
\begin{equation}
    \begin{aligned}
        \textnormal{Var}(g(Z\mid \beta))&=\mathbb{E}_X\textnormal{Var}(g(Z\mid \beta)\mid X)+\textnormal{Var}\underbrace{\mathbb{E}[g(Z\mid \beta)\mid X]}_{=0}\\
        &=
    \end{aligned}
    \nonumber
\end{equation}
