...
\underline{Observation:} If $\beta$ is differentiable, then an unbiased test of the $H_0:\theta\in\Theta_0 \textnormal{ vs. }H_1:\theta\in\Theta_1$ satisfies $\beta'(\theta_0)=0$
