...
Consider a variable, $\mathcal{Z}\sim N(\theta,\sigma^2 I_K)$, and a estimator based on $\mathcal{Z}$, $\hat{\theta}=\hat{\theta}(\mathcal{Z})$. Let $g(\hat{\theta}_{MLE})=\hat{\theta}-\mathcal{Z}$.
\begin{equation}
    \begin{aligned}
        \hat{R}_\textnormal{SURE}(\mathcal{Z})=K\sigma^2+2\sigma^2\sum_{k=1}^K \frac{\partial g_k(\mathcal{Z})}{\partial \mathcal{Z}_k}+\sum_{k=1}^K\left(\hat{\theta}_k- \mathcal{Z}_k\right)^2
    \end{aligned}
    \nonumber
\end{equation}
which has expectation
...
\begin{equation}
    \begin{aligned}
        \hat{R}_\textnormal{SURE}(\mathcal{Z})=\frac{K}{N}\sigma^2-\frac{2\sigma^2}{N}\frac{(K-2)^2}{\mathcal{Z}'\mathcal{Z}}\frac{\sigma^2}{N}+\frac{2\sigma^2}{N}\frac{(K-2)^2}{(\mathcal{Z}'\mathcal{Z})^2}\left(\frac{\sigma^2}{N}\right)^2\sum_{k=1}^K \mathcal{Z}_k^2
    \end{aligned}
    \nonumber
\end{equation}
