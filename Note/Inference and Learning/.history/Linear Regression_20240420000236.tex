...
\begin{equation}
    ...
    \nonumber
\end{equation}
Also, suppose the marginal distribution of the p-dimensional regressors $x_i$ is unspecified and, as
usual, $\beta_0$ is unknown, except that the distribution of $x_i$ and the (compact) parameter space $B\ni\beta_0$ has $\textnormal{Pr}(x_i^T\beta\geq c)$ for some small positive number $c$ and for all $\beta\in B$.
