...
\begin{enumerate}
    ...
    \begin{equation}
        ...
        \nonumber
    \end{equation}
    \item \textbf{\underline{Creates a Similarity Matrix $Q$ for the Points (i.e., Decision Variables we are Trying to Solve for)} in the \underline{Projected Dataset}:} Similarity between a given point $y_i$ and another point $y_j$ is a function about $t$-distribution centered at $y_i$.
