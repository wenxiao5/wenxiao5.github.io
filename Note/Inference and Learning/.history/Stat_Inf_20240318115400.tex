...
\begin{theorem}[Asymptotic Normality of M-estimators]\label{thm:asymptotic_normality_of_m_estimators}
    ...
    \begin{equation}
        \begin{aligned}
            \sqrt{n}\left(\hat{\theta}-\theta_0\right) \stackrel{d}{\Rightarrow} N\left(0,Q\right)
        \end{aligned}
        \nonumber
    \end{equation}
    where
    \begin{equation}
        \begin{aligned}
            Q=G^{-1}\left[\mathbb{E}g(z,\theta_0)g(z,\theta_0)^T\right](G^{-1})^T
        \end{aligned}
        \nonumber
    \end{equation}
\end{theorem}
...
\begin{equation}
    \begin{aligned}
        \sqrt{n}\left(\theta_{MLE}-\theta_0\right) \stackrel{d}{\Rightarrow} N\left(0,Q\right)
    \end{aligned}
    \nonumber
\end{equation}
where
