...
\begin{equation}
    \begin{aligned}
        T(\hat{\rho}-1)=\frac{\frac{1}{T}\sum_{t=1}^Ty_{t-1}\epsilon_t}{\frac{1}{T^2}\sum_{t=1}^Ty_{t-1}^2} \stackrel{d}{\longrightarrow} \frac{\frac{\sigma^2}{2}\left[W(1)^2-1\right]}{\sigma^2 \int_0^1 W(r)^2 dr}=\frac{\frac{1}{2}\left[W(1)^2-1\right]}{\int_0^1 W(r)^2 dr}
    \end{aligned}
    \nonumber
\end{equation}
...
\begin{enumerate}
    \item $\hat{\sigma}^2=\frac{1}{T}\sum_{t=1}^T(y_t-\hat{\rho}y_{t-1})^2 \approx \frac{1}{T}\sum_{t=1}^T(y_t-\rho y_{t-1})^2+o_P(1)=\frac{1}{T}\sum_{t=1}^T\epsilon_t^2 \stackrel{P}{\longrightarrow} \mathbb{E}[\epsilon_t^2]=\sigma^2$ (if $|\rho|<1$ or if $\rho=1$).
\end{enumerate}
