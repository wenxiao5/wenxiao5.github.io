...
\begin{equation}
    \begin{aligned}
        \ln f(\Gamma,X)=\ln\textnormal{Pr}(\Gamma=1|X)+\ln f_X(X)
    \end{aligned}
    \nonumber
\end{equation}
Let
\begin{equation}
    \begin{aligned}
        Q(\beta):=-\mathbb{E}_{\beta_0}\ln f(\Gamma,X)=-\mathbb{E}_{\beta_0}\ln\textnormal{Pr}(\Gamma=1|X)-\mathbb{E}_{\beta_0}\ln f_X(X)
    \end{aligned}
    \nonumber
\end{equation}
...
\begin{equation}
    \begin{aligned}
        \arg\min_{\beta}Q(\beta)\equiv \arg\max_{\beta}\mathbb{E}_{\beta_0}\ln\textnormal{Pr}(\Gamma=1|X)
    \end{aligned}
    \nonumber
\end{equation}
