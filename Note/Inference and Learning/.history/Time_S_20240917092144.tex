...
\begin{definition}[$AR(1)$]
    ...
    where $\epsilon_t\sim \textnormal{WN}(0,\sigma^2)$.
    \begin{note}
        $|\phi|<1$ is not assumed (yet) and $Y_1=\frac{c}{1-\phi}+\sum_{i=0}^\infty \phi^i\epsilon_{1-i}$ is not assumed.
    \end{note}
\end{definition}
\begin{enumerate}[$\circ$]
    \item If $|\phi|<1$ and $Y_1=\frac{c}{1-\phi}+\sum_{i=0}^\infty \phi^i\epsilon_{1-i}$, $Y_t=\frac{c}{1-\phi}+\sum_{i=0}^\infty \phi^i\epsilon_{t-i}$.
