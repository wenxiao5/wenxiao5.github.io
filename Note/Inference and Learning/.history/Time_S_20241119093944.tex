...
\begin{note}
    ...
    \begin{enumerate}
        ...
        \item $\frac{1}{\sqrt{T}}\sum_{t=1}^Ty_{t-1}\epsilon_t \stackrel{d}{\longrightarrow} \textnormal{something else}$.
    \end{enumerate}
\end{note}
Thus,
\begin{equation}
...
Now, we want to find the asymptotic null distribution of $\frac{1}{T^2}\sum_{t=1}^Ty_{t-1}^2$ and $\frac{1}{\sqrt{T}}\sum_{t=1}^Ty_{t-1}\epsilon_t$.
