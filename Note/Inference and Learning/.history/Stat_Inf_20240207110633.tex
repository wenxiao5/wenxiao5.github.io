...
\begin{proof}
    ...
    \begin{equation}
        \begin{aligned}
            \hat{\beta}_\textnormal{GMM}&=\left(\hat{Q}^TW\hat{Q}\right)^{-1}\hat{Q}^TW\frac{1}{m}\sum_{i=1}^mZ_iY_i\\
            &=\hat{\beta}_\textnormal{GMM}=\left(\hat{Q}^TWW^{-1}W\hat{Q}\right)^{-1}\hat{Q}^TWW^{-1}W\frac{1}{m}\sum_{i=1}^mZ_iY_i\\
            &=\hat{\beta}_\textnormal{GMM}=\left((W\hat{Q})^TW^{-1}(W\hat{Q})\right)^{-1}(W\hat{Q})^TW^{-1}W\frac{1}{m}\sum_{i=1}^mZ_iY_i\\
        \end{aligned}
        \nonumber
    \end{equation}
\end{proof}
