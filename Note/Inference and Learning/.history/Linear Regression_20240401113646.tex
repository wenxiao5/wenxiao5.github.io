...
$I(\theta_0)=\textnormal{Var}[g(Z,\theta_0)]$
...
\begin{corollary}[Second Information Equality]\label{cor:asymptotic_normality_of_m_estimators}
    ...
    $$\sqrt{n}\hat{g}(\theta_0)\stackrel{d}{\Rightarrow} N\left(0,I(\theta_0)\right)$$
\end{corollary}
...
$$\sqrt{n}\left(\hat{\theta}-\theta_0\right) \stackrel{d}{\Rightarrow} N\left(0,I(\theta_0)^{-1}\right)$$
$$\sqrt{n}\hat{g}(\theta_0)\stackrel{d}{\Rightarrow} N\left(0,I(\theta_0)\right)$$
We want to test
\begin{equation}
    \begin{aligned}
...
\subsubsection*{Wald: Distance on ``$x$ axis''}
The test statistic is
\begin{equation}
    \begin{aligned}
        W=n \left(\hat{\theta}-\theta_0\right)^T \hat{I} \left(\hat{\theta}-\theta_0\right)
    \end{aligned}
    \nonumber
\end{equation}
where $\hat{I}$ is an estimator of $I(\theta_0)$, $\hat{I}:=I(\hat{\theta}_\textnormal{MLE})^{-1}$
