...
\chapter{}
Consider $Z\in \mathbb{Z}=\{z_1,....,z_J\}$ with parameter $\theta=\{\theta_1,...,\theta_J\}\in \Theta= S^{J-1}=\{\theta:\sum_{j=1}^J\theta_j=1,\theta_j\geq 0, j=1,...,J\}$ such that $P(Z=z_j\mid\theta)=\theta_j$
