...
\begin{enumerate}[$\bullet$]
    ...
    $$
    \begin{gathered}
    P\left(\vec{x}_1, \vec{x}_2, \ldots, \vec{x}_m \mid \Theta\right)=\prod_{i=1}^m P\left(\vec{x}_i \mid \Theta\right)=\prod_{i=1}^m \sum_{k=1}^K P\left(\vec{x}_i \in C_k\right) P\left(x \mid \vec{x}_i \in C_k, \theta_k\right)
    \end{gathered}
    $$
    where $\sum_{k=1}^K P\left(x \in C_k\right)=1$.
\end{enumerate}
