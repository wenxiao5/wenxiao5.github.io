...
\begin{remark}
    ...
    \begin{enumerate}
        ...
        \begin{equation}
            \begin{aligned}
                \hat{V}=\frac{1}{n}\sum_{i=1}^n x_ix'_i \hat{\epsilon}_i^2 \stackrel{P}{\longrightarrow} \mathbb{E}[x_ix'_i \hat{\epsilon}_i^2]=V, \textnormal{ where } \hat{\epsilon}_i=y_i-\hat{\beta}'_{OLS}x_i
            \end{aligned}
            \nonumber
        \end{equation}
        ...
        \begin{equation}
            \begin{aligned}
                V=\mathbb{E}[x_ix'_i \hat{\epsilon}_i^2]=...\underbrace{=}_{LIE} \sigma^2 \mathbb{E}[x_ix'_i]
            \end{aligned}
            \nonumber
        \end{equation}
    \end{enumerate}
