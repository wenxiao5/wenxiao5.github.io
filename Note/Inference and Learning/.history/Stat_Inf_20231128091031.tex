...
\begin{enumerate}
    ...
    \item \textbf{Auxillary Regression}: By the best linear predictor, the $\mathbb{E}^*[A|s]$ can be written as $\mathbb{E}^*[A|s]=\textnormal{constant}+\frac{\textnormal{Cov}(A,s)}{\textnormal{Var}(s)}s$. Then,
    \begin{equation}
        \begin{aligned}
