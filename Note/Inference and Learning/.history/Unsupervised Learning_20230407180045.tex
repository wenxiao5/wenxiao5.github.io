...
\begin{equation}
    P\left(\vec{x} \in C_k \mid \vec{x}\right)=\frac{P\left(\vec{x} \mid \vec{x} \in C_k, \widehat{\mu_k}, \widehat{\Sigma_k}\right) P\left(\vec{x} \in C_k\right)}{P(x)}=\frac{P\left(\vec{x} \mid \vec{x} \in C_k, \widehat{\mu_k}, \widehat{\Sigma_k}\right) P\left(\vec{x} \in C_k\right)}{\sum_{j=1}^K P\left(\vec{x} \mid \vec{x} \in C_j, \widehat{\mu_j}, \widehat{\Sigma_j}\right) P\left(\vec{x} \in C_j\right)}
    \nonumber
\end{equation}
