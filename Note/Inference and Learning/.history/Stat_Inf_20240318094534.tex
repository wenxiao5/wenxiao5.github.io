...
$\frac{\beta_j}{\beta_k}=\frac{(y_1-y_0)_j}{(y_1-y_0)_k},\forall j,k\in \{1,...,d\}$.
\begin{equation}
    \begin{aligned}\frac{\partial \textnormal{Pr(\Gamma=1|X=X)}}{\partial x_i}=F'(X^T\beta_0)\cdot\beta_j
    \end{aligned}
    \nonumber
\end{equation}
