...
Now, we want to find the asymptotic null distribution of $\frac{1}{T^2}\sum_{t=1}^Ty_{t-1}^2$ and $\frac{1}{T}\sum_{t=1}^Ty_{t-1}\epsilon_t$. We can use the following approaches:
\begin{enumerate}
