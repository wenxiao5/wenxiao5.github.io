...
\end{enumerate}
Silhouette coefficients and plots (based off of Euclidean distances) will not be effective at assessing clustering separation and cohesion for all types of datasets. (e.g. the contiguity-based cluster.)
...
\begin{enumerate}
    ...
    \item \textbf{Separation of a prototype-based cluster:} the proximity of the two cluster
\end{enumerate}
