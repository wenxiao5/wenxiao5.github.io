...
\begin{definition}[Sum of Squared Residual]
    ...
    \begin{equation}
        ...
        \nonumber
    \end{equation}
    where the norm is $\|\vec{X}\|=\left[\sum_{i=1}^N X_i^2\right]^{1/2}$. We can infer $\mathbb{E}\left[(Y-\vec{m})'\hat{\vec{m}}\right]=\mathbb{E}\left[(Y-\vec{m})'(\hat{\vec{m}}-\mathbb{E}\hat{\vec{m}})\right]=\textnormal{Cov}(Y,\hat{\vec{m}})$.
\end{definition}
