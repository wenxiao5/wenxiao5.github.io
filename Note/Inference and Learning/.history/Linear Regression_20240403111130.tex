...
A more general form, $H_0:\tau(\beta)=1$ vs. $H_1:\tau(\beta)\neq 1$. By first order continuously differentiable,
\begin{equation}
    \begin{aligned}
        \tau(\hat{\beta})-\tau(1)&=\tau'(1)(\hat{\beta}-1)+\frac{1}{2}\tau''(\bar{\beta})(\hat{\beta}-1)^2\\
        \sqrt{n}\left(\tau(\hat{\beta})-\tau(1)\right)&=\tau'(1)(\hat{\beta}-1)+\frac{1}{2}\tau''(\bar{\beta})(\hat{\beta}-1)^2
    \end{aligned}
    \nonumber
\end{equation}
where $\bar{\beta}\in[1,\hat{\beta}]$
