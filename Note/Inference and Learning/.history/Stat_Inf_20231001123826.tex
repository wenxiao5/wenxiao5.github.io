...
\begin{definition}[Score Function]
    \normalfont
    The \textbf{score function} is $$u(\theta,X_1,...,X_n)=\frac{\partial}{\partial \theta}\log f(\vec{X}\mid\theta)=\frac{1}{f(\vec{X}\mid\theta)}\frac{\partial}{\partial \theta}f(\vec{X}\mid\theta)$$
...
\begin{definition}["Regularity" Condition]
    ...
    \begin{equation}
        \begin{aligned}
            ...
            (*)\quad &=\frac{\partial}{\partial \theta}\underbrace{\int_{-\infty}^\infty f(x|\theta)dx}_{=1}=0
        \end{aligned}
        \nonumber
    \end{equation}
...
\begin{proposition}[Cramer-Rao Inequality]
    Under "regularity" conditions ($\mathbb{E}_\theta\left[\frac{\partial}{\partial \theta}\log f(x|\theta)\right]=0$),
    \begin{equation}
        \begin{aligned}
