...
Suppose we are solving the system of equations $$\left\{\begin{matrix}
    x+y&=2\\
    x-y&=0
\end{matrix}\right.$$ and decide that taking the derivatives of these linear functions is too hard for us. So we're going to pick an initial guess $(x_0,y_0) = (0,0)$ and choose $D_0=I_{2\times 2}$. Our function is $g(x,y)=(x+y-2,x-y)$.
\begin{enumerate}
