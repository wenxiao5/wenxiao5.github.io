...
\begin{equation}
    \begin{aligned}
        ...
        \textnormal{Var}[Y_T(r)]&=\frac{\textnormal{Var}[y_{\left\lfloor Tr\right\rfloor}]}{T}=\frac{\sigma^2\left\lfloor Tr\right\rfloor}{T} \stackrel{T \rightarrow \infty}{\longrightarrow} \sigma^2 r = \textnormal{Var}[Y(r)]
    \end{aligned}
    \nonumber
\end{equation}
