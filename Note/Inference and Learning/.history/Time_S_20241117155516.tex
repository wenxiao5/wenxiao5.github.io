...
\begin{note}
    \begin{enumerate}
        ...
        \item $\sum_{i=0}^\infty i|\psi_i|<\infty \Rightarrow \sum_{i=0}^\infty |\psi_i|<\infty \Rightarrow \sum_{i=0}^\infty \psi_i^2<\infty$ (also a stronger assumption than common assumption)
    \end{enumerate}
\end{note}
