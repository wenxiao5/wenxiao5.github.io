...
\begin{definition}[Controal Variable]
    \normalfont
    W is a \textbf{Controal Variable}.
\end{definition}
A controal variable doesn't have to be an I.V.

Based on the controal variable, we can write the regression as
\begin{equation}
    \begin{aligned}
