...
\begin{equation}
    \begin{aligned}
        I_0=\textnormal{Var}\left(\left[y_i-\frac{exp\{x_i^T\beta\}}{1-exp\{x_i^T\beta\}}\right]x_i\bigg|_{\beta=\beta_0}\right)=\mathbb{E}\left(\left[y_i-\frac{exp\{x_i^T\beta\}}{1-exp\{x_i^T\beta\}}\right]^2x_ix_i^T\right)
    \end{aligned}
    \nonumber
\end{equation}
