...
\begin{example}
    \begin{enumerate}
        ...
        \item (When it doesn't work.) For the linear regression case, $v(P_m)=\left(\frac{1}{m}\sum_{i=1}^mX_iX_i^T\right)^{-1}\left(\frac{1}{m}\sum_{i=1}^mX_iY_i\right)$. If the $\#$ of Covariates $> m$, the estimator is not well-defined.
    \end{enumerate}
\end{example}
