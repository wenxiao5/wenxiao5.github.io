...
Specifically, if $\hat{Q}$ is in the form of $\sum_{i=1}^n \rho(x_i,\theta)$, we call the $\hat{\theta}\in\argmin_{\theta\in\Theta} \hat{Q}(\theta)$ be the \textbf{M-estimator} of $\theta$.
