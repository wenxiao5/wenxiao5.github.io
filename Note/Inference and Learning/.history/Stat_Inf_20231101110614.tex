...
\begin{equation}
    ...
    \nonumber
\end{equation}
As $\mathcal{Z}_k\sim N(\theta_k,\frac{\sigma^2}{N})$, $\mathcal{Z}'\mathcal{Z}=\sum_{k=1}^K \mathcal{Z}_k^2\sim \frac{\sigma^2}{N}V$ such that $V\sim \chi^2_{K+2W}$ where $W\sim \textnormal{Poisson}(\frac{\rho}{2})$. So,
\begin{equation}
    \begin{aligned}
