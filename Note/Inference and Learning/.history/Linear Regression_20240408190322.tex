...
\begin{definition}[Fisher Information]
    ...
    \begin{equation}
        \begin{aligned}
            \mathcal{I}(\theta_0)=\mathbb{E}_{\theta_0}[u(\theta_0,\vec{X})u(\theta_0,\vec{X})^T]=\mathbb{E}_{\theta_0}\left[\left(\frac{\partial}{\partial \theta}\log f_{\vec{X}}(\vec{X}\mid\theta)\right)^2\right]
        \end{aligned}
        \nonumber
    \end{equation}
\end{definition}
