...
For any $\theta_1>\theta_0$, use NP Lemma to find optimal test of $H_0:\mu=0 \textnormal{ vs. }H_1:\mu=\mu_1$.
\begin{enumerate}[$\circ$]
...
\end{enumerate}
\textbf{\underline{Implications}:}
\begin{enumerate}[(i).]
    \item The UMP $5\%$ test of $H_0:\mu=\mu_0 \textnormal{ vs. }H_1:\mu>\mu_0$ rejects $H_0$ iff $\bar{X}>\frac{1.645}{\sqrt{n}}$.
    \item The UMP $5\%$ test of $H_0:\mu=\mu_0 \textnormal{ vs. }H_1:\mu<\mu_0$ rejects $H_0$ iff $-\bar{X}>\frac{1.645}{\sqrt{n}}$.
\end{enumerate}
