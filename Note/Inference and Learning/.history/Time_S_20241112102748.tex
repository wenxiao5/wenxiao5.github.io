...
If rejected, how should we model macroeconomic time series? -- Cointegration (a statistical technique that identifies when multiple time series variables have a common trend or stochastic drift).
