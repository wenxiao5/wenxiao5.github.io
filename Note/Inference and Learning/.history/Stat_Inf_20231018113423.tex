...
\begin{example}[ (Square Loss)]
    Consider a Bernoulli Distribution with parameter $\theta$. We have data $\{Z_1,...,Z_n\}$ and we want to predict the next sample $Z$ (i.e.,$\theta$).\\
    ...
    \begin{equation}
        \begin{aligned}
            R(\hat{\theta}_\textnormal{MLE})=\int_\theta R(\hat{\theta}_\textnormal{MLE},Z\mid \theta) \pi(\theta\mid \{Z_1,...,Z_n\}) d\theta
        \end{aligned}
        \nonumber
    \end{equation}
