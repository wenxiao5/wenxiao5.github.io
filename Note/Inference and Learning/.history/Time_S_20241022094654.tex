...
\begin{enumerate}[$\circ$]
    ...
    \begin{proof}
        ...
        \begin{equation}
            \begin{aligned}
                \frac{1}{T}\sum_{t=2}^T\left[\sigma^2\tilde{Y}_{t-1}^2\right]=\sigma^2\frac{1}{T}\sum_{t=2}^T\tilde{Y}_{t-1}^2 \stackrel{P}{\longrightarrow} \frac{\sigma^4}{1-\phi^2} \stackrel{P}{\longrightarrow} \mathbb{E}\left[\tilde{Y}_{t-1}^2\epsilon_t^2\right]
            \end{aligned}
            \nonumber
        \end{equation}
