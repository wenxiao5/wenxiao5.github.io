...
\begin{equation}
    ...
    \nonumber
\end{equation}
which has mean $\mathbb{E}[g(Z,b)]=-\mathbb{E}[(\tau-\mathbf{1}\{Y-X^Tb\leq 0\})X]=0$. By the Law of Total Variance, the variance of $g(Z,b)$ is
\begin{equation}
    \begin{aligned}
        \Omega=\textnormal{Var}(g(Z,b))=\mathbb{E}[\textnormal{Var}(g(Z,b)|X)]+\textnormal{Var}(\mathbb{E}[g(Z,b)|X])
    \end{aligned}
    \nonumber
\end{equation}
