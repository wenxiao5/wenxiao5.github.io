\documentclass[11pt,result=noanswer]{elegantbook}
\linespread{1.6}
...
\section*{Optimal(Exact) Line Search}
\begin{example}
...
\section*{Armijo's Rule for Steepest Descent}
...
\section{Generalization to Optimization}
