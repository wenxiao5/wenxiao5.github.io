...
Given a sample $\vec{Z}=\left(Z_1,...,Z_N\right)$. Define $N_j=\sum_{i=1}^N \mathbf{1}\{Z_i=z_j\}, j=1,2,...,J$, the number of observations that have value $z_j$. Then, the conditional pmf of $\vec{Z}|\theta$ is $$f(z|\vec{\theta})=\prod_{j=1}^J\theta_j^{N_j}$$
...
\begin{center}\begin{figure}[htbp]
    \centering
    \includegraphics[scale=0.5]{dirichlet_plot.png}
