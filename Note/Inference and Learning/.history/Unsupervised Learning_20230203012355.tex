...
\begin{enumerate}
    \item \textbf{Silhouette Coefficient} $s_i$ of object $\vec{x}_i$ is \underline{large and positive}: the object is closer to objects in the cluster that it is assigned to than objects in other clusters.
\end{enumerate}
