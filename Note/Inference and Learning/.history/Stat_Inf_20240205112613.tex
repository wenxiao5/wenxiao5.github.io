...
The ``relevance'' of the IV doesn't hold ($\mathbb{E}[ZX^T]\neq 0$): $\mathbb{E}[ZX^T]\approx 0$. \underline{Why this is a probelm?}

Let's begin with a simple case that $l=k=1$. The 2SLS estimator is given by
\begin{equation}
    \begin{aligned}
        \hat{\beta}_\textnormal{2SLS}=\frac{\sum_{i=1}^mZ_iY_i}{\sum_{i=1}^mZ_iX_i}
    \end{aligned}
    \nonumber
\end{equation}
