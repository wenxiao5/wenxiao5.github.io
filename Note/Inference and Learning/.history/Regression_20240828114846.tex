...
\begin{equation}
    \begin{aligned}
        Y:&=X Y(1)+(1-X)Y(0)\\
        Y-Y(0)&=\underbrace{(Y(1)-Y(0))}_{\beta}X+Y(0)
    \end{aligned}
    \nonumber
\end{equation}
...
\begin{equation}
    \begin{aligned}
        X:&=ZX(1)+(1-Z)X(0)\\
        &=\underbrace{(X(1)-X(0))}_{\Gamma}Z+X(0)
    \end{aligned}
    \nonumber
\end{equation}
Then, in the \eqref{IV_reduced_form}, we can write
\begin{equation}
    \begin{aligned}
        Y-Y(0) =\underbrace{(Y(1)-Y(0))}_{\beta}(X-X(0))
    \end{aligned}
    \nonumber
\end{equation}
