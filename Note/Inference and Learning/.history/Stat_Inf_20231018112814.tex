...
\begin{example}[ (Square Loss)]
    ...
    \begin{equation}
        \begin{aligned}
            R(\hat{\theta}_\textnormal{MLE},Z\mid \{Z_1,...,Z_n\},\theta)&=\mathbb{E}_\theta[(\bar{Z}-Z)^2]\\
        ...
        \nonumber
    \end{equation}
    Then, the finally averge risk with prior belief $P(\theta)=1_{\{\theta\in[0,1]\}}$ is
    \begin{equation}
        \begin{aligned}
            R(\hat{\theta}_\textnormal{MLE})=\int_\theta R(\hat{\theta}_\textnormal{MLE},Z\mid \theta) P(\theta) d\theta
        \end{aligned}
        \nonumber
    \end{equation}
    The posterior beliefs about the $\theta$ is
    \begin{equation}
        \begin{aligned}
        ...
        \nonumber
    \end{equation}
    As $Z_i\sim \textnormal{Bernoulli}(\theta)$, we have $\theta\mid \{Z_1,...,Z_n\}\sim \textnormal{Beta}\left(\sum_i=1^n Z_i+1, n- \sum_i=1^n Z_i+1\right)$.
\end{example}
