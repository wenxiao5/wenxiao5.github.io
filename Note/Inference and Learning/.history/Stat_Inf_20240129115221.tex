...
\begin{equation}
    \begin{aligned}
        ...
        &=\text{Pr}_{P_m}\left(\max\{\frac{1}{\sqrt{k}}\sum_{i=1}^k(Z_i^*-\bar{Z}_m)+\underbrace{\sqrt{k}\bar{Z}_m}_{\stackrel{P}{\longrightarrow} 0},0\}-\underbrace{\max\{\sqrt{m}\bar{Z}_m,0\}}_{\stackrel{P}{\longrightarrow} 0}\leq t\right)
    \end{aligned}
    \nonumber
\end{equation}
