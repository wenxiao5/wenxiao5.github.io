...
\begin{equation}
    \begin{aligned}
        \prod_{\vec{x}_i:i=1}^m\sum_{C_k:k=1}^K P\left(\vec{x}_i \in C_k\right) P\left(\vec{x}_i \mid \vec{x}_i \in C_k, \theta_k\right)=\prod_{C_k:k=1}^K \prod_{\vec{x}_i\in C_k}
    \end{aligned}
    \nonumber
\end{equation}
