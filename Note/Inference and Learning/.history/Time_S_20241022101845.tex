...
\begin{definition}[Covariance Stationary]
    ...
    \begin{enumerate}
        ...
        \begin{equation}
            \begin{aligned}
                \mathbb{E}[Y_t]=\left(\mathbb{E}[Y_{t,1}],...,\mathbb{E}[Y_{t,n}]\right)'=\mu,\ \forall t \textnormal{ (for some $\mu$)}
            \end{aligned}
            \label{v_s}
            \tag{*}
        \end{equation}
        ...
        \begin{equation}
            \begin{aligned}
                \textnormal{Cov}(Y_t,Y_{t-j})=\mathbb{E}[\underbrace{(Y_t-\mu)(Y_{t-j}-\mu)'}_{n\times n}]=\gamma(j),\ \forall t,j \textnormal{ (for some $\gamma(\cdot)$)}
            \end{aligned}
            \label{v_ss}
            \tag{**}
        \end{equation}
