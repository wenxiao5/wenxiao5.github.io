...
\begin{equation}
    \begin{aligned}
        I_0=\textnormal{Var}_Z\left[\left[\frac{1}{x_i^T\beta_0}-y_i\right]x_i\right]=\mathbb{E}_X \textnormal{Var}_{Y|X}[y_ix_i]+\textnormal{Var}_{X}\mathbb{E}_{Y|X}\left[\left[\frac{1}{x_i^T\beta_0}-y_i\right]x_i\right]=
    \end{aligned}
    \nonumber
\end{equation}
