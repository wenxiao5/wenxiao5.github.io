...
\begin{enumerate}
    ...
    \begin{center}
        \begin{tabular}{ccc}
            ...
            \hline
                $H_0$& &Type II Error (failure to reject a null hypothesis that is actually false)\\
                $H_1$& Type I Error (mistaken rejection of a null hypothesis that is actually true) &\\
            \hline
        \end{tabular}
    \end{center}
