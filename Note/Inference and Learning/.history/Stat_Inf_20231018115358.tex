...
Consider a Gamma random variable $w_i\sim \textnormal{Gamma}(1,1)$. Given $N$ random sample $\{Z_1,...,Z_N\}$ from a Bernoulli distribution with parameter $\theta$ and the sum $\sum_{i=1}^N Z_i=S$. Then, we have
\begin{equation}
    \begin{aligned}
        \sum_{i=1}^N w_i \mathbb{1}_{\{Z_i=1\}}
    \end{aligned}
    \nonumber
\end{equation}
