...
\end{lemma}
\begin{proof}
    Recall that $\mathbb{E}(Y_t)=\mu, \forall t$ because $\epsilon_t\sim \textnormal{WN}(0,\sigma^2)$ and $\sum_{i=0}^\infty \psi_i^2<\infty$. Then, $\mathbb{E}[\bar{Y}]=\mathbb{E}[\frac{1}{n}\sum_{i=1}^n Y_i]=\mu$.
\end{proof}
\begin{enumerate}
