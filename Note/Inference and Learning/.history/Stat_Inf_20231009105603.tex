...
\begin{enumerate}[$\bullet$]
    ...
    \begin{equation}
        \begin{aligned}
            T_{LM}\left(X_1,...,X_n\right)&=\frac{\left(\frac{\partial}{\partial \theta}l(\theta_0\mid X_1,...,X_n)\right)^2}{-\frac{\partial^2}{\partial \theta^2}l(\theta_0\mid X_1,...,X_n)}
        \end{aligned}
        \nonumber
    \end{equation}
    ...
    \begin{equation}
        \begin{aligned}
            T_W\left(X_1,...,X_n\right)=\frac{(\hat{\theta}_{ML}-\theta_0)^2}{\left\{-\frac{\partial^2}{\partial \theta^2}l(\theta_0\mid X_1,...,X_n)\right\}^{-1}}
        \end{aligned}
        \nonumber
    \end{equation}
...
\end{enumerate}
\begin{claim}
    In general, for "large" $n$, $T_{LR}\approx T_{LM}\approx T_W$.
\end{claim}
