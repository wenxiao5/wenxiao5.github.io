...
\begin{enumerate}[$\bullet$]
    ...
    \item Step 2: Keeping the new order (giving the objects new indices), create a pairwise-distance matrix $\left[\right.$ dist $\left._{i j}\right]$ between all objects and visualize it. (not with the cluster labels)
