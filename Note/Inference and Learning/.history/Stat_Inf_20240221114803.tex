...
\begin{enumerate}
    ...
    \begin{equation}
        \begin{aligned}
            \mathbb{E}[\vec{X}^T \vec{e}]=\underbrace{\mathbb{E}[\vec{X}^T \mathbf{1}\alpha]}_{\textcolor{red}{need assumed to be 0}}+\underbrace{\mathbb{E}[\vec{X}^T \vec{\epsilon}]}_{:=0 \textnormal{, by assumption}}
        \end{aligned}
        \nonumber
    \end{equation}
\end{enumerate}
...
Use the notations of vectors $\vec{\dot{Y}}_{i}:=\begin{bmatrix}
    ...
    \vdots\\
    \dot{Y}_{i_T}
\end{bmatrix}$, $\vec{\dot{X}}_{i}:=\begin{bmatrix}
    \dot{X}_{i_1}\\
    \vdots\\
    \dot{X}_{i_T}
\end{bmatrix}$. Then, the equation can be written as
\begin{equation}
    \begin{aligned}
        \vec{\dot{Y}}_i=\vec{\dot{X}}_i\beta_0+\vec{\dot{\epsilon}}_i
    \end{aligned}
    \nonumber
\end{equation}
