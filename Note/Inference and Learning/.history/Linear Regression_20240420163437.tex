...
\begin{equation}
    \begin{aligned}
        \frac{\partial^2 L_N(\hat{\beta})}{\partial \beta\partial \beta^T}=-\frac{1}{N}\sum_{i=1}^N \left(\frac{1}{x_i^T\hat{\beta}}\right)^2 x_ix_i^T
    \end{aligned}
    \nonumber
\end{equation}
The second information equality holds in MLE, $I_0=-\mathbb{E}\left[\frac{1}{N}\sum_{i=1}^N \left(\frac{1}{x_i^T\hat{\beta}}\right)^2 x_ix_i^T\right]$
