...
\begin{lemma}[Second Information Equality]
    The Fisher information is equal to the minus Hessian matrix,
    \begin{equation}
        \begin{aligned}
            \mathcal{I}(\theta_0)
...
\begin{proof}
    \begin{equation}
        \begin{aligned}
            \frac{\partial^2}{\partial \theta^2}\log f_{\vec{X}}(\vec{X}\mid\theta)=\frac{\frac{\partial^2}{\partial \theta^2} f_{\vec{X}}(\vec{X}\mid\theta)}{f_{\vec{X}}(\vec{X}\mid\theta)}-\left(\frac{\frac{\partial}{\partial \theta} f_{\vec{X}}(\vec{X}\mid\theta)}{f_{\vec{X}}(\vec{X}\mid\theta)}\right)^2=\frac{\frac{\partial^2}{\partial \theta^2} f_{\vec{X}}(\vec{X}\mid\theta)}{f_{\vec{X}}(\vec{X}\mid\theta)}-\left(\frac{\partial}{\partial \theta}\log f_{\vec{X}}(\vec{X}\mid\theta)\right)^2
        \end{aligned}
        \nonumber
    \end{equation}
\end{proof}
