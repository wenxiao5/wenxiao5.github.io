...
In \textbf{Ward's linkage algorithms}, the \textbf{proximity between two clusters} is defined as the change in  \underline{some objective function} we get when merging the two clusters.\\
(Most common objective function value to use for Ward's linkage is \textbf{inertia}.)
