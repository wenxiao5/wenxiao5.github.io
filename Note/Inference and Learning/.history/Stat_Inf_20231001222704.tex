...
\begin{theorem}
    Let $f(X)$ be the pmf or pdf of a sample X. Suppose there exists a function T(x) such that, for eve'i!J two sample points x and y, the ratio f(xl0)/ f(yJ0) is constant as a function of 0 if and only if T(x) = T(y). Then T(X) is a minimal sufficient statistic for 0.
\end{theorem}
