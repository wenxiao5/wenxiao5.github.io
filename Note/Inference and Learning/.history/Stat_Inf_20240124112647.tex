...
``Ideal'' Confidence Interval: Suppose you know $v(P_0)$, the ideal interval is $$CI^0_\alpha:=\left[\theta(P_m)-q_{\frac{1-\alpha}{2}}(v(P_0)),\theta(P_m)+q_{\frac{1-\alpha}{2}}(v(P_0))\right]$$
The confidence interval of Bootstrap is given by
\begin{equation}
    \begin{aligned}
        CI^\text{Bootstrap}_\alpha:=\left[\theta(P_m)-q_{\frac{1-\alpha}{2}}(v(P_m)),\theta(P_m)+q_{\frac{1-\alpha}{2}}(v(P_m))\right]
    \end{aligned}
    \nonumber
\end{equation}
