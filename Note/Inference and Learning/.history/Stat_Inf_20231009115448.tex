...
\begin{enumerate}[(I).]
    ...
    \item Recall: The "optimal" two-sided $5\%$ of the $\mu=\mu_0$ rejects \underline{if and only if} $|\bar{X}-\mu_0|>\frac{1.96}{\sqrt{n}}$ $\Leftrightarrow$ $\bar{X}-\mu_0>\frac{1.96}{\sqrt{n}}$ or $\bar{X}-\mu_0<-\frac{1.96}{\sqrt{n}}$.
\end{enumerate}
