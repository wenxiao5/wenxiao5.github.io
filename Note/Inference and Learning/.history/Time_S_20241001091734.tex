...
\begin{equation}
    ...
    \nonumber
\end{equation}
where $\epsilon_t\sim \mathcal{N}(0,\sigma^2)$ and $Y_1\perp \epsilon_2,\epsilon_3,...$.
...
\end{definition}
By the definition that $Y_t=\phi Y_{t-1}+\epsilon_t,\ \forall t\geq 2$, where $\epsilon_t\mid Y_{1},...,Y_{t-1}\sim \mathcal{N}(0,\sigma^2)$.
