...
\begin{definition}[Gower’s Distance]
    \normalfont
    To measure the distance between objects $x_i=\left(x_{i 1}, x_{i 2}, \ldots, x_{i n}\right)$ and $\boldsymbol{x}_{i^{\prime}}=\left(x_{i^{\prime} 1^{\prime}}, x_{i^{\prime} 2}, \ldots, x_{i^{\prime} n}\right)$ where at least one of the attributes is numerical and at least one is categorical, we can use Gower's distance.
    $$
