...
\begin{example}
    ...
    \begin{equation}
        \begin{aligned}
            \frac{L(\mu_1\mid X_1,...,X_n)}{L(\mu=0\mid X_1,...,X_n)}=e^{\mu\sum_{i=1}^n X_i}e^{-\frac{n\mu^2}{2}}
        \end{aligned}
        \nonumber
    \end{equation}
    \underline{Decision Rule:}
    Reject $H_0$ iff $\frac{L(\mu_1\mid X_1,...,X_n)}{L(\mu=0\mid X_1,...,X_n)}=e^{\mu\sum_{i=1}^n X_i}e^{-\frac{n\mu^2}{2}}\geq k$
\end{example}
