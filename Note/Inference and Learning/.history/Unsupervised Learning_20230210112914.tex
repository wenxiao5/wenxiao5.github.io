...
\begin{enumerate}
    ...
    \begin{equation}
        ...
        & \bullet p_{j \mid i}=\frac{\exp \left(-\frac{\left\|x_{i *}-x_j\right\| \|^2}{2 \sigma_i^2}\right)}{\sum_{k \neq i} \exp \left(-\frac{\left\|x_{i_i-x_k}\right\|^2 \|^2}{2 \sigma_i^2}\right)} \\
        & \bullet p_{i \mid j}=\frac{\exp \left(-\frac{\left\|x_{i k}-x_j\right\|^2}{2 \sigma_j^2}\right)}{\sum_{k \neq j} \exp \left(-\frac{\left\|x_{j *}-x_k\right\| \|^2}{2 \sigma_j^2}\right)}
        \end{aligned}
        \end{equation}
\end{enumerate}
