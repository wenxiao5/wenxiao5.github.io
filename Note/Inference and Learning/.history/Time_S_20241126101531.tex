...
\paragraph*{Unit Root Asymptotics:} If $\rho=1$, then $Y_T(r)=\frac{y_{\left\lfloor Tr\right\rfloor}}{\sqrt{T}}=\frac{1}{\sqrt{T}}\sum_{s=1}^{\left\lfloor Tr\right\rfloor}\epsilon_s \stackrel{d}{\longrightarrow} \sigma W(r)$.
