...
\begin{definition}[Sum of Squared Residual]
    ...
    \begin{equation}
        \begin{aligned}
            \mathbb{E}\left[\|\vec{Y}-\hat{\boldsymbol{m}}\|^2\right]&=\mathbb{E}\left[\|Y-m\|^2\right]+\mathbb{E}\left[\|\hat{\boldsymbol{m}}-\boldsymbol{m}\|^2\right]-2 \mathbb{E}\left[(\vec{Y}-\boldsymbol{m})'(\hat{\boldsymbol{m}}-\boldsymbol{m})\right]\\
...
\begin{equation}
    \begin{aligned}
        \hat{R}_\textnormal{SURE}\left(\mathcal{Z},\vec{c}\right)=\sum_{k=1}^K c_k^2+\sum_{k=1}^K\left(\mathcal{Z}_k^2-\frac{\sigma^2}{N}\right)(1-c_k)^2
    \end{aligned}
    \nonumber
\end{equation}
...
\begin{equation}
    ...
    \nonumber
\end{equation}
We have $\mathbb{E}[u]=0$ and $\mathbb{E}[uR]=0=\textnormal{Cov}(u,R)$. If $u>0$, it is underpredicting and if $u<0$, it is overpredicting.
\begin{equation}
    \begin{aligned}
...
\begin{equation}
    \begin{aligned}
        ...
        &=\underbrace{\mathbb{E}[(Y-\mathbb{E}^*[Y|W])W]}_{=0 \textnormal{ by F.O.C.}}-\mathbb{E}[(\mathbb{E}^*[Y|X]]\mathbb{E}[W]-\mathbb{E}[Y]\mathbb{E}[W]
    \end{aligned}
    \nonumber
\end{equation}
