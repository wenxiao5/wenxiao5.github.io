...
\begin{example}[ (Bootstrap Fail Example)]
    Suppose $Y\sim \textnormal{i.i.d. }[0,\theta]$ and consider the estimator $\hat{\theta}_n(\vec{Y})=\max_i Y_i\triangleq Y_{(n)}$. Then, $$G_n(t) \rightarrow 1-e^{-\frac{t}{\theta_F}}\textnormal{ as }n \rightarrow \infty$$
\end{example}
