...
\begin{equation}
    \begin{aligned}
        -2n\left(\hat{Q}(\theta_0)-\hat{Q}(\hat{\theta}_\textnormal{MLE})\right)=n\left(\theta_0-\hat{\theta}_\textnormal{MLE}\right)^T \underbrace{\left(-\frac{\partial^2}{\partial \theta^2}\hat{Q}(\theta)\big|_{\theta=\bar{\theta}}\right)}_{\triangleq \hat{\mathcal{I}}}\left(\theta_0-\hat{\theta}_\textnormal{MLE}\right)\sim \chi^2(d)
    \end{aligned}
    \nonumber
\end{equation}
