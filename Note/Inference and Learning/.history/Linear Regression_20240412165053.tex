...
\begin{enumerate}
    \item \underline{Will your estimator be consistent?}
    \item \underline{Will your estimator be asymptotically normal?}
    \item \underline{The information matrix equality \textbf{does not hold} if the likelihood is not correct.}
    \item \underline{An estimator of the asymptotic variance of the quasi-maximum likelihood estimator of a Poisson regression model that is consistent even if the Poisson assumption is incorrect:}
\end{enumerate}
