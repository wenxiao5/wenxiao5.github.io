...
\begin{enumerate}[1.]
    ...
    \item \textbf{Repeat:}
    \subitem[a.] \textbf{Remove a cluster} from the list of clusters\\
    Common ways to choose which cluster to split:
    \subitem 1. Choose the cluster with the most amount of points in it. (Benefit: you'll end up with more balanced clusters)
    \subitem 2. Choose the clusters with the highest inertia. (Benefit: you'll end up with a clustering with lower inertia)
