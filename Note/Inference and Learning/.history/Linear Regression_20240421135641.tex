...
\begin{center}
    \fcolorbox{black}{gray!10}{\parbox{.9\linewidth}{\paragraph*{C.} Suppose that the first component of $x_i$ is one and you want to test the null hypothesis that the intercept of $\beta_0$ is one and the slope coefficient are all zero, i.e.,
        \begin{equation}
            \begin{aligned}
                H_0:\beta_0=(1,0,...,0)^T
            \end{aligned}
