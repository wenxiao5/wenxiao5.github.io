...
\begin{equation}
    \begin{aligned}
        \pi(\vec{\theta}\mid \{Z_1,...,Z_n\})&=\frac{f(\{Z_1,...,Z_n\}\mid \vec{\theta})P(\vec{\theta})}{\int f(\{Z_1,...,Z_n\}\mid \vec{\theta}')P(\vec{\theta}')d\vec{\theta}'}=\frac{\Gamma(\sum_{j=1}^J (N_j+\alpha_j))}{\sum_{j=1}^N\Gamma(N_j+\alpha_j)}\prod_{j=1}^J\theta_j^{\alpha_j-1}
    \end{aligned}
    \nonumber
\end{equation}
