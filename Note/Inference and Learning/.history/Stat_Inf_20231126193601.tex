...
\end{equation}
\begin{enumerate}
    \item Long Regression: $$\mathbb{E}^*[Y|S,A]=\alpha_0+\beta_0s+A$$
    \item Short Regression: $$\mathbb{E}^*[Y|s]=\alpha_0+b_0s$$
    \item Auxillary Regression: $$\mathbb{E}^*[A|s]=\mathbb{E}[A]-\eta_0\mathbb{E}[s]+\eta_0 s$$
    where $\eta_0=\frac{\text{Cov}(A,s)}{Var(s)}$ and $s=\frac{\beta_0-C}{k_0}$
    \begin{equation}
        \begin{aligned}
            \text{Cov}(A,s)=\text{Cov}(A,\frac{\beta_0-C}{k_0})=-\frac{\text{Cov}(A,C)}{k_0}=-\frac{\sigma_{AC}}{k_0}
        \end{aligned}
        \nonumber
    \end{equation}
\end{enumerate}
