...
Consider a estimator $\mathcal{Z}\sim N(\theta,\sigma^2 I_K)$, $\hat{\theta}=\hat{\theta}(\mathcal{Z})$. Let $g(\hat{\theta}_{MLE})=\hat{\theta}-\mathcal{Z}$.
\begin{equation}
    \begin{aligned}
...
\begin{equation}
    \begin{aligned}
        \mathbb{E}[\hat{R}_{SURE}]=\mathbb{E}[\|\hat{\theta}-\theta\|^2]
    \end{aligned}
    \nonumber
\end{equation}
