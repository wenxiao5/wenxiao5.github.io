...
\begin{lemma}
    ...
    \begin{equation}
        \begin{aligned}
            \mathbb{E}_\theta\left[u(\theta_0,\vec{X})\right]&=\int_{\vec{X}} \left[\frac{\partial}{\partial \theta}\log f_{\vec{X}}(\vec{X}\mid\theta_0)\right]f_{\vec{X}}(\vec{X}\mid\theta_0) d\vec{X}\\
...
\begin{definition}[Fisher Information]
    ...
    \begin{equation}
        \begin{aligned}
            \mathcal{I}(\theta)=\mathbb{E}_\theta[u(\theta,\vec{X})u(\theta,\vec{X})^T]
        \end{aligned}
        \nonumber
    \end{equation}
\end{definition}
