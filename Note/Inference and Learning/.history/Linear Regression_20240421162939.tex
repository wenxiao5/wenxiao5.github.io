...
\end{center}
Given $y_i=c$, $P(x_i,y_i=c;\beta,\sigma^2)=\textnormal{Pr}(\epsilon_i\in\left(-x_i^T\beta,c-x_i^T\beta\right])=\Phi\left(\frac{c-x_i^T\beta}{\sigma}\right)-\Phi\left(\frac{-x_i^T\beta}{\sigma}\right)$.\\
Given $y_i=-c$, $P(x_i,y_i=-c;\beta,\sigma^2)=\textnormal{Pr}(\epsilon_i\in\left[-c-x_i^T\beta,-x_i^T\beta\right])=\Phi\left(\frac{-x_i^T\beta}{\sigma}\right)-\Phi\left(\frac{-c-x_i^T\beta}{\sigma}\right)$.\\
