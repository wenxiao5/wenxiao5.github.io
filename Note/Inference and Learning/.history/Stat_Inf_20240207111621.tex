...
\begin{proof}
    \begin{equation}
        \begin{aligned}
            ...
            \hat{\beta}_\textnormal{GMM}=\left(\hat{Q}^TW\hat{Q}\right)^{-1}\hat{Q}^TW\frac{1}{m}\left(\underbrace{(\sum_{i=1}^mZ_iX_i^T)}_{\hat{Q}}\beta_0+\frac{1}{m}\sum_{i=1}^mZ_ie_i\right)
        \end{aligned}
        \nonumber
    \end{equation}
\end{proof}
