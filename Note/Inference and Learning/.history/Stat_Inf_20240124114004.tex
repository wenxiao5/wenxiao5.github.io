...
\begin{proof}
    ...
    \begin{equation}
        \begin{aligned}
            ...
            \text{by \eqref{consistency} and continunity of the c.d.f. $v(P_0)$ (assumed) }&=v(P_0)\left(q_{1-\frac{\alpha}{2}}(v(P_0))\right)-v(P_0)\left(q_{\frac{\alpha}{2}}(v(P_0))\right)+0_{P_0}(1)\\
            &=1-\alpha+0_{P_0}(1)
        \end{aligned}
        \nonumber
    \end{equation}
