...
$$
\begin{gathered}
P(x \mid \Theta)=\sum_{k=1}^K P\left(x \in C_k \text { and } x \mid \theta_k\right)=\sum_{k=1}^K P\left(\boldsymbol{x} \in C_k\right) P\left(x \mid x \in C_k, \theta_k\right) \text {, where } \\
