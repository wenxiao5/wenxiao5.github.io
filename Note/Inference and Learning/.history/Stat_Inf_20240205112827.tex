...
\begin{equation}
    \begin{aligned}
        \hat{\beta}_\textnormal{2SLS}=\frac{\sum_{i=1}^mZ_iY_i}{\sum_{i=1}^mZ_iX_i}=\beta+\frac{\sum_{i=1}^mZ_iv_i}{\sum_{i=1}^mZ_iX_i}
    \end{aligned}
    \nonumber
\end{equation}
where the small $Z_iX_i$ leads to large biases.
