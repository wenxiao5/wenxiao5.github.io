...
\begin{enumerate}[$\bullet$]
    ...
    \begin{center}\begin{figure}[htbp]
        ...
        \label{}
    \end{figure}\end{center}
    \item \textbf{\underline{Additional Tips and Information:}} $p=10\%\times \textnormal{(the number of observations in the dataset)}$; Hopkins Statistic is \underline{non-deterministic}.
\end{enumerate}
