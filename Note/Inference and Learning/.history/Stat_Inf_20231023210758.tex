...
\begin{definition}[Dirichlet Distribution]
    \normalfont
    A \textbf{Dirichlet distribution} with parameters $J\geq 2$ and $\vec{\alpha}=(\alpha_1,...,\alpha_J)$.
...
Now let's using Dirichlet distribution to estimate $\mathbb{E}[\vec{\theta}|\{Z_1,...,Z_n\}]$.
