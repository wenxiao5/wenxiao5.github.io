...
Under $H_0:\beta^T\beta_0-1=0$. Define $g(\beta_0)=\beta^T\beta_0-1$, which corresponding $\hat{\mathcal{I}}=\textnormal{Var}(g(\hat{\beta}))=\mathbb{E}\left[g(\hat{\beta})g(\hat{\beta})\right]$ $W=N[g(\hat{\beta})]^T\hat{I}[\hat{\beta}-\beta_0]$
