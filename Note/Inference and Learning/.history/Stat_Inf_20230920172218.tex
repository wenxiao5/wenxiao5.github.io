...
\begin{definition}[Sufficient Statistic]
    \normalfont
    A statistic $T=T(X_1,...,X_n)$ is \textbf{sufficient} iff the conditional distribution of $(X_1,...,X_n)$ given $T$ doesn't depend on $\theta$.
\end{definition}
...
\begin{minipage}{0.7\textwidth}
    When we want to do integrals in high dimensions, it becomes exceedingly difficult.
    
    For $d$-dimensional integrals, the trapezoidal rule yields an approximation error $|\hat{I}_n - I| \leq \frac{C}{n^\frac{2}{d}}$ for some constant $C$. This means that $n \sim O\left(\varepsilon^{-\frac{d}{2}}\right)$. To achieve a target approximation error $\varepsilon$, the value of $n$ needs to increase exponentially with the dimension $d$. This phenomenon is commonly referred to as \underline{the curse of dimensionality}.
\end{minipage}%
\hfill
\begin{minipage}{0.3\textwidth}
    \begin{figure}[htbp]
        \centering
        \includegraphics[scale=0.3]{two-dim int.png}
        \caption{Two-dimensional integration using a regular grid.}
        \label{}
    \end{figure}
\end{minipage}
