...
\begin{enumerate}
    ...
    \item \textbf{Average silhouette scores} of the two clusterings: We can use this metric to compare the cohesion and separation of clusterings (and they \tetxbf{could} be two clusterings of \textbf{different dataset}),
\end{enumerate}
