...
\begin{example}
    ...
    \end{enumerate}
    \item (When it doesn't work.) $v(P_m)=\argmin_b\frac{1}{m}\sum_{i=1}^m\left(Y_i-b^TX_i\right)^2=\left(\frac{1}{m}\sum_{i=1}^mX_iX_i^T\right)^{-1}\left(\frac{1}{m}\sum_{i=1}^mX_iY_i\right)$
\end{example}
