...
\begin{enumerate}[$\bullet$]
    ...
    \begin{enumerate}[(1).]
        \item \textbf{Creates an Actual Similarity Matrix $P$ for the Points in the Original Dataset.} Similarity between a given point and another point is a function that uses: 1. the normal distribution; 2. the supplied distance metric $w_{ij}$ distance between the two original dataset points.
        \item 
    \end{enumerate}
\end{enumerate}
