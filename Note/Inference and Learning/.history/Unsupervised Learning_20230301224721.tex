...
\begin{enumerate}[$\bullet$]
    ...
    \begin{enumerate}[(1).]
        ...
        \item \textbf{Creates a Similarity Matrix Function of Variables $Q$ for the Points in the \textit{Projected Dataset}.} Similarity between a given point and another point is a function of:
    \end{enumerate}
\end{enumerate}
