...
\begin{equation}
    \begin{aligned}
        \hat{G}^{-1}\hat{\Omega}\hat{G}^{-1}=\frac{\frac{1}{N}\sum_{i=1}^n (\ln x_i)^2 (x_i)^{2\hat{\beta}}\left(y_i-x_i^{\hat{\beta}}\right)^2}{\left(\frac{1}{N}\sum_{i=1}^N(\ln x_i)^2(x_i)^{2\hat{\beta}}\right)}
    \end{aligned}
    \nonumber
\end{equation}
