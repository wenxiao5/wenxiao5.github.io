...
\begin{enumerate}[(1)]
    ...
    \begin{enumerate}[$\bullet$]
        \item If Criterion 4 \underline{is not} satisfied, make $t_k$ smaller and begin step (2) again.
        \item If Criterion 4 \underline{is} satisfied, check if Criterion 3 is also satisfied, i.e., if $$\phi'_k(t_k)\geq \beta\phi'_k(0)$$
    \end{enumerate}
    \item 
\end{enumerate}
