...
\begin{definition}["Regularity" Condition]
    ...
    \begin{equation}
        \begin{aligned}
            \mathbb{E}_\theta\left[\frac{\partial}{\partial \theta}\log f(\vec{X}\mid\theta)\right]&=\int_{-\infty}^\infty \left[\frac{\partial}{\partial \theta}\log f(\vec{X}\mid\theta)\right]f(\vec{X}\mid\theta) dx\\
            &=\int_{-\infty}^\infty \left[\frac{\partial}{\partial \theta}f(\vec{X}\mid\theta)\right]\vec{X}\\
