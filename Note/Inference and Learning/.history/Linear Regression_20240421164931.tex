    ...
    \begin{aligned}
        L_N(\beta,\sigma^2)=
            \frac{1}{N}\sum_{i=1}^N\left\{
                \mathbf{1}\{y_i=c\}\log\left(\Phi\left(\frac{c-x_i^T\beta}{\sigma}\right)-\Phi\left(\frac{-x_i^T\beta}{\sigma}\right)\right)\\+\mathbf{1}\{y_i=-c\}\log\left(\Phi\left(\frac{-x_i^T\beta}{\sigma}\right)-\Phi\left(\frac{-c-x_i^T\beta}{\sigma}\right)\right)+\mathbf{1}\{|y_i|>c\}\log\left(\frac{1}{\sigma}\phi\left(\frac{y_i-x_i^T\beta}{\sigma}\right)\right)
            \right\}
    \end{aligned}
    \nonumber
\end{equation}
