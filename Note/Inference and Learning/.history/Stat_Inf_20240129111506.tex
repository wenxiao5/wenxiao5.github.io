...
\begin{enumerate}
    ...
    \begin{example}
        ...
        \begin{equation}
            \begin{aligned}
                v(P)(t):&=\text{Pr}_{P}\left(\sqrt{m}\left(\max\{\bar{Z}_m,0\}-\mathbb{E}_{P_0}[Z]\right)\leq t\right)\\
                &=\text{Pr}_{P}\left(\max\{\sqrt{m}(\bar{Z}-\mathbb{E}_{P_0}[Z]),-\sqrt{m}\mathbb{E}_{P_0}[Z]\}\leq t\right)\\
                &=\text{Pr}_{P}\left(\max\{\mathcal{Z},-\sqrt{m}\mathbb{E}_{P_0}[Z]\}\leq t\right)\\
            \end{aligned}
            \nonumber
        \end{equation}
        where $\mathcal{Z}\sim \mathcal{N}(0,1)$.
        \begin{enumerate}
            \item If $\mathbb{E}_{P_0}[Z]=0$, $v(P)(t)=\text{Pr}_{P}\left(\max\{\mathcal{Z},0\}\leq t\right)$
            \item If $\mathbb{E}_{P_0}[Z]>0$, $v(P)(t)\stackrel{m \rightarrow \infty}{\longrightarrow}\text{Pr}_{P}\left(\mathcal{Z}\leq t\right)$
        \end{enumerate}
        Consider $P=\mathcal{N}\left(\frac{c}{\sqrt{m}},1\right)$, where $c>0$. We have $\mathcal{N}\left(\frac{c}{\sqrt{m}},1\right) \rightarrow \mathcal{N}\left(0,1\right)$. However, $v(P)(t)=\text{Pr}_{P}\left(\max\{\mathcal{Z},-c\}\leq t\right)$
    \end{example}
\end{enumerate}
