...
\begin{assumption}
    We assume
    \begin{enumerate}
        \item $\mathbb{E}^*[Y|S,A,W]=\mathbb{E}^*[Y|S,A]$ ($W$ doesn't give extra information).
        \item $\mathbb{E}^*[A|S,W]=\mathbb{E}^*[A|W]=\Pi_0+W'\Pi_W$ (Auxillary Regression).
        \item $C\perp A | W=w$ (Conditional independence).
    \end{enumerate}
\end{assumption}
...
\begin{equation}
    \begin{aligned}
        \mathbb{E}^*[Y|S,A,W]&=\mathbb{E}^*[Y|S,A]\\
