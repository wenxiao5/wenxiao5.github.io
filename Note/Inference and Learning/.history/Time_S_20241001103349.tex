...
\begin{remark}
    ...
    \begin{equation}
        \begin{aligned}
            \hat{V}=\frac{1}{n}\sum_{i=1}^n x_ix'_i \hat{\epsilon}_i^2 \stackrel{P}{\longrightarrow} \mathbb{E}[x_ix'_i \hat{\epsilon}_i^2]=V,\ \hat{\epsilon}_i=y_i-\hat{\beta}'_{OLS}x_i
        \end{aligned}
        \nonumber
    \end{equation}
\end{remark}
