...
\begin{example}
    ...
    \begin{enumerate}
        ...
        \item If $\epsilon_t\sim i.i.d.(0,\sigma^2)$, then $F(\frac{1}{\sqrt{T}}\sum_{t=1}^{\left\lfloor T\cdot\right\rfloor}\epsilon_t)\stackrel{d}{\longrightarrow} F(\sigma W(\cdot))=\sigma W(1)$
    \end{enumerate}
\end{example}
