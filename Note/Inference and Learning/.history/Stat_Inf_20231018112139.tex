...
\begin{example}[ (Square Loss)]
    ...
    \begin{equation}
        ...
        \nonumber
    \end{equation}
    Then, the optimal estimation is $t^*=\theta$. And we say the minimial risk is \textbf{oracle risk} $$R(t^*,Z;\theta)=\theta(1-\theta)$$\\
    ...
    \begin{equation}
        \begin{aligned}
            R(\hat{\theta}_\textnormal{MLE},Z;\theta)&=\mathbb{E}_\theta[(\bar{Z}-Z)^2]\\
    ...
    \begin{equation}
        \begin{aligned}
            R(\hat{\theta}_\textnormal{MLE})=\int_\theta R(\hat{\theta}_\textnormal{MLE},Z;\theta) P(\theta) d\theta
        \end{aligned}
        \nonumber
    \end{equation}
\end{example}
