...
\begin{proof}
    ...
    \begin{equation}
        \begin{aligned}
            \mathbb{E}_\theta\left[\frac{\frac{\partial^2}{\partial \theta^2} f_{\vec{X}}(\vec{X}\mid\theta)}{f_{\vec{X}}(\vec{X}\mid\theta)}\mid\theta\right]=\frac{\partial^2}{\partial \theta^2} f_{\vec{X}}(\vec{X}\mid\theta)
        \end{aligned}
        \nonumber
    \end{equation}
\end{proof}
