...
\end{note}
\begin{note}
    $\mathbb{E}[Y_{t,i}^2]<\infty \Leftrightarrow \sum_{i=1}^n \mathbb{E}[Y_{t,i}^2]<\infty \Leftrightarrow \mathbb{E}[\sum_{i=1}^n Y_{t,i}^2]<\infty\Leftrightarrow \mathbb{E}\left[\|Y_t\|^2\right]<\infty,\forall t$, where $\|Y_t\|^2=Y'_tY_t$ is the Euclidean norm.
\end{note}
