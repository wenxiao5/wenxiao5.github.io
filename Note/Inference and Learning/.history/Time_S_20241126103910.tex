...
\begin{enumerate}
    \item $\hat{\sigma}^2=\frac{1}{T}\sum_{t=1}^T(y_t-\hat{\rho}y_{t-1})^2 \approx \frac{1}{T}\sum_{t=1}^T(y_t-\rho y_{t-1})^2+o_P(1)=\frac{1}{T}\sum_{t=1}^T\epsilon_t^2 \stackrel{P}{\longrightarrow} \mathbb{E}[\epsilon_t^2]=\sigma^2$
\end{enumerate}
