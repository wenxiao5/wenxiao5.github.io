...
\begin{definition}
    ...
    \begin{equation}
        ...
        \nonumber
    \end{equation}
    then $F(\cdot)$ is called the \underline{spectral distribution function} (of $\gamma(\cdot)$) and $f(\cdot)$ is called a \underline{spectral density function} (of $\gamma(\cdot)$) and
    \begin{equation}
        \begin{aligned}
