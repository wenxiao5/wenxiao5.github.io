...
\begin{enumerate}[(a).]
    ...
    \item Even if $y$ doesn't have PDF $f(y;\theta_0)$ ($f(y;\theta')$ instead), we can still give this result. In this case, the information inequality $\mathbb{E}_{\theta'}[\ln (y;\theta_0)]>\mathbb{E}_{\theta'}[\ln (y;\theta)]$
    \item 
\end{enumerate}
