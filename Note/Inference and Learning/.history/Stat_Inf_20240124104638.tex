...
\begin{equation}
    ...
    \nonumber
\end{equation}
Here, the data $\{Z_i\}_i$ is generated from $P_0$, which forms $P_m$. (Sometimes, we may study $v(P_0)(t)=\text{Pr}_{P_0}\left(\underbrace{\frac{C(P_m,P_0)}{\text{Var}_{P_0}(\theta(P_m))}}_{T(P_m,P_0)}\leq t\right),\forall t$)
