...
\begin{equation}
    ...
    \nonumber
\end{equation}
Since $-\mathbf{1}\{Y-X^Tb\leq 0\}\mid X\sim \textnormal{Bernoulli}(\tau)$,
\begin{equation}
    \begin{aligned}
        \textnormal{Var}_{Y|X}[g(Z,\beta_0(\tau))\mid X]=\textnormal{Var}_{Y|X}[-(\tau-\mathbf{1}\{Y-X^T\beta_0(\tau)\leq 0\})X]
    \end{aligned}
    \nonumber
\end{equation}
By the Law of Total Variance, the variance of $g(Z,b)$ is
\begin{equation}
    \begin{aligned}
        \Omega:&=\textnormal{Var}(g(Z,b))\\
        &=\mathbb{E}[\textnormal{Var}(g(Z,b)|X)]+\textnormal{Var}(\mathbb{E}[g(Z,b)|X])\\
        &=\mathbb{E}[(\tau-\mathbf{1}\{Y-X^Tb\leq 0\})^2XX^T]+0\\
        &=
    \end{aligned}
    \nonumber
\end{equation}
...
\begin{equation}
    \begin{aligned}
        G(Z,b)=\frac{\partial g(Z,b)}{\partial b^T}
    \end{aligned}
    \nonumber
\end{equation}
