...
\begin{equation}
    \begin{aligned}
        I_0=\textnormal{Var}\left[g(z_i,\beta_0)\right]=\mathbb{E}_X\textnormal{Var}_{Y|X}\left[g(z_i,\beta_0)\mid x_i\right]+\textnormal{Var}_X \mathbb{E}_{Y|X}[g(z_i,\beta_0)\mid x_i]
    \end{aligned}
    \nonumber
\end{equation}
