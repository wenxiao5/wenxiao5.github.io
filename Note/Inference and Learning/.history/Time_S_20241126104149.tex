...
\begin{equation}
    \begin{aligned}
        t(1)&=\frac{\frac{1}{T}\sum_{t=1}^Ty_{t-1}\epsilon_t}{\hat{\sigma}\sqrt{\frac{1}{T^2}\sum_{t=1}^Ty_{t-1}^2}} \stackrel{d}{\longrightarrow} \frac{\frac{1}{2}\left[W(1)^2-1\right]}{\sqrt{\sigma^2 \int_0^1 W(r)^2 dr}}
    \end{aligned}
    \nonumber
\end{equation}
