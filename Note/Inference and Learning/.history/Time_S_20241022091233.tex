...
\begin{definition}[$L^1-$mixingale]
...
\begin{enumerate}[(i).]
    \item $\frac{1}{T}\sum_{t=2}^T Y_{t-1}^2 \stackrel{p}{\longrightarrow} Q>0$,
    \item $\frac{1}{\sqrt{T}}\sum_{t=2}^T Y_{t-1}\epsilon_t \stackrel{d}{\longrightarrow} \mathcal{N}\left(0,V\right)$.
\end{enumerate}
