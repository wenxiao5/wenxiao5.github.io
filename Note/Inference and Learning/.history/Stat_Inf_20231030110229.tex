...
\begin{equation}
    \begin{aligned}
        \hat{\theta}_{MLE}=\frac{1}{N}\sum_{i=1}^N w(X_i)Y_i=\frac{W \boldsymbol{Y}}{N}
    \end{aligned}
    \nonumber
\end{equation}
...
\begin{equation}
    \begin{aligned}
        ...
        &=\left(\frac{1}{N}\sum_{i=1}^N w_iw_i^T\right)\boldsymbol{\theta}
    \end{aligned}
    \nonumber
\end{equation}
and has variance
\begin{equation}
    \begin{aligned}
        \mathbb{Var}[\hat{\theta}_{MLE}\mid X]&=
    \end{aligned}
    \nonumber
\end{equation}
