...
\begin{enumerate}
    \item An \textbf{agglomerative hierarchical clustering algorithm} starts with all objects \textbf{apart in singleton clusters} and then iteratively joins clusters together until all objects
