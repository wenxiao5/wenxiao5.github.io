...
\begin{definition}[Score Function]
    ...
    where $f_{\vec{X}}(\vec{X}\mid\theta)=L(\theta\mid X_1,...,X_n)=\prod_{i=1}^n f(X_i\mid\theta)$.
\end{definition}
...
\begin{lemma}[Fisher Information]
    ...
    \begin{equation}
        \begin{aligned}
            ...
            &=\mathbb{E}_\theta\left[\left(\frac{\partial}{\partial \theta}\log f_{\vec{X}}(\vec{X}\mid\theta)\right)^2\right]\\
