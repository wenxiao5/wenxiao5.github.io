...
\begin{enumerate}[$\circ$]
    ...
    \begin{equation}
        ...
        \nonumber
    \end{equation}
    \begin{proof}[The Convergence of $\tilde{Y}_{t-1}^2\sigma^2$]
        \begin{equation}
            \begin{aligned}
                \frac{1}{T}\sum_{t=2}^T\left[\sigma^2\tilde{Y}_{t-1}^2\right]=\sigma^2\frac{1}{T}\sum_{t=2}^T\tilde{Y}_{t-1}^2 \stackrel{P}{\longrightarrow} \frac{\sigma^2}{1-\sigma^4}
            \end{aligned}
            \nonumber
        \end{equation}
    \end{proof}
