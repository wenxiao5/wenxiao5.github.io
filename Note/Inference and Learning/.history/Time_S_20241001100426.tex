...
\begin{proof}
    ...
    \begin{equation}
        \begin{aligned}
            \hat{\beta}=\beta+\underbrace{\left(\sum_{i=1}^n x_ix'_i\right)}_{\stackrel{P}{\longrightarrow} Q}^{-1}\underbrace{\left(\sum_{i=1}^n x_i\epsilon_i\right)}_{\stackrel{P}{\longrightarrow} 0}
        \end{aligned}
        \nonumber
    \end{equation}
\end{proof}
