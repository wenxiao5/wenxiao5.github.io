...
\begin{enumerate}
    ...
    \item \textbf{(Only holds on $p=n$)} The sum of the principal component (i.e. projected attribute) variances of $Y_{m\times p}$ are
    equal to the sum of the attribute variances of the original data matrix $X_{m\times n}$, (ie.    
\end{enumerate}
