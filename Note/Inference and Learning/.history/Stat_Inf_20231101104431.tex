...
\begin{equation}
    \begin{aligned}
        \hat{R}_\textnormal{SURE}=K\sigma^2+2\sigma^2\sum_{k=1}^K \frac{\partial g_k(\mathcal{Z})}{\partial \mathcal{Z}_k}+\sum_{k=1}^K\left(\hat{\theta}_k- \mathcal{Z}_k\right)^2
    \end{aligned}
    \nonumber
\end{equation}
which has expectation
...
\begin{equation}
    \begin{aligned}
        ...
        &=-\frac{(K-2)^2}{\mathcal{Z}'\mathcal{Z}}\frac{\sigma^2}{N}\sum_{k=1}^K
    \end{aligned}
    \nonumber
\end{equation}
