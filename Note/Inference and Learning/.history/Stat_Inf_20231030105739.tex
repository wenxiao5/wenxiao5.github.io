...
\begin{equation}
    \begin{aligned}
        Y\mid X\sim N(W \boldsymbol{\theta},\sigma^2 I_N)
    \end{aligned}
    \nonumber
\end{equation}
...
\begin{equation}
    \begin{aligned}
        \underbrace{\boldsymbol{Y}}_{N\times 1}=\underbrace{W \boldsymbol{\theta}}_{N\times 1}+\underbrace{\sigma^2 U}_{N\times 1}, \textnormal{ where }U\sim N(0,I_N)
    \end{aligned}
    \nonumber
\end{equation}
