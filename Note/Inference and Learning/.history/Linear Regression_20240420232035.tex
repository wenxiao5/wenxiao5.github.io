...
\begin{equation}
    \begin{aligned}
        G=\mathbb{E}\left[\frac{\partial g(Z,\beta_0)}{\partial \beta}\right]=\mathbb{E}\left[\frac{XX^T}{(X^T\beta+1)^4}\right]
    \end{aligned}
    \nonumber
\end{equation}
...
\begin{equation}
    \begin{aligned}
        \Omega=\mathbb{E}\left[\textnormal{Var}[g(Z,\beta_0)]\right]=
    \end{aligned}
    \nonumber
\end{equation}
