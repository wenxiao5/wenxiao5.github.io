...
\subsection{Jensen's Inequality: $f(\frac{\sum_{i=1}^k\lambda_ix_i}{\sum_{j}\lambda_j})\leq \frac{\sum_{i=1}^k\lambda_if(x_i)}{\sum_{j}\lambda_j}$ / $f(\mathbb{E}[x])\leq \mathbb{E}[f(x)]$}
