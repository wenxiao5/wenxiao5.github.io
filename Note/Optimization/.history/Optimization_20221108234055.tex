...
\begin{center}
    \fcolorbox{black}{blue!10}{\parbox{.9\linewidth}{\begin{theorem}[Karush-Kuhn-Tucker theorem, gradient form]
        ...
        \end{enumerate}
        \textbf{Furthermore,} if $P$ is a convex program then the converse holds: If $(\vec{x}^*,\vec{\lambda}^*)$ satisfy these conditions $\Leftrightarrow$ $\vec{x}^*$ is an optimal solution and $\vec{\lambda}^*$ is a sensitivity vector.
    \end{theorem}}}
\end{center}
