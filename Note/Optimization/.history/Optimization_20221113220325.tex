...
\begin{corollary}[Extreme value theorem]
    If $S\subseteq \mathbb{R}^n$ is a \texebf{compact} (closed and bounded) set and $f: S \rightarrow \mathbb{R}$ is a continuous function, then $f$ has a global maximizer on $S$.
\end{corollary}
