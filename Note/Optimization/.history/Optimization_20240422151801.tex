...
\subsection{Jensen's Inequality: $f(\sum_{i=1}^k\frac{\lambda_i}{\sum_{j}\lambda_j} x_i)\leq \sum_{i=1}^k\frac{\lambda_i}{\sum_{j}\lambda_j}f(x_i)$, $f(\mathbb{E}[x])\leq \mathbb{E}[f(x)]$}
