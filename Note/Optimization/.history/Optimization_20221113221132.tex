...
\subsection{Equality constraints in geometric programming}
\begin{equation}
...
\section{The geometric programming dual, in general}
...
\section{Using a dual solution to find a primal solution}
