...
\section{Arithmetic Mean-Geometric Mean Inequality (AM-GM inequality) $\delta_1 x_2+\delta_2 x_2+\cdots+\delta_nx_n\geq x_1^{\delta_1}x_2^{\delta_2}\cdots x_n^{\delta_n}$}
