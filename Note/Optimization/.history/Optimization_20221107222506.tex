...
\begin{equation}
    ...
    \nonumber
\end{equation}
By symmetric, we can solve $\delta_3=\delta_4=\frac{1}{2}$. We can compute $V(\vec{\delta})=\frac{27}{4}$, so $\frac{1}{xyz}=\frac{27}{4}$.

Since $\delta_2,\delta_3\neq 0$,
$$x=\text{Term}_2(x,y,z)=\frac{\delta_2}{\delta_2+\delta_3}=\frac{2}{3},\ y=\text{Term}_3(x,y,z)=\frac{\delta_3}{\delta_2+\delta_3}=\frac{1}{3}$$
