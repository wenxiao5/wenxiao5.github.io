...
\begin{corollary}[Extreme value theorem]
    If $S\subseteq \mathbb{R}^n$ is a \textbf{compact} (closed and bounded) set and $f: S \rightarrow \mathbb{R}$ is a continuous function, then $f$ has a global maximizer on $S$.
\end{corollary}
...
\section{Arithmetic Mean-Geometric Mean Inequality (A-G inequality) $\delta_1x_2+\delta_2x_2+\cdots+\delta_nx_n\geq x_1^{\delta_1}x_2^{\delta_2}\cdots x_n^{\delta_n}$}
...
\subsection{General Strategy: A-G inequality}
\begin{definition}
