...
\begin{equation}
    ...
    \nonumber
\end{equation}
$$\left(G P^{\prime \prime}\right) \quad \begin{cases}\underset{\mathbf{x} \in \mathbb{R}^2, \mathbf{z} \in \mathbb{R}^4}{\operatorname{minize}} & e^{z_1}+e^{z_2} \\ \text { subject to } & e^{z_3}+e^{z_4} \leq 1 \\ & z_1 \geq \log 4-x_1 \\ & z_2 \geq \log 9-x_2 \\ & z_3 \geq x_1 \\ & z_4 \geq x_2\end{cases}$$
