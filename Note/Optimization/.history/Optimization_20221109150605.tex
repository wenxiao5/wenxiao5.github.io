...
\begin{theorem}
    ...
    \begin{equation}
        ...
        \nonumber
    \end{equation}
    (1):$P$ is feasible, i.e., there exists a point $\vec{x}$ with $\vec{g}(\vec{x})\leq\vec{0}$ (Note we are not asking $\vec{g}(\vec{x})<\vec{0}$); (2):$g_1, g_2, \ldots, g_m$ are continuous; (3):$f$ is coercive.
\end{theorem}
